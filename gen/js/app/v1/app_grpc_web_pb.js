 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.viam.app.v1.GetBillingServiceRequest,
 *   !proto.viam.app.v1.GetBillingServiceResponse>}
 */
const methodDescriptor_AppService_GetBillingService = new grpc.web.MethodDescriptor(
  '/viam.app.v1.AppService/GetBillingService',
  grpc.web.MethodType.UNARY,
  proto.viam.app.v1.GetBillingServiceRequest,
  proto.viam.app.v1.GetBillingServiceResponse,
  /**
   * @param {!proto.viam.app.v1.GetBillingServiceRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
...
/**
 * @param {!proto.viam.app.v1.GetBillingServiceRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.viam.app.v1.GetBillingServiceResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.viam.app.v1.GetBillingServiceResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.viam.app.v1.AppServiceClient.prototype.getBillingService =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.app.v1.AppService/GetBillingService',
      request,
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.viam.app.v1.GetBillingServiceResponse>}
 *     Promise that resolves to the response
 */
proto.viam.app.v1.AppServicePromiseClient.prototype.getBillingService =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.app.v1.AppService/GetBillingService',
      request,
