...
var file_component_generic_v1_generic_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xc3, 0x03, 0x0a, 0x0e, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x69,
	...
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x8a, 0x01, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61,
	...
	0x75, 0x73, 0x12, 0x96, 0x01, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x47, 0x65, 0x6f, 0x6d, 0x65, 0x74,
	...
	0x74, 0x2e, 0x67, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x63, 0x2e, 0x76, 0x31, 0x5a, 0x24, 0x67, 0x6f,
...
var file_component_generic_v1_generic_proto_goTypes = []any{
	...
	(*v1.GetStatusRequest)(nil),      // 1: viam.common.v1.GetStatusRequest
	(*v1.GetGeometriesRequest)(nil),  // 2: viam.common.v1.GetGeometriesRequest
	(*v1.DoCommandResponse)(nil),     // 3: viam.common.v1.DoCommandResponse
	(*v1.GetStatusResponse)(nil),     // 4: viam.common.v1.GetStatusResponse
...
var file_component_generic_v1_generic_proto_depIdxs = []int32{
	...
	1, // 1: viam.component.generic.v1.GenericService.GetStatus:input_type -> viam.common.v1.GetStatusRequest
	2, // 2: viam.component.generic.v1.GenericService.GetGeometries:input_type -> viam.common.v1.GetGeometriesRequest
	3, // 3: viam.component.generic.v1.GenericService.DoCommand:output_type -> viam.common.v1.DoCommandResponse
	4, // 4: viam.component.generic.v1.GenericService.GetStatus:output_type -> viam.common.v1.GetStatusResponse
	5, // 5: viam.component.generic.v1.GenericService.GetGeometries:output_type -> viam.common.v1.GetGeometriesResponse
