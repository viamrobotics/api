 ...
 */
const methodDescriptor_SwitchService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.component.switch.v1.SwitchServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.component.switch.v1.SwitchService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_SwitchService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.component.switch.v1.SwitchServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.component.switch.v1.SwitchService/GetStatus',
      request,
