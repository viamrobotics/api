 ...
 */
const methodDescriptor_NavigationService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.service.navigation.v1.NavigationServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.service.navigation.v1.NavigationService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_NavigationService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.service.navigation.v1.NavigationServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.service.navigation.v1.NavigationService/GetStatus',
      request,
