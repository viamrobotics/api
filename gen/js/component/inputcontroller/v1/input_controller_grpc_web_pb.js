 ...
 */
const methodDescriptor_InputControllerService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.component.inputcontroller.v1.InputControllerServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.component.inputcontroller.v1.InputControllerService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_InputControllerService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.component.inputcontroller.v1.InputControllerServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.component.inputcontroller.v1.InputControllerService/GetStatus',
      request,
