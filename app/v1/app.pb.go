...
var file_app_v1_app_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x75, 0x72, 0x6c, 0x22, 0xc1, 0x02, 0x0a, 0x13, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x66, 0x69, 0x72, 0x73, 0x74, 0x5f, 0x72, 0x75, 0x6e, 0x22, 0x4d, 0x0a, 0x03, 0x41, 0x70, 0x70,
	...
	0x72, 0x6c, 0x22, 0x62, 0x0a, 0x14, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x4d, 0x6f, 0x64, 0x75,
	...
	0x79, 0x70, 0x6f, 0x69, 0x6e, 0x74, 0x22, 0xaa, 0x01, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x28, 0x08, 0x52, 0x05, 0x64, 0x72, 0x61, 0x66, 0x74, 0x22, 0xbd, 0x01, 0x0a, 0x05, 0x4d, 0x6f,
	...
	0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x88, 0x01, 0x01, 0x42, 0x19,
	...
	0x45, 0x5f, 0x43, 0x4f, 0x44, 0x45, 0x10, 0x05, 0x32, 0xa9, 0x4e, 0x0a, 0x0a, 0x41, 0x70, 0x70,
...
var file_app_v1_app_proto_msgTypes = make([]protoimpl.MessageInfo, 245)
var file_app_v1_app_proto_goTypes = []any{
	...
	(*App)(nil),                                            // 199: viam.app.v1.App
	(*UpdateModuleResponse)(nil),                           // 200: viam.app.v1.UpdateModuleResponse
	(*UpdateModuleMetadata)(nil),                           // 201: viam.app.v1.UpdateModuleMetadata
	(*UpdateMLModelMetadata)(nil),                          // 202: viam.app.v1.UpdateMLModelMetadata
	(*UpdateMLTrainingMetadata)(nil),                       // 203: viam.app.v1.UpdateMLTrainingMetadata
	(*Model)(nil),                                          // 204: viam.app.v1.Model
	(*ModuleFileInfo)(nil),                                 // 205: viam.app.v1.ModuleFileInfo
	(*UploadModuleFileRequest)(nil),                        // 206: viam.app.v1.UploadModuleFileRequest
	(*UploadModuleFileResponse)(nil),                       // 207: viam.app.v1.UploadModuleFileResponse
	(*GetModuleRequest)(nil),                               // 208: viam.app.v1.GetModuleRequest
	(*GetModuleResponse)(nil),                              // 209: viam.app.v1.GetModuleResponse
	(*Module)(nil),                                         // 210: viam.app.v1.Module
	(*VersionHistory)(nil),                                 // 211: viam.app.v1.VersionHistory
	(*Uploads)(nil),                                        // 212: viam.app.v1.Uploads
	(*ListModulesRequest)(nil),                             // 213: viam.app.v1.ListModulesRequest
	(*ListModulesResponse)(nil),                            // 214: viam.app.v1.ListModulesResponse
	(*GetUserIDByEmailRequest)(nil),                        // 215: viam.app.v1.GetUserIDByEmailRequest
	(*GetUserIDByEmailResponse)(nil),                       // 216: viam.app.v1.GetUserIDByEmailResponse
	(*ListOrganizationsByUserRequest)(nil),                 // 217: viam.app.v1.ListOrganizationsByUserRequest
	(*OrgDetails)(nil),                                     // 218: viam.app.v1.OrgDetails
	(*ListOrganizationsByUserResponse)(nil),                // 219: viam.app.v1.ListOrganizationsByUserResponse
	(*SearchOrganizationsRequest)(nil),                     // 220: viam.app.v1.SearchOrganizationsRequest
	(*SearchOrganizationsResponse)(nil),                    // 221: viam.app.v1.SearchOrganizationsResponse
	(*CreateKeyRequest)(nil),                               // 222: viam.app.v1.CreateKeyRequest
	(*CreateKeyResponse)(nil),                              // 223: viam.app.v1.CreateKeyResponse
	(*DeleteKeyRequest)(nil),                               // 224: viam.app.v1.DeleteKeyRequest
	(*DeleteKeyResponse)(nil),                              // 225: viam.app.v1.DeleteKeyResponse
	(*RenameKeyRequest)(nil),                               // 226: viam.app.v1.RenameKeyRequest
	(*RenameKeyResponse)(nil),                              // 227: viam.app.v1.RenameKeyResponse
	(*AuthorizationDetails)(nil),                           // 228: viam.app.v1.AuthorizationDetails
	(*APIKeyWithAuthorizations)(nil),                       // 229: viam.app.v1.APIKeyWithAuthorizations
	(*ListKeysRequest)(nil),                                // 230: viam.app.v1.ListKeysRequest
	(*ListKeysResponse)(nil),                               // 231: viam.app.v1.ListKeysResponse
	(*RotateKeyRequest)(nil),                               // 232: viam.app.v1.RotateKeyRequest
	(*RotateKeyResponse)(nil),                              // 233: viam.app.v1.RotateKeyResponse
	(*CreateKeyFromExistingKeyAuthorizationsRequest)(nil),  // 234: viam.app.v1.CreateKeyFromExistingKeyAuthorizationsRequest
	(*CreateKeyFromExistingKeyAuthorizationsResponse)(nil), // 235: viam.app.v1.CreateKeyFromExistingKeyAuthorizationsResponse
	(*OrganizationSetLogoRequest)(nil),                     // 236: viam.app.v1.OrganizationSetLogoRequest
	(*OrganizationSetLogoResponse)(nil),                    // 237: viam.app.v1.OrganizationSetLogoResponse
	(*OrganizationGetLogoRequest)(nil),                     // 238: viam.app.v1.OrganizationGetLogoRequest
	(*OrganizationGetLogoResponse)(nil),                    // 239: viam.app.v1.OrganizationGetLogoResponse
	(*EnableAuthServiceRequest)(nil),                       // 240: viam.app.v1.EnableAuthServiceRequest
	(*EnableAuthServiceResponse)(nil),                      // 241: viam.app.v1.EnableAuthServiceResponse
	(*DisableAuthServiceRequest)(nil),                      // 242: viam.app.v1.DisableAuthServiceRequest
	(*DisableAuthServiceResponse)(nil),                     // 243: viam.app.v1.DisableAuthServiceResponse
	(*CreateOAuthAppRequest)(nil),                          // 244: viam.app.v1.CreateOAuthAppRequest
	(*CreateOAuthAppResponse)(nil),                         // 245: viam.app.v1.CreateOAuthAppResponse
	(*ReadOAuthAppRequest)(nil),                            // 246: viam.app.v1.ReadOAuthAppRequest
	(*ReadOAuthAppResponse)(nil),                           // 247: viam.app.v1.ReadOAuthAppResponse
	(*UpdateOAuthAppRequest)(nil),                          // 248: viam.app.v1.UpdateOAuthAppRequest
	(*UpdateOAuthAppResponse)(nil),                         // 249: viam.app.v1.UpdateOAuthAppResponse
	(*DeleteOAuthAppRequest)(nil),                          // 250: viam.app.v1.DeleteOAuthAppRequest
	(*DeleteOAuthAppResponse)(nil),                         // 251: viam.app.v1.DeleteOAuthAppResponse
	(*ListOAuthAppsRequest)(nil),                           // 252: viam.app.v1.ListOAuthAppsRequest
	(*ListOAuthAppsResponse)(nil),                          // 253: viam.app.v1.ListOAuthAppsResponse
	(*OAuthConfig)(nil),                                    // 254: viam.app.v1.OAuthConfig
	(*timestamppb.Timestamp)(nil),                          // 255: google.protobuf.Timestamp
	(*structpb.Struct)(nil),                                // 256: google.protobuf.Struct
	(*v1.LogEntry)(nil),                                    // 257: viam.common.v1.LogEntry
	(v11.ModelType)(0),                                     // 258: viam.app.mltraining.v1.ModelType
	(v11.ModelFramework)(0),                                // 259: viam.app.mltraining.v1.ModelFramework
	(v12.PackageType)(0),                                   // 260: viam.app.packages.v1.PackageType
}
var file_app_v1_app_proto_depIdxs = []int32{
	255, // 0: viam.app.v1.Robot.last_access:type_name -> google.protobuf.Timestamp
	255, // 1: viam.app.v1.Robot.created_on:type_name -> google.protobuf.Timestamp
	256, // 2: viam.app.v1.RobotPart.robot_config:type_name -> google.protobuf.Struct
	255, // 3: viam.app.v1.RobotPart.last_access:type_name -> google.protobuf.Timestamp
	256, // 4: viam.app.v1.RobotPart.user_supplied_info:type_name -> google.protobuf.Struct
	255, // 5: viam.app.v1.RobotPart.created_on:type_name -> google.protobuf.Timestamp
	63,  // 6: viam.app.v1.RobotPart.secrets:type_name -> viam.app.v1.SharedSecret
	255, // 7: viam.app.v1.RobotPart.last_updated:type_name -> google.protobuf.Timestamp
	255, // 8: viam.app.v1.RobotPartHistoryEntry.when:type_name -> google.protobuf.Timestamp
	...
	255, // 12: viam.app.v1.Organization.created_on:type_name -> google.protobuf.Timestamp
	255, // 13: viam.app.v1.OrganizationMember.date_added:type_name -> google.protobuf.Timestamp
	255, // 14: viam.app.v1.OrganizationMember.last_login:type_name -> google.protobuf.Timestamp
	15,  // 15: viam.app.v1.ListOrganizationsResponse.organizations:type_name -> viam.app.v1.Organization
	255, // 16: viam.app.v1.OrganizationInvite.created_on:type_name -> google.protobuf.Timestamp
	...
	256, // 21: viam.app.v1.GetOrganizationMetadataResponse.data:type_name -> google.protobuf.Struct
	256, // 22: viam.app.v1.UpdateOrganizationMetadataRequest.data:type_name -> google.protobuf.Struct
	...
	255, // 37: viam.app.v1.Location.created_on:type_name -> google.protobuf.Timestamp
	...
	255, // 40: viam.app.v1.SharedSecret.created_on:type_name -> google.protobuf.Timestamp
	...
	256, // 45: viam.app.v1.GetLocationMetadataResponse.data:type_name -> google.protobuf.Struct
	256, // 46: viam.app.v1.UpdateLocationMetadataRequest.data:type_name -> google.protobuf.Struct
	...
	255, // 55: viam.app.v1.GetRobotPartLogsRequest.start:type_name -> google.protobuf.Timestamp
	255, // 56: viam.app.v1.GetRobotPartLogsRequest.end:type_name -> google.protobuf.Timestamp
	257, // 57: viam.app.v1.GetRobotPartLogsResponse.logs:type_name -> viam.common.v1.LogEntry
	257, // 58: viam.app.v1.TailRobotPartLogsResponse.logs:type_name -> viam.common.v1.LogEntry
	12,  // 59: viam.app.v1.GetRobotPartHistoryResponse.history:type_name -> viam.app.v1.RobotPartHistoryEntry
	256, // 60: viam.app.v1.UpdateRobotPartRequest.robot_config:type_name -> google.protobuf.Struct
	11,  // 61: viam.app.v1.UpdateRobotPartResponse.part:type_name -> viam.app.v1.RobotPart
	256, // 62: viam.app.v1.GetRobotPartMetadataResponse.data:type_name -> google.protobuf.Struct
	256, // 63: viam.app.v1.UpdateRobotPartMetadataRequest.data:type_name -> google.protobuf.Struct
	255, // 64: viam.app.v1.APIKey.created_on:type_name -> google.protobuf.Timestamp
	229, // 65: viam.app.v1.GetRobotAPIKeysResponse.api_keys:type_name -> viam.app.v1.APIKeyWithAuthorizations
	256, // 66: viam.app.v1.Fragment.fragment:type_name -> google.protobuf.Struct
	255, // 67: viam.app.v1.Fragment.created_on:type_name -> google.protobuf.Timestamp
	1,   // 68: viam.app.v1.Fragment.visibility:type_name -> viam.app.v1.FragmentVisibility
	255, // 69: viam.app.v1.Fragment.last_updated:type_name -> google.protobuf.Timestamp
	255, // 70: viam.app.v1.FragmentHistoryEntry.edited_on:type_name -> google.protobuf.Timestamp
	...
	256, // 73: viam.app.v1.FragmentHistoryEntry.config:type_name -> google.protobuf.Struct
	255, // 74: viam.app.v1.FragmentRevision.created_at:type_name -> google.protobuf.Timestamp
	2,   // 75: viam.app.v1.FragmentError.error_type:type_name -> viam.app.v1.FragmentErrorType
	256, // 76: viam.app.v1.ResolvedFragment.resolved_config:type_name -> google.protobuf.Struct
	...
	256, // 85: viam.app.v1.CreateFragmentRequest.config:type_name -> google.protobuf.Struct
	...
	256, // 88: viam.app.v1.UpdateFragmentRequest.config:type_name -> google.protobuf.Struct
	...
	256, // 100: viam.app.v1.GetRobotMetadataResponse.data:type_name -> google.protobuf.Struct
	256, // 101: viam.app.v1.UpdateRobotMetadataRequest.data:type_name -> google.protobuf.Struct
	...
	212, // 110: viam.app.v1.ModuleVersion.files:type_name -> viam.app.v1.Uploads
	204, // 111: viam.app.v1.ModuleVersion.models:type_name -> viam.app.v1.Model
	204, // 112: viam.app.v1.ModuleMetadata.models:type_name -> viam.app.v1.Model
	178, // 113: viam.app.v1.ModuleMetadata.versions:type_name -> viam.app.v1.ModuleVersion
	258, // 114: viam.app.v1.MLModelMetadata.model_type:type_name -> viam.app.mltraining.v1.ModelType
	259, // 115: viam.app.v1.MLModelMetadata.model_framework:type_name -> viam.app.mltraining.v1.ModelFramework
	255, // 116: viam.app.v1.MLTrainingVersion.created_on:type_name -> google.protobuf.Timestamp
	181, // 117: viam.app.v1.MLTrainingMetadata.versions:type_name -> viam.app.v1.MLTrainingVersion
	258, // 118: viam.app.v1.MLTrainingMetadata.model_type:type_name -> viam.app.mltraining.v1.ModelType
	259, // 119: viam.app.v1.MLTrainingMetadata.model_framework:type_name -> viam.app.mltraining.v1.ModelFramework
	260, // 120: viam.app.v1.RegistryItem.type:type_name -> viam.app.packages.v1.PackageType
	...
	255, // 125: viam.app.v1.RegistryItem.created_at:type_name -> google.protobuf.Timestamp
	255, // 126: viam.app.v1.RegistryItem.updated_at:type_name -> google.protobuf.Timestamp
	183, // 127: viam.app.v1.GetRegistryItemResponse.item:type_name -> viam.app.v1.RegistryItem
	260, // 128: viam.app.v1.CreateRegistryItemRequest.type:type_name -> viam.app.packages.v1.PackageType
	260, // 129: viam.app.v1.UpdateRegistryItemRequest.type:type_name -> viam.app.packages.v1.PackageType
	4,   // 130: viam.app.v1.UpdateRegistryItemRequest.visibility:type_name -> viam.app.v1.Visibility
	201, // 131: viam.app.v1.UpdateRegistryItemRequest.module_update_metadata:type_name -> viam.app.v1.UpdateModuleMetadata
	202, // 132: viam.app.v1.UpdateRegistryItemRequest.ml_model_update_metadata:type_name -> viam.app.v1.UpdateMLModelMetadata
	203, // 133: viam.app.v1.UpdateRegistryItemRequest.ml_training_update_metadata:type_name -> viam.app.v1.UpdateMLTrainingMetadata
	260, // 134: viam.app.v1.ListRegistryItemsRequest.types:type_name -> viam.app.packages.v1.PackageType
	...
	204, // 139: viam.app.v1.UpdateModuleRequest.models:type_name -> viam.app.v1.Model
	199, // 140: viam.app.v1.UpdateModuleRequest.apps:type_name -> viam.app.v1.App
	204, // 141: viam.app.v1.UpdateModuleMetadata.models:type_name -> viam.app.v1.Model
	258, // 142: viam.app.v1.UpdateMLModelMetadata.model_type:type_name -> viam.app.mltraining.v1.ModelType
	259, // 143: viam.app.v1.UpdateMLModelMetadata.model_framework:type_name -> viam.app.mltraining.v1.ModelFramework
	258, // 144: viam.app.v1.UpdateMLTrainingMetadata.model_type:type_name -> viam.app.mltraining.v1.ModelType
	259, // 145: viam.app.v1.UpdateMLTrainingMetadata.model_framework:type_name -> viam.app.mltraining.v1.ModelFramework
	205, // 146: viam.app.v1.UploadModuleFileRequest.module_file_info:type_name -> viam.app.v1.ModuleFileInfo
	210, // 147: viam.app.v1.GetModuleResponse.module:type_name -> viam.app.v1.Module
	4,   // 148: viam.app.v1.Module.visibility:type_name -> viam.app.v1.Visibility
	211, // 149: viam.app.v1.Module.versions:type_name -> viam.app.v1.VersionHistory
	204, // 150: viam.app.v1.Module.models:type_name -> viam.app.v1.Model
	212, // 151: viam.app.v1.VersionHistory.files:type_name -> viam.app.v1.Uploads
	204, // 152: viam.app.v1.VersionHistory.models:type_name -> viam.app.v1.Model
	255, // 153: viam.app.v1.Uploads.uploaded_at:type_name -> google.protobuf.Timestamp
	210, // 154: viam.app.v1.ListModulesResponse.modules:type_name -> viam.app.v1.Module
	218, // 155: viam.app.v1.ListOrganizationsByUserResponse.orgs:type_name -> viam.app.v1.OrgDetails
	218, // 156: viam.app.v1.SearchOrganizationsResponse.organizations:type_name -> viam.app.v1.OrgDetails
	166, // 157: viam.app.v1.CreateKeyRequest.authorizations:type_name -> viam.app.v1.Authorization
	115, // 158: viam.app.v1.APIKeyWithAuthorizations.api_key:type_name -> viam.app.v1.APIKey
	228, // 159: viam.app.v1.APIKeyWithAuthorizations.authorizations:type_name -> viam.app.v1.AuthorizationDetails
	229, // 160: viam.app.v1.ListKeysResponse.api_keys:type_name -> viam.app.v1.APIKeyWithAuthorizations
	254, // 161: viam.app.v1.CreateOAuthAppRequest.oauth_config:type_name -> viam.app.v1.OAuthConfig
	254, // 162: viam.app.v1.ReadOAuthAppResponse.oauth_config:type_name -> viam.app.v1.OAuthConfig
	254, // 163: viam.app.v1.UpdateOAuthAppRequest.oauth_config:type_name -> viam.app.v1.OAuthConfig
	5,   // 164: viam.app.v1.OAuthConfig.client_authentication:type_name -> viam.app.v1.ClientAuthentication
	6,   // 165: viam.app.v1.OAuthConfig.pkce:type_name -> viam.app.v1.PKCE
	7,   // 166: viam.app.v1.OAuthConfig.url_validation:type_name -> viam.app.v1.URLValidation
	8,   // 167: viam.app.v1.OAuthConfig.enabled_grants:type_name -> viam.app.v1.EnabledGrant
	215, // 168: viam.app.v1.AppService.GetUserIDByEmail:input_type -> viam.app.v1.GetUserIDByEmailRequest
	19,  // 169: viam.app.v1.AppService.CreateOrganization:input_type -> viam.app.v1.CreateOrganizationRequest
	14,  // 170: viam.app.v1.AppService.ListOrganizations:input_type -> viam.app.v1.ListOrganizationsRequest
	76,  // 171: viam.app.v1.AppService.GetOrganizationsWithAccessToLocation:input_type -> viam.app.v1.GetOrganizationsWithAccessToLocationRequest
	217, // 172: viam.app.v1.AppService.ListOrganizationsByUser:input_type -> viam.app.v1.ListOrganizationsByUserRequest
	220, // 173: viam.app.v1.AppService.SearchOrganizations:input_type -> viam.app.v1.SearchOrganizationsRequest
	21,  // 174: viam.app.v1.AppService.GetOrganization:input_type -> viam.app.v1.GetOrganizationRequest
	23,  // 175: viam.app.v1.AppService.GetOrganizationNamespaceAvailability:input_type -> viam.app.v1.GetOrganizationNamespaceAvailabilityRequest
	25,  // 176: viam.app.v1.AppService.UpdateOrganization:input_type -> viam.app.v1.UpdateOrganizationRequest
	27,  // 177: viam.app.v1.AppService.DeleteOrganization:input_type -> viam.app.v1.DeleteOrganizationRequest
	29,  // 178: viam.app.v1.AppService.GetOrganizationMetadata:input_type -> viam.app.v1.GetOrganizationMetadataRequest
	31,  // 179: viam.app.v1.AppService.UpdateOrganizationMetadata:input_type -> viam.app.v1.UpdateOrganizationMetadataRequest
	33,  // 180: viam.app.v1.AppService.ListOrganizationMembers:input_type -> viam.app.v1.ListOrganizationMembersRequest
	35,  // 181: viam.app.v1.AppService.CreateOrganizationInvite:input_type -> viam.app.v1.CreateOrganizationInviteRequest
	37,  // 182: viam.app.v1.AppService.UpdateOrganizationInviteAuthorizations:input_type -> viam.app.v1.UpdateOrganizationInviteAuthorizationsRequest
	43,  // 183: viam.app.v1.AppService.DeleteOrganizationMember:input_type -> viam.app.v1.DeleteOrganizationMemberRequest
	39,  // 184: viam.app.v1.AppService.DeleteOrganizationInvite:input_type -> viam.app.v1.DeleteOrganizationInviteRequest
	41,  // 185: viam.app.v1.AppService.ResendOrganizationInvite:input_type -> viam.app.v1.ResendOrganizationInviteRequest
	46,  // 186: viam.app.v1.AppService.EnableBillingService:input_type -> viam.app.v1.EnableBillingServiceRequest
	52,  // 187: viam.app.v1.AppService.DisableBillingService:input_type -> viam.app.v1.DisableBillingServiceRequest
	48,  // 188: viam.app.v1.AppService.UpdateBillingService:input_type -> viam.app.v1.UpdateBillingServiceRequest
	50,  // 189: viam.app.v1.AppService.GetBillingServiceConfig:input_type -> viam.app.v1.GetBillingServiceConfigRequest
	54,  // 190: viam.app.v1.AppService.OrganizationSetSupportEmail:input_type -> viam.app.v1.OrganizationSetSupportEmailRequest
	56,  // 191: viam.app.v1.AppService.OrganizationGetSupportEmail:input_type -> viam.app.v1.OrganizationGetSupportEmailRequest
	236, // 192: viam.app.v1.AppService.OrganizationSetLogo:input_type -> viam.app.v1.OrganizationSetLogoRequest
	238, // 193: viam.app.v1.AppService.OrganizationGetLogo:input_type -> viam.app.v1.OrganizationGetLogoRequest
	240, // 194: viam.app.v1.AppService.EnableAuthService:input_type -> viam.app.v1.EnableAuthServiceRequest
	242, // 195: viam.app.v1.AppService.DisableAuthService:input_type -> viam.app.v1.DisableAuthServiceRequest
	244, // 196: viam.app.v1.AppService.CreateOAuthApp:input_type -> viam.app.v1.CreateOAuthAppRequest
	246, // 197: viam.app.v1.AppService.ReadOAuthApp:input_type -> viam.app.v1.ReadOAuthAppRequest
	248, // 198: viam.app.v1.AppService.UpdateOAuthApp:input_type -> viam.app.v1.UpdateOAuthAppRequest
	250, // 199: viam.app.v1.AppService.DeleteOAuthApp:input_type -> viam.app.v1.DeleteOAuthAppRequest
	252, // 200: viam.app.v1.AppService.ListOAuthApps:input_type -> viam.app.v1.ListOAuthAppsRequest
	64,  // 201: viam.app.v1.AppService.CreateLocation:input_type -> viam.app.v1.CreateLocationRequest
	66,  // 202: viam.app.v1.AppService.GetLocation:input_type -> viam.app.v1.GetLocationRequest
	68,  // 203: viam.app.v1.AppService.UpdateLocation:input_type -> viam.app.v1.UpdateLocationRequest
	70,  // 204: viam.app.v1.AppService.DeleteLocation:input_type -> viam.app.v1.DeleteLocationRequest
	72,  // 205: viam.app.v1.AppService.GetLocationMetadata:input_type -> viam.app.v1.GetLocationMetadataRequest
	74,  // 206: viam.app.v1.AppService.UpdateLocationMetadata:input_type -> viam.app.v1.UpdateLocationMetadataRequest
	78,  // 207: viam.app.v1.AppService.ListLocations:input_type -> viam.app.v1.ListLocationsRequest
	79,  // 208: viam.app.v1.AppService.ShareLocation:input_type -> viam.app.v1.ShareLocationRequest
	81,  // 209: viam.app.v1.AppService.UnshareLocation:input_type -> viam.app.v1.UnshareLocationRequest
	88,  // 210: viam.app.v1.AppService.LocationAuth:input_type -> viam.app.v1.LocationAuthRequest
	84,  // 211: viam.app.v1.AppService.CreateLocationSecret:input_type -> viam.app.v1.CreateLocationSecretRequest
	86,  // 212: viam.app.v1.AppService.DeleteLocationSecret:input_type -> viam.app.v1.DeleteLocationSecretRequest
	90,  // 213: viam.app.v1.AppService.GetRobot:input_type -> viam.app.v1.GetRobotRequest
	154, // 214: viam.app.v1.AppService.GetRobotMetadata:input_type -> viam.app.v1.GetRobotMetadataRequest
	156, // 215: viam.app.v1.AppService.UpdateRobotMetadata:input_type -> viam.app.v1.UpdateRobotMetadataRequest
	91,  // 216: viam.app.v1.AppService.GetRoverRentalRobots:input_type -> viam.app.v1.GetRoverRentalRobotsRequest
	95,  // 217: viam.app.v1.AppService.GetRobotParts:input_type -> viam.app.v1.GetRobotPartsRequest
	97,  // 218: viam.app.v1.AppService.GetRobotPart:input_type -> viam.app.v1.GetRobotPartRequest
	99,  // 219: viam.app.v1.AppService.GetRobotPartLogs:input_type -> viam.app.v1.GetRobotPartLogsRequest
	101, // 220: viam.app.v1.AppService.TailRobotPartLogs:input_type -> viam.app.v1.TailRobotPartLogsRequest
	103, // 221: viam.app.v1.AppService.GetRobotPartHistory:input_type -> viam.app.v1.GetRobotPartHistoryRequest
	105, // 222: viam.app.v1.AppService.UpdateRobotPart:input_type -> viam.app.v1.UpdateRobotPartRequest
	107, // 223: viam.app.v1.AppService.NewRobotPart:input_type -> viam.app.v1.NewRobotPartRequest
	109, // 224: viam.app.v1.AppService.DeleteRobotPart:input_type -> viam.app.v1.DeleteRobotPartRequest
	110, // 225: viam.app.v1.AppService.GetRobotPartMetadata:input_type -> viam.app.v1.GetRobotPartMetadataRequest
	112, // 226: viam.app.v1.AppService.UpdateRobotPartMetadata:input_type -> viam.app.v1.UpdateRobotPartMetadataRequest
	114, // 227: viam.app.v1.AppService.GetRobotAPIKeys:input_type -> viam.app.v1.GetRobotAPIKeysRequest
	158, // 228: viam.app.v1.AppService.MarkPartAsMain:input_type -> viam.app.v1.MarkPartAsMainRequest
	160, // 229: viam.app.v1.AppService.MarkPartForRestart:input_type -> viam.app.v1.MarkPartForRestartRequest
	162, // 230: viam.app.v1.AppService.CreateRobotPartSecret:input_type -> viam.app.v1.CreateRobotPartSecretRequest
	164, // 231: viam.app.v1.AppService.DeleteRobotPartSecret:input_type -> viam.app.v1.DeleteRobotPartSecretRequest
	143, // 232: viam.app.v1.AppService.ListRobots:input_type -> viam.app.v1.ListRobotsRequest
	148, // 233: viam.app.v1.AppService.NewRobot:input_type -> viam.app.v1.NewRobotRequest
	150, // 234: viam.app.v1.AppService.UpdateRobot:input_type -> viam.app.v1.UpdateRobotRequest
	152, // 235: viam.app.v1.AppService.DeleteRobot:input_type -> viam.app.v1.DeleteRobotRequest
	125, // 236: viam.app.v1.AppService.ListFragments:input_type -> viam.app.v1.ListFragmentsRequest
	127, // 237: viam.app.v1.AppService.GetFragment:input_type -> viam.app.v1.GetFragmentRequest
	129, // 238: viam.app.v1.AppService.CreateFragment:input_type -> viam.app.v1.CreateFragmentRequest
	131, // 239: viam.app.v1.AppService.UpdateFragment:input_type -> viam.app.v1.UpdateFragmentRequest
	133, // 240: viam.app.v1.AppService.DeleteFragment:input_type -> viam.app.v1.DeleteFragmentRequest
	145, // 241: viam.app.v1.AppService.ListMachineFragments:input_type -> viam.app.v1.ListMachineFragmentsRequest
	135, // 242: viam.app.v1.AppService.GetFragmentHistory:input_type -> viam.app.v1.GetFragmentHistoryRequest
	137, // 243: viam.app.v1.AppService.GetFragmentUsage:input_type -> viam.app.v1.GetFragmentUsageRequest
	139, // 244: viam.app.v1.AppService.SetFragmentTag:input_type -> viam.app.v1.SetFragmentTagRequest
	141, // 245: viam.app.v1.AppService.DeleteFragmentTag:input_type -> viam.app.v1.DeleteFragmentTagRequest
	167, // 246: viam.app.v1.AppService.AddRole:input_type -> viam.app.v1.AddRoleRequest
	169, // 247: viam.app.v1.AppService.RemoveRole:input_type -> viam.app.v1.RemoveRoleRequest
	171, // 248: viam.app.v1.AppService.ChangeRole:input_type -> viam.app.v1.ChangeRoleRequest
	173, // 249: viam.app.v1.AppService.ListAuthorizations:input_type -> viam.app.v1.ListAuthorizationsRequest
	175, // 250: viam.app.v1.AppService.CheckPermissions:input_type -> viam.app.v1.CheckPermissionsRequest
	184, // 251: viam.app.v1.AppService.GetRegistryItem:input_type -> viam.app.v1.GetRegistryItemRequest
	186, // 252: viam.app.v1.AppService.CreateRegistryItem:input_type -> viam.app.v1.CreateRegistryItemRequest
	188, // 253: viam.app.v1.AppService.UpdateRegistryItem:input_type -> viam.app.v1.UpdateRegistryItemRequest
	190, // 254: viam.app.v1.AppService.ListRegistryItems:input_type -> viam.app.v1.ListRegistryItemsRequest
	192, // 255: viam.app.v1.AppService.DeleteRegistryItem:input_type -> viam.app.v1.DeleteRegistryItemRequest
	194, // 256: viam.app.v1.AppService.TransferRegistryItem:input_type -> viam.app.v1.TransferRegistryItemRequest
	196, // 257: viam.app.v1.AppService.CreateModule:input_type -> viam.app.v1.CreateModuleRequest
	198, // 258: viam.app.v1.AppService.UpdateModule:input_type -> viam.app.v1.UpdateModuleRequest
	206, // 259: viam.app.v1.AppService.UploadModuleFile:input_type -> viam.app.v1.UploadModuleFileRequest
	208, // 260: viam.app.v1.AppService.GetModule:input_type -> viam.app.v1.GetModuleRequest
	213, // 261: viam.app.v1.AppService.ListModules:input_type -> viam.app.v1.ListModulesRequest
	222, // 262: viam.app.v1.AppService.CreateKey:input_type -> viam.app.v1.CreateKeyRequest
	224, // 263: viam.app.v1.AppService.DeleteKey:input_type -> viam.app.v1.DeleteKeyRequest
	230, // 264: viam.app.v1.AppService.ListKeys:input_type -> viam.app.v1.ListKeysRequest
	226, // 265: viam.app.v1.AppService.RenameKey:input_type -> viam.app.v1.RenameKeyRequest
	232, // 266: viam.app.v1.AppService.RotateKey:input_type -> viam.app.v1.RotateKeyRequest
	234, // 267: viam.app.v1.AppService.CreateKeyFromExistingKeyAuthorizations:input_type -> viam.app.v1.CreateKeyFromExistingKeyAuthorizationsRequest
	216, // 268: viam.app.v1.AppService.GetUserIDByEmail:output_type -> viam.app.v1.GetUserIDByEmailResponse
	...
	219, // 272: viam.app.v1.AppService.ListOrganizationsByUser:output_type -> viam.app.v1.ListOrganizationsByUserResponse
	221, // 273: viam.app.v1.AppService.SearchOrganizations:output_type -> viam.app.v1.SearchOrganizationsResponse
	...
	237, // 292: viam.app.v1.AppService.OrganizationSetLogo:output_type -> viam.app.v1.OrganizationSetLogoResponse
	239, // 293: viam.app.v1.AppService.OrganizationGetLogo:output_type -> viam.app.v1.OrganizationGetLogoResponse
	241, // 294: viam.app.v1.AppService.EnableAuthService:output_type -> viam.app.v1.EnableAuthServiceResponse
	243, // 295: viam.app.v1.AppService.DisableAuthService:output_type -> viam.app.v1.DisableAuthServiceResponse
	245, // 296: viam.app.v1.AppService.CreateOAuthApp:output_type -> viam.app.v1.CreateOAuthAppResponse
	247, // 297: viam.app.v1.AppService.ReadOAuthApp:output_type -> viam.app.v1.ReadOAuthAppResponse
	249, // 298: viam.app.v1.AppService.UpdateOAuthApp:output_type -> viam.app.v1.UpdateOAuthAppResponse
	251, // 299: viam.app.v1.AppService.DeleteOAuthApp:output_type -> viam.app.v1.DeleteOAuthAppResponse
	253, // 300: viam.app.v1.AppService.ListOAuthApps:output_type -> viam.app.v1.ListOAuthAppsResponse
	...
	200, // 358: viam.app.v1.AppService.UpdateModule:output_type -> viam.app.v1.UpdateModuleResponse
	207, // 359: viam.app.v1.AppService.UploadModuleFile:output_type -> viam.app.v1.UploadModuleFileResponse
	209, // 360: viam.app.v1.AppService.GetModule:output_type -> viam.app.v1.GetModuleResponse
	214, // 361: viam.app.v1.AppService.ListModules:output_type -> viam.app.v1.ListModulesResponse
	223, // 362: viam.app.v1.AppService.CreateKey:output_type -> viam.app.v1.CreateKeyResponse
	225, // 363: viam.app.v1.AppService.DeleteKey:output_type -> viam.app.v1.DeleteKeyResponse
	231, // 364: viam.app.v1.AppService.ListKeys:output_type -> viam.app.v1.ListKeysResponse
	227, // 365: viam.app.v1.AppService.RenameKey:output_type -> viam.app.v1.RenameKeyResponse
	233, // 366: viam.app.v1.AppService.RotateKey:output_type -> viam.app.v1.RotateKeyResponse
	235, // 367: viam.app.v1.AppService.CreateKeyFromExistingKeyAuthorizations:output_type -> viam.app.v1.CreateKeyFromExistingKeyAuthorizationsResponse
	268, // [268:368] is the sub-list for method output_type
	168, // [168:268] is the sub-list for method input_type
