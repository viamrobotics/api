...
var file_component_gripper_v1_gripper_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x69, 0x73, 0x4d, 0x6f, 0x76, 0x69, 0x6e, 0x67, 0x32, 0xa0, 0x08, 0x0a, 0x0e, 0x47,
	...
	0x72, 0x69, 0x65, 0x73, 0x12, 0x96, 0x01, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x4b, 0x69, 0x6e, 0x65,
	...
	0x65, 0x7d, 0x2f, 0x6b, 0x69, 0x6e, 0x65, 0x6d, 0x61, 0x74, 0x69, 0x63, 0x73, 0x42, 0x45, 0x0a,
...
var file_component_gripper_v1_gripper_proto_goTypes = []any{
	...
	(*v1.GetKinematicsRequest)(nil),  // 11: viam.common.v1.GetKinematicsRequest
	...
	(*v1.GetKinematicsResponse)(nil), // 14: viam.common.v1.GetKinematicsResponse
}
var file_component_gripper_v1_gripper_proto_depIdxs = []int32{
	...
	11, // 10: viam.component.gripper.v1.GripperService.GetKinematics:input_type -> viam.common.v1.GetKinematicsRequest
	1,  // 11: viam.component.gripper.v1.GripperService.Open:output_type -> viam.component.gripper.v1.OpenResponse
	3,  // 12: viam.component.gripper.v1.GripperService.Grab:output_type -> viam.component.gripper.v1.GrabResponse
	5,  // 13: viam.component.gripper.v1.GripperService.Stop:output_type -> viam.component.gripper.v1.StopResponse
	7,  // 14: viam.component.gripper.v1.GripperService.IsMoving:output_type -> viam.component.gripper.v1.IsMovingResponse
	12, // 15: viam.component.gripper.v1.GripperService.DoCommand:output_type -> viam.common.v1.DoCommandResponse
	13, // 16: viam.component.gripper.v1.GripperService.GetGeometries:output_type -> viam.common.v1.GetGeometriesResponse
	14, // 17: viam.component.gripper.v1.GripperService.GetKinematics:output_type -> viam.common.v1.GetKinematicsResponse
