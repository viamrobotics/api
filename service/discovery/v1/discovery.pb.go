...
var file_service_discovery_v1_discovery_proto_rawDesc = []byte{
	...
	0x65, 0x72, 0x69, 0x65, 0x73, 0x32, 0xdc, 0x03, 0x0a, 0x10, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76,
	...
	0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x8a, 0x01, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x53,
	...
	0x72, 0x79, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x2f, 0x67, 0x65, 0x74, 0x5f, 0x73, 0x74,
	0x61, 0x74, 0x75, 0x73, 0x42, 0x44, 0x0a, 0x1d, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x69, 0x61, 0x6d,
	...
	0x6f, 0x6d, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x64,
	0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x79, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_service_discovery_v1_discovery_proto_goTypes = []any{
	...
	(*v11.GetStatusRequest)(nil),      // 5: viam.common.v1.GetStatusRequest
	(*v11.DoCommandResponse)(nil),     // 6: viam.common.v1.DoCommandResponse
	(*v11.GetStatusResponse)(nil),     // 7: viam.common.v1.GetStatusResponse
}
var file_service_discovery_v1_discovery_proto_depIdxs = []int32{
	...
	5, // 4: viam.service.discovery.v1.DiscoveryService.GetStatus:input_type -> viam.common.v1.GetStatusRequest
	1, // 5: viam.service.discovery.v1.DiscoveryService.DiscoverResources:output_type -> viam.service.discovery.v1.DiscoverResourcesResponse
	6, // 6: viam.service.discovery.v1.DiscoveryService.DoCommand:output_type -> viam.common.v1.DoCommandResponse
	7, // 7: viam.service.discovery.v1.DiscoveryService.GetStatus:output_type -> viam.common.v1.GetStatusResponse
