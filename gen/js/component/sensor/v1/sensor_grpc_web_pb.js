 ...
 */
const methodDescriptor_SensorService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.component.sensor.v1.SensorServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.component.sensor.v1.SensorService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_SensorService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.component.sensor.v1.SensorServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.component.sensor.v1.SensorService/GetStatus',
      request,
