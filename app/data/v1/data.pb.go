...
var file_app_data_v1_data_proto_rawDesc = []byte{
	...
	0x6e, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x22, 0x81, 0x01, 0x0a, 0x20, 0x42, 0x69, 0x6e, 0x61,
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x09, 0x6a, 0x73, 0x6f, 0x6e, 0x4c, 0x69, 0x6e, 0x65, 0x73, 0x2a,
	...
	0x6e, 0x64, 0x65, 0x78, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x84, 0x01, 0x0a,
	0x19, 0x42, 0x69, 0x6e, 0x61, 0x72, 0x79, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x54,
	0x6f, 0x4a, 0x53, 0x4f, 0x4e, 0x4c, 0x69, 0x6e, 0x65, 0x73, 0x12, 0x32, 0x2e, 0x76, 0x69, 0x61,
	0x6d, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x42, 0x69,
	0x6e, 0x61, 0x72, 0x79, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x54, 0x6f, 0x4a, 0x53,
	0x4f, 0x4e, 0x4c, 0x69, 0x6e, 0x65, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x33,
	0x2e, 0x76, 0x69, 0x61, 0x6d, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x76,
...
var file_app_data_v1_data_proto_goTypes = []any{
	...
	(*BinaryMetadataToJSONLinesRequest)(nil),         // 71: viam.app.data.v1.BinaryMetadataToJSONLinesRequest
	(*BinaryMetadataToJSONLinesResponse)(nil),        // 72: viam.app.data.v1.BinaryMetadataToJSONLinesResponse
...
var file_app_data_v1_data_proto_depIdxs = []int32{
	...
	31, // 55: viam.app.data.v1.BinaryMetadataToJSONLinesRequest.binary_metadata:type_name -> viam.app.data.v1.BinaryMetadata
	...
	64, // 80: viam.app.data.v1.DataService.CreateIndex:input_type -> viam.app.data.v1.CreateIndexRequest
	68, // 81: viam.app.data.v1.DataService.ListIndexes:input_type -> viam.app.data.v1.ListIndexesRequest
	66, // 82: viam.app.data.v1.DataService.DeleteIndex:input_type -> viam.app.data.v1.DeleteIndexRequest
	71, // 83: viam.app.data.v1.DataService.BinaryMetadataToJSONLines:input_type -> viam.app.data.v1.BinaryMetadataToJSONLinesRequest
	...
	65, // 107: viam.app.data.v1.DataService.CreateIndex:output_type -> viam.app.data.v1.CreateIndexResponse
	69, // 108: viam.app.data.v1.DataService.ListIndexes:output_type -> viam.app.data.v1.ListIndexesResponse
	67, // 109: viam.app.data.v1.DataService.DeleteIndex:output_type -> viam.app.data.v1.DeleteIndexResponse
	72, // 110: viam.app.data.v1.DataService.BinaryMetadataToJSONLines:output_type -> viam.app.data.v1.BinaryMetadataToJSONLinesResponse
