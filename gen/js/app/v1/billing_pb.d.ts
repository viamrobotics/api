...
export class CreateBillingTierRequest extends jspb.Message {
  getTierName(): string;
  setTierName(value: string): void;

  clearResourceCostsList(): void;
  getResourceCostsList(): Array<UsageCost>;
  setResourceCostsList(value: Array<UsageCost>): void;
  addResourceCosts(value?: UsageCost, index?: number): UsageCost;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): CreateBillingTierRequest.AsObject;
  static toObject(includeInstance: boolean, msg: CreateBillingTierRequest): CreateBillingTierRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: CreateBillingTierRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): CreateBillingTierRequest;
  static deserializeBinaryFromReader(message: CreateBillingTierRequest, reader: jspb.BinaryReader): CreateBillingTierRequest;
}

export namespace CreateBillingTierRequest {
  export type AsObject = {
    tierName: string,
    resourceCostsList: Array<UsageCost.AsObject>,
    discount: number,
  }
}

export class CreateBillingTierResponse extends jspb.Message {
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): CreateBillingTierResponse.AsObject;
  static toObject(includeInstance: boolean, msg: CreateBillingTierResponse): CreateBillingTierResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: CreateBillingTierResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): CreateBillingTierResponse;
  static deserializeBinaryFromReader(message: CreateBillingTierResponse, reader: jspb.BinaryReader): CreateBillingTierResponse;
}

export namespace CreateBillingTierResponse {
  export type AsObject = {
  }
}
