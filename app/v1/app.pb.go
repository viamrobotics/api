...
var file_app_v1_app_proto_msgTypes = make([]protoimpl.MessageInfo, 99)
...
var file_app_v1_app_proto_depIdxs = []int32{
	100, // 0: viam.app.v1.Robot.last_access:type_name -> google.protobuf.Timestamp
	100, // 1: viam.app.v1.Robot.created_on:type_name -> google.protobuf.Timestamp
	101, // 2: viam.app.v1.RobotPart.robot_config:type_name -> google.protobuf.Struct
	100, // 3: viam.app.v1.RobotPart.last_access:type_name -> google.protobuf.Timestamp
	101, // 4: viam.app.v1.RobotPart.user_supplied_info:type_name -> google.protobuf.Struct
	100, // 5: viam.app.v1.RobotPart.created_on:type_name -> google.protobuf.Timestamp
	30,  // 6: viam.app.v1.RobotPart.secrets:type_name -> viam.app.v1.SharedSecret
	100, // 7: viam.app.v1.RobotPartHistoryEntry.when:type_name -> google.protobuf.Timestamp
	2,   // 8: viam.app.v1.RobotPartHistoryEntry.old:type_name -> viam.app.v1.RobotPart
	100, // 9: viam.app.v1.Organization.created_on:type_name -> google.protobuf.Timestamp
	100, // 10: viam.app.v1.OrganizationMember.date_added:type_name -> google.protobuf.Timestamp
	5,   // 11: viam.app.v1.ListOrganizationsResponse.organizations:type_name -> viam.app.v1.Organization
	100, // 12: viam.app.v1.OrganizationInvite.created_on:type_name -> google.protobuf.Timestamp
	...
	100, // 23: viam.app.v1.Location.created_on:type_name -> google.protobuf.Timestamp
	100, // 24: viam.app.v1.SharedSecret.created_on:type_name -> google.protobuf.Timestamp
	...
	100, // 36: viam.app.v1.LogEntry.time:type_name -> google.protobuf.Timestamp
	101, // 37: viam.app.v1.LogEntry.caller:type_name -> google.protobuf.Struct
	101, // 38: viam.app.v1.LogEntry.fields:type_name -> google.protobuf.Struct
	...
	101, // 42: viam.app.v1.UpdateRobotPartRequest.robot_config:type_name -> google.protobuf.Struct
	2,   // 43: viam.app.v1.UpdateRobotPartResponse.part:type_name -> viam.app.v1.RobotPart
	101, // 44: viam.app.v1.Fragment.fragment:type_name -> google.protobuf.Struct
	100, // 45: viam.app.v1.Fragment.created_on:type_name -> google.protobuf.Timestamp
	...
	101, // 48: viam.app.v1.CreateFragmentRequest.config:type_name -> google.protobuf.Struct
	73,  // 49: viam.app.v1.CreateFragmentResponse.fragment:type_name -> viam.app.v1.Fragment
	101, // 50: viam.app.v1.UpdateFragmentRequest.config:type_name -> google.protobuf.Struct
	...
	9,   // 55: viam.app.v1.AppService.CreateOrganization:input_type -> viam.app.v1.CreateOrganizationRequest
	4,   // 56: viam.app.v1.AppService.ListOrganizations:input_type -> viam.app.v1.ListOrganizationsRequest
	11,  // 57: viam.app.v1.AppService.GetOrganization:input_type -> viam.app.v1.GetOrganizationRequest
	13,  // 58: viam.app.v1.AppService.UpdateOrganization:input_type -> viam.app.v1.UpdateOrganizationRequest
	15,  // 59: viam.app.v1.AppService.DeleteOrganization:input_type -> viam.app.v1.DeleteOrganizationRequest
	17,  // 60: viam.app.v1.AppService.ListOrganizationMembers:input_type -> viam.app.v1.ListOrganizationMembersRequest
	19,  // 61: viam.app.v1.AppService.CreateOrganizationInvite:input_type -> viam.app.v1.CreateOrganizationInviteRequest
	25,  // 62: viam.app.v1.AppService.DeleteOrganizationMember:input_type -> viam.app.v1.DeleteOrganizationMemberRequest
	21,  // 63: viam.app.v1.AppService.DeleteOrganizationInvite:input_type -> viam.app.v1.DeleteOrganizationInviteRequest
	23,  // 64: viam.app.v1.AppService.ResendOrganizationInvite:input_type -> viam.app.v1.ResendOrganizationInviteRequest
	31,  // 65: viam.app.v1.AppService.CreateLocation:input_type -> viam.app.v1.CreateLocationRequest
	33,  // 66: viam.app.v1.AppService.GetLocation:input_type -> viam.app.v1.GetLocationRequest
	35,  // 67: viam.app.v1.AppService.UpdateLocation:input_type -> viam.app.v1.UpdateLocationRequest
	37,  // 68: viam.app.v1.AppService.DeleteLocation:input_type -> viam.app.v1.DeleteLocationRequest
	39,  // 69: viam.app.v1.AppService.ListLocations:input_type -> viam.app.v1.ListLocationsRequest
	40,  // 70: viam.app.v1.AppService.ShareLocation:input_type -> viam.app.v1.ShareLocationRequest
	42,  // 71: viam.app.v1.AppService.UnshareLocation:input_type -> viam.app.v1.UnshareLocationRequest
	49,  // 72: viam.app.v1.AppService.LocationAuth:input_type -> viam.app.v1.LocationAuthRequest
	45,  // 73: viam.app.v1.AppService.CreateLocationSecret:input_type -> viam.app.v1.CreateLocationSecretRequest
	47,  // 74: viam.app.v1.AppService.DeleteLocationSecret:input_type -> viam.app.v1.DeleteLocationSecretRequest
	51,  // 75: viam.app.v1.AppService.GetRobot:input_type -> viam.app.v1.GetRobotRequest
	52,  // 76: viam.app.v1.AppService.GetRoverRentalRobots:input_type -> viam.app.v1.GetRoverRentalRobotsRequest
	56,  // 77: viam.app.v1.AppService.GetRobotParts:input_type -> viam.app.v1.GetRobotPartsRequest
	58,  // 78: viam.app.v1.AppService.GetRobotPart:input_type -> viam.app.v1.GetRobotPartRequest
	60,  // 79: viam.app.v1.AppService.GetRobotPartLogs:input_type -> viam.app.v1.GetRobotPartLogsRequest
	63,  // 80: viam.app.v1.AppService.TailRobotPartLogs:input_type -> viam.app.v1.TailRobotPartLogsRequest
	65,  // 81: viam.app.v1.AppService.GetRobotPartHistory:input_type -> viam.app.v1.GetRobotPartHistoryRequest
	67,  // 82: viam.app.v1.AppService.UpdateRobotPart:input_type -> viam.app.v1.UpdateRobotPartRequest
	69,  // 83: viam.app.v1.AppService.NewRobotPart:input_type -> viam.app.v1.NewRobotPartRequest
	71,  // 84: viam.app.v1.AppService.DeleteRobotPart:input_type -> viam.app.v1.DeleteRobotPartRequest
	92,  // 85: viam.app.v1.AppService.MarkPartAsMain:input_type -> viam.app.v1.MarkPartAsMainRequest
	94,  // 86: viam.app.v1.AppService.MarkPartForRestart:input_type -> viam.app.v1.MarkPartForRestartRequest
	96,  // 87: viam.app.v1.AppService.CreateRobotPartSecret:input_type -> viam.app.v1.CreateRobotPartSecretRequest
	98,  // 88: viam.app.v1.AppService.DeleteRobotPartSecret:input_type -> viam.app.v1.DeleteRobotPartSecretRequest
	84,  // 89: viam.app.v1.AppService.ListRobots:input_type -> viam.app.v1.ListRobotsRequest
	86,  // 90: viam.app.v1.AppService.NewRobot:input_type -> viam.app.v1.NewRobotRequest
	88,  // 91: viam.app.v1.AppService.UpdateRobot:input_type -> viam.app.v1.UpdateRobotRequest
	90,  // 92: viam.app.v1.AppService.DeleteRobot:input_type -> viam.app.v1.DeleteRobotRequest
	74,  // 93: viam.app.v1.AppService.ListFragments:input_type -> viam.app.v1.ListFragmentsRequest
	76,  // 94: viam.app.v1.AppService.GetFragment:input_type -> viam.app.v1.GetFragmentRequest
	78,  // 95: viam.app.v1.AppService.CreateFragment:input_type -> viam.app.v1.CreateFragmentRequest
	80,  // 96: viam.app.v1.AppService.UpdateFragment:input_type -> viam.app.v1.UpdateFragmentRequest
	82,  // 97: viam.app.v1.AppService.DeleteFragment:input_type -> viam.app.v1.DeleteFragmentRequest
	10,  // 98: viam.app.v1.AppService.CreateOrganization:output_type -> viam.app.v1.CreateOrganizationResponse
	7,   // 99: viam.app.v1.AppService.ListOrganizations:output_type -> viam.app.v1.ListOrganizationsResponse
	12,  // 100: viam.app.v1.AppService.GetOrganization:output_type -> viam.app.v1.GetOrganizationResponse
	14,  // 101: viam.app.v1.AppService.UpdateOrganization:output_type -> viam.app.v1.UpdateOrganizationResponse
	16,  // 102: viam.app.v1.AppService.DeleteOrganization:output_type -> viam.app.v1.DeleteOrganizationResponse
	18,  // 103: viam.app.v1.AppService.ListOrganizationMembers:output_type -> viam.app.v1.ListOrganizationMembersResponse
	20,  // 104: viam.app.v1.AppService.CreateOrganizationInvite:output_type -> viam.app.v1.CreateOrganizationInviteResponse
	26,  // 105: viam.app.v1.AppService.DeleteOrganizationMember:output_type -> viam.app.v1.DeleteOrganizationMemberResponse
	22,  // 106: viam.app.v1.AppService.DeleteOrganizationInvite:output_type -> viam.app.v1.DeleteOrganizationInviteResponse
	24,  // 107: viam.app.v1.AppService.ResendOrganizationInvite:output_type -> viam.app.v1.ResendOrganizationInviteResponse
	32,  // 108: viam.app.v1.AppService.CreateLocation:output_type -> viam.app.v1.CreateLocationResponse
	34,  // 109: viam.app.v1.AppService.GetLocation:output_type -> viam.app.v1.GetLocationResponse
	36,  // 110: viam.app.v1.AppService.UpdateLocation:output_type -> viam.app.v1.UpdateLocationResponse
	38,  // 111: viam.app.v1.AppService.DeleteLocation:output_type -> viam.app.v1.DeleteLocationResponse
	44,  // 112: viam.app.v1.AppService.ListLocations:output_type -> viam.app.v1.ListLocationsResponse
	41,  // 113: viam.app.v1.AppService.ShareLocation:output_type -> viam.app.v1.ShareLocationResponse
	43,  // 114: viam.app.v1.AppService.UnshareLocation:output_type -> viam.app.v1.UnshareLocationResponse
	50,  // 115: viam.app.v1.AppService.LocationAuth:output_type -> viam.app.v1.LocationAuthResponse
	46,  // 116: viam.app.v1.AppService.CreateLocationSecret:output_type -> viam.app.v1.CreateLocationSecretResponse
	48,  // 117: viam.app.v1.AppService.DeleteLocationSecret:output_type -> viam.app.v1.DeleteLocationSecretResponse
	55,  // 118: viam.app.v1.AppService.GetRobot:output_type -> viam.app.v1.GetRobotResponse
	54,  // 119: viam.app.v1.AppService.GetRoverRentalRobots:output_type -> viam.app.v1.GetRoverRentalRobotsResponse
	57,  // 120: viam.app.v1.AppService.GetRobotParts:output_type -> viam.app.v1.GetRobotPartsResponse
	59,  // 121: viam.app.v1.AppService.GetRobotPart:output_type -> viam.app.v1.GetRobotPartResponse
	62,  // 122: viam.app.v1.AppService.GetRobotPartLogs:output_type -> viam.app.v1.GetRobotPartLogsResponse
	64,  // 123: viam.app.v1.AppService.TailRobotPartLogs:output_type -> viam.app.v1.TailRobotPartLogsResponse
	66,  // 124: viam.app.v1.AppService.GetRobotPartHistory:output_type -> viam.app.v1.GetRobotPartHistoryResponse
	68,  // 125: viam.app.v1.AppService.UpdateRobotPart:output_type -> viam.app.v1.UpdateRobotPartResponse
	70,  // 126: viam.app.v1.AppService.NewRobotPart:output_type -> viam.app.v1.NewRobotPartResponse
	72,  // 127: viam.app.v1.AppService.DeleteRobotPart:output_type -> viam.app.v1.DeleteRobotPartResponse
	93,  // 128: viam.app.v1.AppService.MarkPartAsMain:output_type -> viam.app.v1.MarkPartAsMainResponse
	95,  // 129: viam.app.v1.AppService.MarkPartForRestart:output_type -> viam.app.v1.MarkPartForRestartResponse
	97,  // 130: viam.app.v1.AppService.CreateRobotPartSecret:output_type -> viam.app.v1.CreateRobotPartSecretResponse
	99,  // 131: viam.app.v1.AppService.DeleteRobotPartSecret:output_type -> viam.app.v1.DeleteRobotPartSecretResponse
	85,  // 132: viam.app.v1.AppService.ListRobots:output_type -> viam.app.v1.ListRobotsResponse
	87,  // 133: viam.app.v1.AppService.NewRobot:output_type -> viam.app.v1.NewRobotResponse
	89,  // 134: viam.app.v1.AppService.UpdateRobot:output_type -> viam.app.v1.UpdateRobotResponse
	91,  // 135: viam.app.v1.AppService.DeleteRobot:output_type -> viam.app.v1.DeleteRobotResponse
	75,  // 136: viam.app.v1.AppService.ListFragments:output_type -> viam.app.v1.ListFragmentsResponse
	77,  // 137: viam.app.v1.AppService.GetFragment:output_type -> viam.app.v1.GetFragmentResponse
	79,  // 138: viam.app.v1.AppService.CreateFragment:output_type -> viam.app.v1.CreateFragmentResponse
	81,  // 139: viam.app.v1.AppService.UpdateFragment:output_type -> viam.app.v1.UpdateFragmentResponse
	83,  // 140: viam.app.v1.AppService.DeleteFragment:output_type -> viam.app.v1.DeleteFragmentResponse
