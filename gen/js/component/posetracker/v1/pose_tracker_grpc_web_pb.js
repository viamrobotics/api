 ...
 */
const methodDescriptor_PoseTrackerService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.component.posetracker.v1.PoseTrackerServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.component.posetracker.v1.PoseTrackerService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_PoseTrackerService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.component.posetracker.v1.PoseTrackerServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.component.posetracker.v1.PoseTrackerService/GetStatus',
      request,
