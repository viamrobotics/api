...
const (
	PoseTrackerService_GetPoses_FullMethodName      = "/viam.component.posetracker.v1.PoseTrackerService/GetPoses"
	PoseTrackerService_DoCommand_FullMethodName     = "/viam.component.posetracker.v1.PoseTrackerService/DoCommand"
	PoseTrackerService_GetGeometries_FullMethodName = "/viam.component.posetracker.v1.PoseTrackerService/GetGeometries"
)
...
func (c *poseTrackerServiceClient) GetPoses(ctx context.Context, in *GetPosesRequest, opts ...grpc.CallOption) (*GetPosesResponse, error) {
	...
	err := c.cc.Invoke(ctx, PoseTrackerService_GetPoses_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *poseTrackerServiceClient) DoCommand(ctx context.Context, in *v1.DoCommandRequest, opts ...grpc.CallOption) (*v1.DoCommandResponse, error) {
	...
	err := c.cc.Invoke(ctx, PoseTrackerService_DoCommand_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *poseTrackerServiceClient) GetGeometries(ctx context.Context, in *v1.GetGeometriesRequest, opts ...grpc.CallOption) (*v1.GetGeometriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, PoseTrackerService_GetGeometries_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPoseTrackerServiceServer must be embedded to have
...
func (UnimplementedPoseTrackerServiceServer) testEmbeddedByValue()                            {}
...
func RegisterPoseTrackerServiceServer(s grpc.ServiceRegistrar, srv PoseTrackerServiceServer) {
	// If the following call pancis, it indicates UnimplementedPoseTrackerServiceServer was
...
func _PoseTrackerService_GetPoses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoseTrackerService_GetPoses_FullMethodName,
	}
...
func _PoseTrackerService_DoCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoseTrackerService_DoCommand_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PoseTrackerService_GetGeometries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PoseTrackerService_GetGeometries_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
