...
var file_robot_v1_robot_proto_rawDesc = []byte{
	...
	0x79, 0x70, 0x65, 0x73, 0x22, 0xa0, 0x01, 0x0a, 0x09, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69,
	...
	0x73, 0x74, 0x61, 0x72, 0x74, 0x65, 0x64, 0x22, 0x16, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x4f, 0x70,
	...
	0x41, 0x6c, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xdb, 0x0b, 0x0a, 0x0c,
	...
	0x70, 0x6f, 0x73, 0x65, 0x12, 0x6b, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x73, 0x12, 0x7d, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x74, 0x61, 0x74, 0x75,
	...
	0x2f, 0x73, 0x74, 0x6f, 0x70, 0x5f, 0x61, 0x6c, 0x6c, 0x42, 0x2d, 0x0a, 0x11, 0x63, 0x6f, 0x6d,
...
var file_robot_v1_robot_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_robot_v1_robot_proto_goTypes = []interface{}{
	(*FrameSystemConfig)(nil),           // 0: viam.robot.v1.FrameSystemConfig
	(*FrameSystemConfigRequest)(nil),    // 1: viam.robot.v1.FrameSystemConfigRequest
	(*FrameSystemConfigResponse)(nil),   // 2: viam.robot.v1.FrameSystemConfigResponse
	(*TransformPoseRequest)(nil),        // 3: viam.robot.v1.TransformPoseRequest
	(*TransformPoseResponse)(nil),       // 4: viam.robot.v1.TransformPoseResponse
	(*ResourceNamesRequest)(nil),        // 5: viam.robot.v1.ResourceNamesRequest
	(*ResourceNamesResponse)(nil),       // 6: viam.robot.v1.ResourceNamesResponse
	(*ResourceRPCSubtype)(nil),          // 7: viam.robot.v1.ResourceRPCSubtype
	(*ResourceRPCSubtypesRequest)(nil),  // 8: viam.robot.v1.ResourceRPCSubtypesRequest
	(*ResourceRPCSubtypesResponse)(nil), // 9: viam.robot.v1.ResourceRPCSubtypesResponse
	(*Operation)(nil),                   // 10: viam.robot.v1.Operation
	(*GetOperationsRequest)(nil),        // 11: viam.robot.v1.GetOperationsRequest
	(*GetOperationsResponse)(nil),       // 12: viam.robot.v1.GetOperationsResponse
	(*CancelOperationRequest)(nil),      // 13: viam.robot.v1.CancelOperationRequest
	(*CancelOperationResponse)(nil),     // 14: viam.robot.v1.CancelOperationResponse
	(*BlockForOperationRequest)(nil),    // 15: viam.robot.v1.BlockForOperationRequest
	(*BlockForOperationResponse)(nil),   // 16: viam.robot.v1.BlockForOperationResponse
	(*DiscoveryQuery)(nil),              // 17: viam.robot.v1.DiscoveryQuery
	(*Discovery)(nil),                   // 18: viam.robot.v1.Discovery
	(*DiscoverComponentsRequest)(nil),   // 19: viam.robot.v1.DiscoverComponentsRequest
	(*DiscoverComponentsResponse)(nil),  // 20: viam.robot.v1.DiscoverComponentsResponse
	(*Status)(nil),                      // 21: viam.robot.v1.Status
	(*GetStatusRequest)(nil),            // 22: viam.robot.v1.GetStatusRequest
	(*GetStatusResponse)(nil),           // 23: viam.robot.v1.GetStatusResponse
	(*StreamStatusRequest)(nil),         // 24: viam.robot.v1.StreamStatusRequest
	(*StreamStatusResponse)(nil),        // 25: viam.robot.v1.StreamStatusResponse
	(*StopExtraParameters)(nil),         // 26: viam.robot.v1.StopExtraParameters
	(*StopAllRequest)(nil),              // 27: viam.robot.v1.StopAllRequest
	(*StopAllResponse)(nil),             // 28: viam.robot.v1.StopAllResponse
	(*v1.PoseInFrame)(nil),              // 29: viam.common.v1.PoseInFrame
	(*v1.Transform)(nil),                // 30: viam.common.v1.Transform
...
var file_robot_v1_robot_proto_depIdxs = []int32{
	29, // 0: viam.robot.v1.FrameSystemConfig.pose_in_parent_frame:type_name -> viam.common.v1.PoseInFrame
	30, // 1: viam.robot.v1.FrameSystemConfigRequest.supplemental_transforms:type_name -> viam.common.v1.Transform
	0,  // 2: viam.robot.v1.FrameSystemConfigResponse.frame_system_configs:type_name -> viam.robot.v1.FrameSystemConfig
	29, // 3: viam.robot.v1.TransformPoseRequest.source:type_name -> viam.common.v1.PoseInFrame
	30, // 4: viam.robot.v1.TransformPoseRequest.supplemental_transforms:type_name -> viam.common.v1.Transform
	29, // 5: viam.robot.v1.TransformPoseResponse.pose:type_name -> viam.common.v1.PoseInFrame
	31, // 6: viam.robot.v1.ResourceNamesResponse.resources:type_name -> viam.common.v1.ResourceName
	31, // 7: viam.robot.v1.ResourceRPCSubtype.subtype:type_name -> viam.common.v1.ResourceName
	7,  // 8: viam.robot.v1.ResourceRPCSubtypesResponse.resource_rpc_subtypes:type_name -> viam.robot.v1.ResourceRPCSubtype
	32, // 9: viam.robot.v1.Operation.arguments:type_name -> google.protobuf.Struct
	33, // 10: viam.robot.v1.Operation.started:type_name -> google.protobuf.Timestamp
	10, // 11: viam.robot.v1.GetOperationsResponse.operations:type_name -> viam.robot.v1.Operation
	17, // 12: viam.robot.v1.Discovery.query:type_name -> viam.robot.v1.DiscoveryQuery
	32, // 13: viam.robot.v1.Discovery.results:type_name -> google.protobuf.Struct
	17, // 14: viam.robot.v1.DiscoverComponentsRequest.queries:type_name -> viam.robot.v1.DiscoveryQuery
	18, // 15: viam.robot.v1.DiscoverComponentsResponse.discovery:type_name -> viam.robot.v1.Discovery
	31, // 16: viam.robot.v1.Status.name:type_name -> viam.common.v1.ResourceName
	32, // 17: viam.robot.v1.Status.status:type_name -> google.protobuf.Struct
	31, // 18: viam.robot.v1.GetStatusRequest.resource_names:type_name -> viam.common.v1.ResourceName
	21, // 19: viam.robot.v1.GetStatusResponse.status:type_name -> viam.robot.v1.Status
	31, // 20: viam.robot.v1.StreamStatusRequest.resource_names:type_name -> viam.common.v1.ResourceName
	34, // 21: viam.robot.v1.StreamStatusRequest.every:type_name -> google.protobuf.Duration
	21, // 22: viam.robot.v1.StreamStatusResponse.status:type_name -> viam.robot.v1.Status
	31, // 23: viam.robot.v1.StopExtraParameters.name:type_name -> viam.common.v1.ResourceName
	32, // 24: viam.robot.v1.StopExtraParameters.params:type_name -> google.protobuf.Struct
	26, // 25: viam.robot.v1.StopAllRequest.extra:type_name -> viam.robot.v1.StopExtraParameters
	11, // 26: viam.robot.v1.RobotService.GetOperations:input_type -> viam.robot.v1.GetOperationsRequest
	5,  // 27: viam.robot.v1.RobotService.ResourceNames:input_type -> viam.robot.v1.ResourceNamesRequest
	8,  // 28: viam.robot.v1.RobotService.ResourceRPCSubtypes:input_type -> viam.robot.v1.ResourceRPCSubtypesRequest
	13, // 29: viam.robot.v1.RobotService.CancelOperation:input_type -> viam.robot.v1.CancelOperationRequest
	15, // 30: viam.robot.v1.RobotService.BlockForOperation:input_type -> viam.robot.v1.BlockForOperationRequest
	19, // 31: viam.robot.v1.RobotService.DiscoverComponents:input_type -> viam.robot.v1.DiscoverComponentsRequest
	1,  // 32: viam.robot.v1.RobotService.FrameSystemConfig:input_type -> viam.robot.v1.FrameSystemConfigRequest
	3,  // 33: viam.robot.v1.RobotService.TransformPose:input_type -> viam.robot.v1.TransformPoseRequest
	22, // 34: viam.robot.v1.RobotService.GetStatus:input_type -> viam.robot.v1.GetStatusRequest
	24, // 35: viam.robot.v1.RobotService.StreamStatus:input_type -> viam.robot.v1.StreamStatusRequest
	27, // 36: viam.robot.v1.RobotService.StopAll:input_type -> viam.robot.v1.StopAllRequest
	12, // 37: viam.robot.v1.RobotService.GetOperations:output_type -> viam.robot.v1.GetOperationsResponse
	6,  // 38: viam.robot.v1.RobotService.ResourceNames:output_type -> viam.robot.v1.ResourceNamesResponse
	9,  // 39: viam.robot.v1.RobotService.ResourceRPCSubtypes:output_type -> viam.robot.v1.ResourceRPCSubtypesResponse
	14, // 40: viam.robot.v1.RobotService.CancelOperation:output_type -> viam.robot.v1.CancelOperationResponse
	16, // 41: viam.robot.v1.RobotService.BlockForOperation:output_type -> viam.robot.v1.BlockForOperationResponse
	20, // 42: viam.robot.v1.RobotService.DiscoverComponents:output_type -> viam.robot.v1.DiscoverComponentsResponse
	2,  // 43: viam.robot.v1.RobotService.FrameSystemConfig:output_type -> viam.robot.v1.FrameSystemConfigResponse
	4,  // 44: viam.robot.v1.RobotService.TransformPose:output_type -> viam.robot.v1.TransformPoseResponse
	23, // 45: viam.robot.v1.RobotService.GetStatus:output_type -> viam.robot.v1.GetStatusResponse
	25, // 46: viam.robot.v1.RobotService.StreamStatus:output_type -> viam.robot.v1.StreamStatusResponse
	28, // 47: viam.robot.v1.RobotService.StopAll:output_type -> viam.robot.v1.StopAllResponse
