...
func file_service_navigation_v1_navigation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_service_navigation_v1_navigation_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
		...
		file_service_navigation_v1_navigation_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
