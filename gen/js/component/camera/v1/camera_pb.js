...
goog.exportSymbol('proto.viam.component.camera.v1.Video', null, global);
 ...
 * @constructor
 */
proto.viam.component.camera.v1.Video = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.viam.component.camera.v1.Video, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viam.component.camera.v1.Video.displayName = 'proto.viam.component.camera.v1.Video';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.viam.component.camera.v1.Property.toObject = function(includeInstance, msg) {
  var f, obj = {
    video: (f = msg.getVideo()) && proto.viam.component.camera.v1.Video.toObject(includeInstance, f),
    width: jspb.Message.getFieldWithDefault(msg, 2, 0),
    height: jspb.Message.getFieldWithDefault(msg, 3, 0),
    frameFormat: jspb.Message.getFieldWithDefault(msg, 4, "")
  };
...
proto.viam.component.camera.v1.Property.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.viam.component.camera.v1.Video;
      reader.readMessage(value,proto.viam.component.camera.v1.Video.deserializeBinaryFromReader);
      msg.setVideo(value);
      break;
    case 2:
...
proto.viam.component.camera.v1.Property.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.viam.component.camera.v1.Video.serializeBinaryToWriter
    );
  }
  f = message.getWidth();
  if (f !== 0) {
 ...
 * @return {?proto.viam.component.camera.v1.Video}
 */
proto.viam.component.camera.v1.Property.prototype.getVideo = function() {
  return /** @type{?proto.viam.component.camera.v1.Video} */ (
    jspb.Message.getWrapperField(this, proto.viam.component.camera.v1.Video, 1));
};


/**
 * @param {?proto.viam.component.camera.v1.Video|undefined} value
 * @return {!proto.viam.component.camera.v1.Property} returns this
*/
proto.viam.component.camera.v1.Property.prototype.setVideo = function(value) {
 ...
 * @return {!proto.viam.component.camera.v1.Property} returns this
 */
proto.viam.component.camera.v1.Property.prototype.clearVideo = function() {
 ...
 * @return {boolean}
 */
proto.viam.component.camera.v1.Property.prototype.hasVideo = function() {
...
/**
 * optional string frame_format = 4;
 * @return {string}
 */
 ...
 * @return {!Object}
 */
proto.viam.component.camera.v1.Video.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.component.camera.v1.Video.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.component.camera.v1.Video} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.component.camera.v1.Video.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * @return {!proto.viam.component.camera.v1.Video}
 */
proto.viam.component.camera.v1.Video.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.component.camera.v1.Video;
  return proto.viam.component.camera.v1.Video.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.component.camera.v1.Video} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.component.camera.v1.Video}
 */
proto.viam.component.camera.v1.Video.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.component.camera.v1.Video.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.component.camera.v1.Video.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.component.camera.v1.Video} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.component.camera.v1.Video.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getWidth();
  if (f !== 0) {
    writer.writeInt32(
 ...
 * @return {number}
 */
proto.viam.component.camera.v1.Video.prototype.getWidth = function() {
...
/**
 * @param {number} value
 * @return {!proto.viam.component.camera.v1.Video} returns this
 */
proto.viam.component.camera.v1.Video.prototype.setWidth = function(value) {
 ...
 * @return {number}
 */
proto.viam.component.camera.v1.Video.prototype.getHeight = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};
 ...
 * @return {!proto.viam.component.camera.v1.Video} returns this
 */
proto.viam.component.camera.v1.Video.prototype.setHeight = function(value) {
  return jspb.Message.setProto3IntField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.viam.component.camera.v1.Video.prototype.getFrameFormat = function() {
 ...
 * @return {!proto.viam.component.camera.v1.Video} returns this
 */
proto.viam.component.camera.v1.Video.prototype.setFrameFormat = function(value) {
