...
AppService.GetOrganizationSummary = {
  methodName: "GetOrganizationSummary",
  service: AppService,
  requestStream: false,
  responseStream: false,
  requestType: app_v1_app_pb.GetOrganizationSummaryRequest,
  responseType: app_v1_app_pb.GetOrganizationSummaryResponse
};
...
AppServiceClient.prototype.getOrganizationSummary = function getOrganizationSummary(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(AppService.GetOrganizationSummary, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
