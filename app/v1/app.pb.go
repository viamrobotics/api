...
type ResendOrganizationInviteRequest struct {
	...
	OrganizationId string `protobuf:"bytes,1,opt,name=organization_id,json=organizationId,proto3" json:"organization_id,omitempty"`
	Email          string `protobuf:"bytes,2,opt,name=email,proto3" json:"email,omitempty"`
	Tmp            string `protobuf:"bytes,3,opt,name=tmp,proto3" json:"tmp,omitempty"`
}
...
func (x *ResendOrganizationInviteRequest) GetTmp() string {
	if x != nil {
		return x.Tmp
	}
	return ""
...
var file_app_v1_app_proto_rawDesc = []byte{
	...
	0x76, 0x69, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x72, 0x0a, 0x1f,
	...
	0x0a, 0x03, 0x74, 0x6d, 0x70, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x74, 0x6d, 0x70,
