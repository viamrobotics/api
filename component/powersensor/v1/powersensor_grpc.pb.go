...
const (
	PowerSensorService_GetVoltage_FullMethodName  = "/viam.component.powersensor.v1.PowerSensorService/GetVoltage"
	PowerSensorService_GetCurrent_FullMethodName  = "/viam.component.powersensor.v1.PowerSensorService/GetCurrent"
	PowerSensorService_GetPower_FullMethodName    = "/viam.component.powersensor.v1.PowerSensorService/GetPower"
	PowerSensorService_GetReadings_FullMethodName = "/viam.component.powersensor.v1.PowerSensorService/GetReadings"
	PowerSensorService_DoCommand_FullMethodName   = "/viam.component.powersensor.v1.PowerSensorService/DoCommand"
)
...
func (c *powerSensorServiceClient) GetVoltage(ctx context.Context, in *GetVoltageRequest, opts ...grpc.CallOption) (*GetVoltageResponse, error) {
	...
	err := c.cc.Invoke(ctx, PowerSensorService_GetVoltage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *powerSensorServiceClient) GetCurrent(ctx context.Context, in *GetCurrentRequest, opts ...grpc.CallOption) (*GetCurrentResponse, error) {
	...
	err := c.cc.Invoke(ctx, PowerSensorService_GetCurrent_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *powerSensorServiceClient) GetPower(ctx context.Context, in *GetPowerRequest, opts ...grpc.CallOption) (*GetPowerResponse, error) {
	...
	err := c.cc.Invoke(ctx, PowerSensorService_GetPower_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *powerSensorServiceClient) GetReadings(ctx context.Context, in *v1.GetReadingsRequest, opts ...grpc.CallOption) (*v1.GetReadingsResponse, error) {
	...
	err := c.cc.Invoke(ctx, PowerSensorService_GetReadings_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *powerSensorServiceClient) DoCommand(ctx context.Context, in *v1.DoCommandRequest, opts ...grpc.CallOption) (*v1.DoCommandResponse, error) {
	...
	err := c.cc.Invoke(ctx, PowerSensorService_DoCommand_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedPowerSensorServiceServer must be embedded to have
...
func (UnimplementedPowerSensorServiceServer) testEmbeddedByValue()                            {}
...
func RegisterPowerSensorServiceServer(s grpc.ServiceRegistrar, srv PowerSensorServiceServer) {
	// If the following call pancis, it indicates UnimplementedPowerSensorServiceServer was
...
func _PowerSensorService_GetVoltage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PowerSensorService_GetVoltage_FullMethodName,
	}
...
func _PowerSensorService_GetCurrent_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PowerSensorService_GetCurrent_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PowerSensorService_GetPower_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PowerSensorService_GetPower_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PowerSensorService_GetReadings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PowerSensorService_GetReadings_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _PowerSensorService_DoCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PowerSensorService_DoCommand_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
