...
goog.exportSymbol('proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest', null, global);
goog.exportSymbol('proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse', null, global);
 ...
 * @constructor
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.displayName = 'proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse.displayName = 'proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    filter: (f = msg.getFilter()) && proto.viam.app.data.v1.Filter.toObject(includeInstance, f),
    datasetId: jspb.Message.getFieldWithDefault(msg, 2, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest}
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest;
  return proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest}
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getFilter();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.viam.app.data.v1.Filter}
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.prototype.getFilter = function() {
  return /** @type{?proto.viam.app.data.v1.Filter} */ (
    jspb.Message.getWrapperField(this, proto.viam.app.data.v1.Filter, 1));
};
...
/**
 * @param {?proto.viam.app.data.v1.Filter|undefined} value
 * @return {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest} returns this
*/
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.prototype.setFilter = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest} returns this
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.prototype.clearFilter = function() {
  return this.setFilter(undefined);
};
 ...
 * @return {boolean}
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.prototype.hasFilter = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @return {string}
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.prototype.getDatasetId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest} returns this
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterRequest.prototype.setDatasetId = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {!Object}
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse}
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse;
  return proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse}
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.AddBinaryDataToDatasetByFilterResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
};
