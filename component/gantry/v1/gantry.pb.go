...
var file_component_gantry_v1_gantry_proto_rawDesc = []byte{
	...
	0x32, 0xf2, 0x0a, 0x0a, 0x0d, 0x47, 0x61, 0x6e, 0x74, 0x72, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x95, 0x01, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x4b, 0x69, 0x6e,
	...
	0x65, 0x7d, 0x2f, 0x6b, 0x69, 0x6e, 0x65, 0x6d, 0x61, 0x74, 0x69, 0x63, 0x73, 0x12, 0x95, 0x01,
	...
	0x76, 0x31, 0x2f, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x2f, 0x67, 0x61, 0x6e,
	0x74, 0x72, 0x79, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x2f, 0x67, 0x65, 0x6f, 0x6d, 0x65,
...
var file_component_gantry_v1_gantry_proto_goTypes = []any{
	...
	(*v1.GetKinematicsRequest)(nil),  // 15: viam.common.v1.GetKinematicsRequest
...
var file_component_gantry_v1_gantry_proto_depIdxs = []int32{
	...
	15, // 12: viam.component.gantry.v1.GantryService.GetKinematics:input_type -> viam.common.v1.GetKinematicsRequest
	16, // 13: viam.component.gantry.v1.GantryService.GetGeometries:input_type -> viam.common.v1.GetGeometriesRequest
	1,  // 14: viam.component.gantry.v1.GantryService.GetPosition:output_type -> viam.component.gantry.v1.GetPositionResponse
	3,  // 15: viam.component.gantry.v1.GantryService.MoveToPosition:output_type -> viam.component.gantry.v1.MoveToPositionResponse
	5,  // 16: viam.component.gantry.v1.GantryService.Home:output_type -> viam.component.gantry.v1.HomeResponse
	7,  // 17: viam.component.gantry.v1.GantryService.GetLengths:output_type -> viam.component.gantry.v1.GetLengthsResponse
	9,  // 18: viam.component.gantry.v1.GantryService.Stop:output_type -> viam.component.gantry.v1.StopResponse
	12, // 19: viam.component.gantry.v1.GantryService.IsMoving:output_type -> viam.component.gantry.v1.IsMovingResponse
	17, // 20: viam.component.gantry.v1.GantryService.DoCommand:output_type -> viam.common.v1.DoCommandResponse
	18, // 21: viam.component.gantry.v1.GantryService.GetKinematics:output_type -> viam.common.v1.GetKinematicsResponse
	19, // 22: viam.component.gantry.v1.GantryService.GetGeometries:output_type -> viam.common.v1.GetGeometriesResponse
