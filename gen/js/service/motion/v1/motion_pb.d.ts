...
export class ExportPointCloudRequest extends jspb.Message {
  hasWorldState(): boolean;
  clearWorldState(): void;
  getWorldState(): common_v1_common_pb.WorldState | undefined;
  setWorldState(value?: common_v1_common_pb.WorldState): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ExportPointCloudRequest.AsObject;
  static toObject(includeInstance: boolean, msg: ExportPointCloudRequest): ExportPointCloudRequest.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ExportPointCloudRequest, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ExportPointCloudRequest;
  static deserializeBinaryFromReader(message: ExportPointCloudRequest, reader: jspb.BinaryReader): ExportPointCloudRequest;
}

export namespace ExportPointCloudRequest {
  export type AsObject = {
    worldState?: common_v1_common_pb.WorldState.AsObject,
    extra?: google_protobuf_struct_pb.Struct.AsObject,
  }
...
export class ExportPointCloudResponse extends jspb.Message {
  getWorldStatePcd(): Uint8Array | string;
  getWorldStatePcd_asU8(): Uint8Array;
  getWorldStatePcd_asB64(): string;
  setWorldStatePcd(value: Uint8Array | string): void;

  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ExportPointCloudResponse.AsObject;
  static toObject(includeInstance: boolean, msg: ExportPointCloudResponse): ExportPointCloudResponse.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ExportPointCloudResponse, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ExportPointCloudResponse;
  static deserializeBinaryFromReader(message: ExportPointCloudResponse, reader: jspb.BinaryReader): ExportPointCloudResponse;
}

export namespace ExportPointCloudResponse {
  export type AsObject = {
    worldStatePcd: Uint8Array | string,
  }
}
