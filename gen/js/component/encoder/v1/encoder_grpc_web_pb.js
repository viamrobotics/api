 ...
 */
const methodDescriptor_EncoderService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.component.encoder.v1.EncoderServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.component.encoder.v1.EncoderService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_EncoderService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.component.encoder.v1.EncoderServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.component.encoder.v1.EncoderService/GetStatus',
      request,
