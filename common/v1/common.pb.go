...
type Transform struct {
	...
	Geometry            *Geometry    `protobuf:"bytes,3,opt,name=geometry,proto3,oneof" json:"geometry,omitempty"`
}
...
func (x *Transform) GetGeometry() *Geometry {
	if x != nil {
		return x.Geometry
	}
	return nil
...
var file_common_v1_common_proto_rawDesc = []byte{
	...
	0x64, 0x69, 0x6d, 0x73, 0x4d, 0x6d, 0x22, 0xc7, 0x01, 0x0a, 0x08, 0x47, 0x65, 0x6f, 0x6d, 0x65,
	...
	0x73, 0x6d, 0x48, 0x00, 0x52, 0x03, 0x62, 0x6f, 0x78, 0x12, 0x14, 0x0a, 0x05, 0x6c, 0x61, 0x62,
	...
	0x67, 0x69, 0x74, 0x75, 0x64, 0x65, 0x22, 0xce, 0x01, 0x0a, 0x09, 0x54, 0x72, 0x61, 0x6e, 0x73,
	...
	0x39, 0x0a, 0x08, 0x67, 0x65, 0x6f, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x18, 0x2e, 0x76, 0x69, 0x61, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e,
	0x76, 0x31, 0x2e, 0x47, 0x65, 0x6f, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x48, 0x00, 0x52, 0x08, 0x67,
	0x65, 0x6f, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x88, 0x01, 0x01, 0x42, 0x0b, 0x0a, 0x09, 0x5f, 0x67,
	0x65, 0x6f, 0x6d, 0x65, 0x74, 0x72, 0x79, 0x22, 0xda, 0x01, 0x0a, 0x0a, 0x57, 0x6f, 0x72, 0x6c,
	0x64, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x3f, 0x0a, 0x09, 0x6f, 0x62, 0x73, 0x74, 0x61, 0x63,
	0x6c, 0x65, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x76, 0x69, 0x61, 0x6d,
	...
	0x73, 0x74, 0x61, 0x63, 0x6c, 0x65, 0x73, 0x12, 0x50, 0x0a, 0x12, 0x69, 0x6e, 0x74, 0x65, 0x72,
	...
	0x6e, 0x46, 0x72, 0x61, 0x6d, 0x65, 0x52, 0x11, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x61, 0x63, 0x74,
	0x69, 0x6f, 0x6e, 0x53, 0x70, 0x61, 0x63, 0x65, 0x73, 0x12, 0x39, 0x0a, 0x0a, 0x74, 0x72, 0x61,
	...
	0x6f, 0x72, 0x6d, 0x73, 0x22, 0x2d, 0x0a, 0x0e, 0x41, 0x63, 0x74, 0x75, 0x61, 0x74, 0x6f, 0x72,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x1b, 0x0a, 0x09, 0x69, 0x73, 0x5f, 0x6d, 0x6f, 0x76,
	0x69, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x73, 0x4d, 0x6f, 0x76,
	0x69, 0x6e, 0x67, 0x3a, 0x61, 0x0a, 0x1a, 0x73, 0x61, 0x66, 0x65, 0x74, 0x79, 0x5f, 0x68, 0x65,
...
var file_common_v1_common_proto_goTypes = []interface{}{
	...
	nil,                                // 17: viam.common.v1.BoardStatus.AnalogsEntry
	nil,                                // 18: viam.common.v1.BoardStatus.DigitalInterruptsEntry
	(*descriptorpb.MethodOptions)(nil), // 19: google.protobuf.MethodOptions
}
var file_common_v1_common_proto_depIdxs = []int32{
	17, // 0: viam.common.v1.BoardStatus.analogs:type_name -> viam.common.v1.BoardStatus.AnalogsEntry
	18, // 1: viam.common.v1.BoardStatus.digital_interrupts:type_name -> viam.common.v1.BoardStatus.DigitalInterruptsEntry
	...
	9,  // 6: viam.common.v1.Geometry.box:type_name -> viam.common.v1.RectangularPrism
	...
	6,  // 9: viam.common.v1.Transform.pose_in_observer_frame:type_name -> viam.common.v1.PoseInFrame
	10, // 10: viam.common.v1.Transform.geometry:type_name -> viam.common.v1.Geometry
	11, // 11: viam.common.v1.WorldState.obstacles:type_name -> viam.common.v1.GeometriesInFrame
	11, // 12: viam.common.v1.WorldState.interaction_spaces:type_name -> viam.common.v1.GeometriesInFrame
	14, // 13: viam.common.v1.WorldState.transforms:type_name -> viam.common.v1.Transform
	2,  // 14: viam.common.v1.BoardStatus.AnalogsEntry.value:type_name -> viam.common.v1.AnalogStatus
	3,  // 15: viam.common.v1.BoardStatus.DigitalInterruptsEntry.value:type_name -> viam.common.v1.DigitalInterruptStatus
	19, // 16: viam.common.v1.safety_heartbeat_monitored:extendee -> google.protobuf.MethodOptions
...
func file_common_v1_common_proto_init() {
	...
	file_common_v1_common_proto_msgTypes[14].OneofWrappers = []interface{}{}
	type x struct{}
