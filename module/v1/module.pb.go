...
var file_module_v1_module_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x6c, 0x65, 0x72, 0x6d, 0x61, 0x70, 0x32, 0xfe, 0x02, 0x0a, 0x0d, 0x4d, 0x6f, 0x64,
	...
	0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x1b, 0x5a, 0x19, 0x67, 0x6f, 0x2e,
...
var file_module_v1_module_proto_goTypes = []interface{}{
	...
	(*v11.ResourceRPCSubtype)(nil),      // 11: viam.robot.v1.ResourceRPCSubtype
}
var file_module_v1_module_proto_depIdxs = []int32{
	10, // 0: viam.module.v1.AddResourceRequest.config:type_name -> viam.app.v1.ComponentConfig
	10, // 1: viam.module.v1.ReconfigureResourceRequest.config:type_name -> viam.app.v1.ComponentConfig
	11, // 2: viam.module.v1.HandlerDefinition.subtype:type_name -> viam.robot.v1.ResourceRPCSubtype
	...
	0,  // 5: viam.module.v1.ModuleService.AddResource:input_type -> viam.module.v1.AddResourceRequest
	2,  // 6: viam.module.v1.ModuleService.ReconfigureResource:input_type -> viam.module.v1.ReconfigureResourceRequest
	4,  // 7: viam.module.v1.ModuleService.RemoveResource:input_type -> viam.module.v1.RemoveResourceRequest
	8,  // 8: viam.module.v1.ModuleService.Ready:input_type -> viam.module.v1.ReadyRequest
	1,  // 9: viam.module.v1.ModuleService.AddResource:output_type -> viam.module.v1.AddResourceResponse
	3,  // 10: viam.module.v1.ModuleService.ReconfigureResource:output_type -> viam.module.v1.ReconfigureResourceResponse
	5,  // 11: viam.module.v1.ModuleService.RemoveResource:output_type -> viam.module.v1.RemoveResourceResponse
	9,  // 12: viam.module.v1.ModuleService.Ready:output_type -> viam.module.v1.ReadyResponse
