 ...
 * @constructor
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.repeatedFields_, null);
};
goog.inherits(proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.displayName = 'proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.repeatedFields_, null);
};
goog.inherits(proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.displayName = 'proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse';
}
 ...
 * @const
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    binaryMetadataList: jspb.Message.toObjectList(msg.getBinaryMetadataList(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest;
  return proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getBinaryMetadataList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
...
/**
 * repeated BinaryMetadata binary_metadata = 1;
 * @return {!Array<!proto.viam.app.data.v1.BinaryMetadata>}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.prototype.getBinaryMetadataList = function() {
  return /** @type{!Array<!proto.viam.app.data.v1.BinaryMetadata>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.viam.app.data.v1.BinaryMetadata, 1));
};


/**
 * @param {!Array<!proto.viam.app.data.v1.BinaryMetadata>} value
 * @return {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest} returns this
*/
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.prototype.setBinaryMetadataList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.viam.app.data.v1.BinaryMetadata}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.prototype.addBinaryMetadata = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.viam.app.data.v1.BinaryMetadata, opt_index);
};
 ...
 * @return {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest} returns this
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.prototype.clearBinaryMetadataList = function() {
  return this.setBinaryMetadataList([]);
};
 ...
 * @return {string}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.prototype.getPath = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};
 ...
 * @return {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest} returns this
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesRequest.prototype.setPath = function(value) {
  return jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @const
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    jsonLinesList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse;
  return proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getJsonLinesList();
  if (f.length > 0) {
    writer.writeRepeatedString(
      1,
      f
...
/**
 * repeated string json_lines = 1;
 * @return {!Array<string>}
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.prototype.getJsonLinesList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<string>} value
 * @return {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse} returns this
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.prototype.setJsonLinesList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse} returns this
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.prototype.addJsonLines = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse} returns this
 */
proto.viam.app.data.v1.BinaryMetadataToJSONLinesResponse.prototype.clearJsonLinesList = function() {
  return this.setJsonLinesList([]);
};
