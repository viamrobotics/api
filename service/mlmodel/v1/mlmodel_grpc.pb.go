...
const (
	MLModelService_Infer_FullMethodName    = "/viam.service.mlmodel.v1.MLModelService/Infer"
	MLModelService_Metadata_FullMethodName = "/viam.service.mlmodel.v1.MLModelService/Metadata"
)
...
func (c *mLModelServiceClient) Infer(ctx context.Context, in *InferRequest, opts ...grpc.CallOption) (*InferResponse, error) {
	...
	err := c.cc.Invoke(ctx, MLModelService_Infer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *mLModelServiceClient) Metadata(ctx context.Context, in *MetadataRequest, opts ...grpc.CallOption) (*MetadataResponse, error) {
	...
	err := c.cc.Invoke(ctx, MLModelService_Metadata_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMLModelServiceServer must be embedded to have
...
func _MLModelService_Infer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MLModelService_Infer_FullMethodName,
	}
...
func _MLModelService_Metadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MLModelService_Metadata_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
