...
goog.exportSymbol('proto.viam.app.v1.AuthHandlerWebOauthConfig', null, global);
 ...
 * @constructor
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.viam.app.v1.AuthHandlerWebOauthConfig.repeatedFields_, null);
};
goog.inherits(proto.viam.app.v1.AuthHandlerWebOauthConfig, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viam.app.v1.AuthHandlerWebOauthConfig.displayName = 'proto.viam.app.v1.AuthHandlerWebOauthConfig';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.viam.app.v1.RobotConfig.repeatedFields_ = [2,3,4,5,9];
 ...
 * @const
 */
proto.viam.app.v1.ModuleConfig.repeatedFields_ = [3];
...
proto.viam.app.v1.ModuleConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    modelsList: (f = jspb.Message.getRepeatedField(msg, 3)) == null ? undefined : f
  };
 ...
 * @const
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.app.v1.AuthHandlerWebOauthConfig.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.app.v1.AuthHandlerWebOauthConfig} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    allowedAudiencesList: (f = jspb.Message.getRepeatedField(msg, 1)) == null ? undefined : f,
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.viam.app.v1.AuthHandlerWebOauthConfig}
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.app.v1.AuthHandlerWebOauthConfig;
  return proto.viam.app.v1.AuthHandlerWebOauthConfig.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.app.v1.AuthHandlerWebOauthConfig} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.app.v1.AuthHandlerWebOauthConfig}
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.app.v1.AuthHandlerWebOauthConfig.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.app.v1.AuthHandlerWebOauthConfig} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array<string>}
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.prototype.getAllowedAudiencesList = function() {
...
/**
 * @param {!Array<string>} value
 * @return {!proto.viam.app.v1.AuthHandlerWebOauthConfig} returns this
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.prototype.setAllowedAudiencesList = function(value) {
 ...
 * @return {!proto.viam.app.v1.AuthHandlerWebOauthConfig} returns this
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.prototype.addAllowedAudiences = function(value, opt_index) {
 ...
 * @return {!proto.viam.app.v1.AuthHandlerWebOauthConfig} returns this
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.prototype.clearAllowedAudiencesList = function() {
  return this.setAllowedAudiencesList([]);
};


/**
 * optional JWKSFile jwks = 2;
 * @return {?proto.viam.app.v1.JWKSFile}
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.prototype.getJwks = function() {
  return /** @type{?proto.viam.app.v1.JWKSFile} */ (
    jspb.Message.getWrapperField(this, proto.viam.app.v1.JWKSFile, 2));
};
 ...
 * @return {!proto.viam.app.v1.AuthHandlerWebOauthConfig} returns this
*/
proto.viam.app.v1.AuthHandlerWebOauthConfig.prototype.setJwks = function(value) {
  return jspb.Message.setWrapperField(this, 2, value);
};
 ...
 * @return {!proto.viam.app.v1.AuthHandlerWebOauthConfig} returns this
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.prototype.clearJwks = function() {
 ...
 * @return {boolean}
 */
proto.viam.app.v1.AuthHandlerWebOauthConfig.prototype.hasJwks = function() {
  return jspb.Message.getField(this, 2) != null;
};
...
proto.viam.app.v1.AuthHandlerConfig.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    webOauthConfig: (f = msg.getWebOauthConfig()) && proto.viam.app.v1.AuthHandlerWebOauthConfig.toObject(includeInstance, f)
  };
...
proto.viam.app.v1.AuthHandlerConfig.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = new proto.viam.app.v1.AuthHandlerWebOauthConfig;
      reader.readMessage(value,proto.viam.app.v1.AuthHandlerWebOauthConfig.deserializeBinaryFromReader);
      msg.setWebOauthConfig(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.viam.app.v1.AuthHandlerConfig.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getWebOauthConfig();
  if (f != null) {
    writer.writeMessage(
      6,
      f,
      proto.viam.app.v1.AuthHandlerWebOauthConfig.serializeBinaryToWriter
    );
  }
};
...
/**
 * optional AuthHandlerWebOauthConfig web_oauth_config = 6;
 * @return {?proto.viam.app.v1.AuthHandlerWebOauthConfig}
 */
proto.viam.app.v1.AuthHandlerConfig.prototype.getWebOauthConfig = function() {
  return /** @type{?proto.viam.app.v1.AuthHandlerWebOauthConfig} */ (
    jspb.Message.getWrapperField(this, proto.viam.app.v1.AuthHandlerWebOauthConfig, 6));
};


/**
 * @param {?proto.viam.app.v1.AuthHandlerWebOauthConfig|undefined} value
 * @return {!proto.viam.app.v1.AuthHandlerConfig} returns this
*/
proto.viam.app.v1.AuthHandlerConfig.prototype.setWebOauthConfig = function(value) {
  return jspb.Message.setWrapperField(this, 6, value);
};
 ...
 * @return {!proto.viam.app.v1.AuthHandlerConfig} returns this
 */
proto.viam.app.v1.AuthHandlerConfig.prototype.clearWebOauthConfig = function() {
  return this.setWebOauthConfig(undefined);
};
 ...
 * @return {boolean}
 */
proto.viam.app.v1.AuthHandlerConfig.prototype.hasWebOauthConfig = function() {
  return jspb.Message.getField(this, 6) != null;
};
