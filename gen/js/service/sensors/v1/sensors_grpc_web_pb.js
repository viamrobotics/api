 ...
 */
const methodDescriptor_SensorsService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.service.sensors.v1.SensorsServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.service.sensors.v1.SensorsService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_SensorsService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.service.sensors.v1.SensorsServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.service.sensors.v1.SensorsService/GetStatus',
      request,
