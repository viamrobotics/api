...
var file_app_v1_app_proto_rawDesc = []byte{
	...
	0x5f, 0x50, 0x55, 0x42, 0x4c, 0x49, 0x43, 0x10, 0x02, 0x32, 0xe9, 0x38, 0x0a, 0x0a, 0x41, 0x70,
	...
	0x73, 0x74, 0x6f, 0x72, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x44, 0x0a,
...
var file_app_v1_app_proto_depIdxs = []int32{
	...
	26,  // 136: viam.app.v1.AppService.ListMachineSummaries:input_type -> viam.app.v1.ListMachineSummariesRequest
	29,  // 137: viam.app.v1.AppService.CreateOrganizationInvite:input_type -> viam.app.v1.CreateOrganizationInviteRequest
	31,  // 138: viam.app.v1.AppService.UpdateOrganizationInviteAuthorizations:input_type -> viam.app.v1.UpdateOrganizationInviteAuthorizationsRequest
	37,  // 139: viam.app.v1.AppService.DeleteOrganizationMember:input_type -> viam.app.v1.DeleteOrganizationMemberRequest
	33,  // 140: viam.app.v1.AppService.DeleteOrganizationInvite:input_type -> viam.app.v1.DeleteOrganizationInviteRequest
	35,  // 141: viam.app.v1.AppService.ResendOrganizationInvite:input_type -> viam.app.v1.ResendOrganizationInviteRequest
	45,  // 142: viam.app.v1.AppService.CreateLocation:input_type -> viam.app.v1.CreateLocationRequest
	47,  // 143: viam.app.v1.AppService.GetLocation:input_type -> viam.app.v1.GetLocationRequest
	49,  // 144: viam.app.v1.AppService.UpdateLocation:input_type -> viam.app.v1.UpdateLocationRequest
	51,  // 145: viam.app.v1.AppService.DeleteLocation:input_type -> viam.app.v1.DeleteLocationRequest
	55,  // 146: viam.app.v1.AppService.ListLocations:input_type -> viam.app.v1.ListLocationsRequest
	56,  // 147: viam.app.v1.AppService.ShareLocation:input_type -> viam.app.v1.ShareLocationRequest
	58,  // 148: viam.app.v1.AppService.UnshareLocation:input_type -> viam.app.v1.UnshareLocationRequest
	65,  // 149: viam.app.v1.AppService.LocationAuth:input_type -> viam.app.v1.LocationAuthRequest
	61,  // 150: viam.app.v1.AppService.CreateLocationSecret:input_type -> viam.app.v1.CreateLocationSecretRequest
	63,  // 151: viam.app.v1.AppService.DeleteLocationSecret:input_type -> viam.app.v1.DeleteLocationSecretRequest
	67,  // 152: viam.app.v1.AppService.GetRobot:input_type -> viam.app.v1.GetRobotRequest
	68,  // 153: viam.app.v1.AppService.GetRoverRentalRobots:input_type -> viam.app.v1.GetRoverRentalRobotsRequest
	72,  // 154: viam.app.v1.AppService.GetRobotParts:input_type -> viam.app.v1.GetRobotPartsRequest
	74,  // 155: viam.app.v1.AppService.GetRobotPart:input_type -> viam.app.v1.GetRobotPartRequest
	76,  // 156: viam.app.v1.AppService.GetRobotPartLogs:input_type -> viam.app.v1.GetRobotPartLogsRequest
	78,  // 157: viam.app.v1.AppService.TailRobotPartLogs:input_type -> viam.app.v1.TailRobotPartLogsRequest
	80,  // 158: viam.app.v1.AppService.GetRobotPartHistory:input_type -> viam.app.v1.GetRobotPartHistoryRequest
	82,  // 159: viam.app.v1.AppService.UpdateRobotPart:input_type -> viam.app.v1.UpdateRobotPartRequest
	84,  // 160: viam.app.v1.AppService.NewRobotPart:input_type -> viam.app.v1.NewRobotPartRequest
	86,  // 161: viam.app.v1.AppService.DeleteRobotPart:input_type -> viam.app.v1.DeleteRobotPartRequest
	87,  // 162: viam.app.v1.AppService.GetRobotAPIKeys:input_type -> viam.app.v1.GetRobotAPIKeysRequest
	115, // 163: viam.app.v1.AppService.MarkPartAsMain:input_type -> viam.app.v1.MarkPartAsMainRequest
	117, // 164: viam.app.v1.AppService.MarkPartForRestart:input_type -> viam.app.v1.MarkPartForRestartRequest
	119, // 165: viam.app.v1.AppService.CreateRobotPartSecret:input_type -> viam.app.v1.CreateRobotPartSecretRequest
	121, // 166: viam.app.v1.AppService.DeleteRobotPartSecret:input_type -> viam.app.v1.DeleteRobotPartSecretRequest
	105, // 167: viam.app.v1.AppService.ListRobots:input_type -> viam.app.v1.ListRobotsRequest
	109, // 168: viam.app.v1.AppService.NewRobot:input_type -> viam.app.v1.NewRobotRequest
	111, // 169: viam.app.v1.AppService.UpdateRobot:input_type -> viam.app.v1.UpdateRobotRequest
	113, // 170: viam.app.v1.AppService.DeleteRobot:input_type -> viam.app.v1.DeleteRobotRequest
	93,  // 171: viam.app.v1.AppService.ListFragments:input_type -> viam.app.v1.ListFragmentsRequest
	95,  // 172: viam.app.v1.AppService.GetFragment:input_type -> viam.app.v1.GetFragmentRequest
	97,  // 173: viam.app.v1.AppService.CreateFragment:input_type -> viam.app.v1.CreateFragmentRequest
	99,  // 174: viam.app.v1.AppService.UpdateFragment:input_type -> viam.app.v1.UpdateFragmentRequest
	101, // 175: viam.app.v1.AppService.DeleteFragment:input_type -> viam.app.v1.DeleteFragmentRequest
	106, // 176: viam.app.v1.AppService.ListMachineFragments:input_type -> viam.app.v1.ListMachineFragmentsRequest
	103, // 177: viam.app.v1.AppService.GetFragmentHistory:input_type -> viam.app.v1.GetFragmentHistoryRequest
	124, // 178: viam.app.v1.AppService.AddRole:input_type -> viam.app.v1.AddRoleRequest
	126, // 179: viam.app.v1.AppService.RemoveRole:input_type -> viam.app.v1.RemoveRoleRequest
	128, // 180: viam.app.v1.AppService.ChangeRole:input_type -> viam.app.v1.ChangeRoleRequest
	130, // 181: viam.app.v1.AppService.ListAuthorizations:input_type -> viam.app.v1.ListAuthorizationsRequest
	132, // 182: viam.app.v1.AppService.CheckPermissions:input_type -> viam.app.v1.CheckPermissionsRequest
	141, // 183: viam.app.v1.AppService.GetRegistryItem:input_type -> viam.app.v1.GetRegistryItemRequest
	143, // 184: viam.app.v1.AppService.CreateRegistryItem:input_type -> viam.app.v1.CreateRegistryItemRequest
	145, // 185: viam.app.v1.AppService.UpdateRegistryItem:input_type -> viam.app.v1.UpdateRegistryItemRequest
	147, // 186: viam.app.v1.AppService.ListRegistryItems:input_type -> viam.app.v1.ListRegistryItemsRequest
	149, // 187: viam.app.v1.AppService.DeleteRegistryItem:input_type -> viam.app.v1.DeleteRegistryItemRequest
	151, // 188: viam.app.v1.AppService.TransferRegistryItem:input_type -> viam.app.v1.TransferRegistryItemRequest
	153, // 189: viam.app.v1.AppService.CreateModule:input_type -> viam.app.v1.CreateModuleRequest
	155, // 190: viam.app.v1.AppService.UpdateModule:input_type -> viam.app.v1.UpdateModuleRequest
	159, // 191: viam.app.v1.AppService.UploadModuleFile:input_type -> viam.app.v1.UploadModuleFileRequest
	161, // 192: viam.app.v1.AppService.GetModule:input_type -> viam.app.v1.GetModuleRequest
	166, // 193: viam.app.v1.AppService.ListModules:input_type -> viam.app.v1.ListModulesRequest
	173, // 194: viam.app.v1.AppService.CreateKey:input_type -> viam.app.v1.CreateKeyRequest
	175, // 195: viam.app.v1.AppService.DeleteKey:input_type -> viam.app.v1.DeleteKeyRequest
	181, // 196: viam.app.v1.AppService.ListKeys:input_type -> viam.app.v1.ListKeysRequest
	177, // 197: viam.app.v1.AppService.RenameKey:input_type -> viam.app.v1.RenameKeyRequest
	183, // 198: viam.app.v1.AppService.RotateKey:input_type -> viam.app.v1.RotateKeyRequest
	185, // 199: viam.app.v1.AppService.CreateKeyFromExistingKeyAuthorizations:input_type -> viam.app.v1.CreateKeyFromExistingKeyAuthorizationsRequest
	169, // 200: viam.app.v1.AppService.GetUserIDByEmail:output_type -> viam.app.v1.GetUserIDByEmailResponse
	15,  // 201: viam.app.v1.AppService.CreateOrganization:output_type -> viam.app.v1.CreateOrganizationResponse
	12,  // 202: viam.app.v1.AppService.ListOrganizations:output_type -> viam.app.v1.ListOrganizationsResponse
	54,  // 203: viam.app.v1.AppService.GetOrganizationsWithAccessToLocation:output_type -> viam.app.v1.GetOrganizationsWithAccessToLocationResponse
	172, // 204: viam.app.v1.AppService.ListOrganizationsByUser:output_type -> viam.app.v1.ListOrganizationsByUserResponse
	17,  // 205: viam.app.v1.AppService.GetOrganization:output_type -> viam.app.v1.GetOrganizationResponse
	19,  // 206: viam.app.v1.AppService.GetOrganizationNamespaceAvailability:output_type -> viam.app.v1.GetOrganizationNamespaceAvailabilityResponse
	21,  // 207: viam.app.v1.AppService.UpdateOrganization:output_type -> viam.app.v1.UpdateOrganizationResponse
	23,  // 208: viam.app.v1.AppService.DeleteOrganization:output_type -> viam.app.v1.DeleteOrganizationResponse
	25,  // 209: viam.app.v1.AppService.ListOrganizationMembers:output_type -> viam.app.v1.ListOrganizationMembersResponse
	27,  // 210: viam.app.v1.AppService.ListMachineSummaries:output_type -> viam.app.v1.ListMachineSummariesResponse
	30,  // 211: viam.app.v1.AppService.CreateOrganizationInvite:output_type -> viam.app.v1.CreateOrganizationInviteResponse
	32,  // 212: viam.app.v1.AppService.UpdateOrganizationInviteAuthorizations:output_type -> viam.app.v1.UpdateOrganizationInviteAuthorizationsResponse
	38,  // 213: viam.app.v1.AppService.DeleteOrganizationMember:output_type -> viam.app.v1.DeleteOrganizationMemberResponse
	34,  // 214: viam.app.v1.AppService.DeleteOrganizationInvite:output_type -> viam.app.v1.DeleteOrganizationInviteResponse
	36,  // 215: viam.app.v1.AppService.ResendOrganizationInvite:output_type -> viam.app.v1.ResendOrganizationInviteResponse
	46,  // 216: viam.app.v1.AppService.CreateLocation:output_type -> viam.app.v1.CreateLocationResponse
	48,  // 217: viam.app.v1.AppService.GetLocation:output_type -> viam.app.v1.GetLocationResponse
	50,  // 218: viam.app.v1.AppService.UpdateLocation:output_type -> viam.app.v1.UpdateLocationResponse
	52,  // 219: viam.app.v1.AppService.DeleteLocation:output_type -> viam.app.v1.DeleteLocationResponse
	60,  // 220: viam.app.v1.AppService.ListLocations:output_type -> viam.app.v1.ListLocationsResponse
	57,  // 221: viam.app.v1.AppService.ShareLocation:output_type -> viam.app.v1.ShareLocationResponse
	59,  // 222: viam.app.v1.AppService.UnshareLocation:output_type -> viam.app.v1.UnshareLocationResponse
	66,  // 223: viam.app.v1.AppService.LocationAuth:output_type -> viam.app.v1.LocationAuthResponse
	62,  // 224: viam.app.v1.AppService.CreateLocationSecret:output_type -> viam.app.v1.CreateLocationSecretResponse
	64,  // 225: viam.app.v1.AppService.DeleteLocationSecret:output_type -> viam.app.v1.DeleteLocationSecretResponse
	71,  // 226: viam.app.v1.AppService.GetRobot:output_type -> viam.app.v1.GetRobotResponse
	70,  // 227: viam.app.v1.AppService.GetRoverRentalRobots:output_type -> viam.app.v1.GetRoverRentalRobotsResponse
	73,  // 228: viam.app.v1.AppService.GetRobotParts:output_type -> viam.app.v1.GetRobotPartsResponse
	75,  // 229: viam.app.v1.AppService.GetRobotPart:output_type -> viam.app.v1.GetRobotPartResponse
	77,  // 230: viam.app.v1.AppService.GetRobotPartLogs:output_type -> viam.app.v1.GetRobotPartLogsResponse
	79,  // 231: viam.app.v1.AppService.TailRobotPartLogs:output_type -> viam.app.v1.TailRobotPartLogsResponse
	81,  // 232: viam.app.v1.AppService.GetRobotPartHistory:output_type -> viam.app.v1.GetRobotPartHistoryResponse
	83,  // 233: viam.app.v1.AppService.UpdateRobotPart:output_type -> viam.app.v1.UpdateRobotPartResponse
	85,  // 234: viam.app.v1.AppService.NewRobotPart:output_type -> viam.app.v1.NewRobotPartResponse
	90,  // 235: viam.app.v1.AppService.DeleteRobotPart:output_type -> viam.app.v1.DeleteRobotPartResponse
	89,  // 236: viam.app.v1.AppService.GetRobotAPIKeys:output_type -> viam.app.v1.GetRobotAPIKeysResponse
	116, // 237: viam.app.v1.AppService.MarkPartAsMain:output_type -> viam.app.v1.MarkPartAsMainResponse
	118, // 238: viam.app.v1.AppService.MarkPartForRestart:output_type -> viam.app.v1.MarkPartForRestartResponse
	120, // 239: viam.app.v1.AppService.CreateRobotPartSecret:output_type -> viam.app.v1.CreateRobotPartSecretResponse
	122, // 240: viam.app.v1.AppService.DeleteRobotPartSecret:output_type -> viam.app.v1.DeleteRobotPartSecretResponse
	108, // 241: viam.app.v1.AppService.ListRobots:output_type -> viam.app.v1.ListRobotsResponse
	110, // 242: viam.app.v1.AppService.NewRobot:output_type -> viam.app.v1.NewRobotResponse
	112, // 243: viam.app.v1.AppService.UpdateRobot:output_type -> viam.app.v1.UpdateRobotResponse
	114, // 244: viam.app.v1.AppService.DeleteRobot:output_type -> viam.app.v1.DeleteRobotResponse
	94,  // 245: viam.app.v1.AppService.ListFragments:output_type -> viam.app.v1.ListFragmentsResponse
	96,  // 246: viam.app.v1.AppService.GetFragment:output_type -> viam.app.v1.GetFragmentResponse
	98,  // 247: viam.app.v1.AppService.CreateFragment:output_type -> viam.app.v1.CreateFragmentResponse
	100, // 248: viam.app.v1.AppService.UpdateFragment:output_type -> viam.app.v1.UpdateFragmentResponse
	102, // 249: viam.app.v1.AppService.DeleteFragment:output_type -> viam.app.v1.DeleteFragmentResponse
	107, // 250: viam.app.v1.AppService.ListMachineFragments:output_type -> viam.app.v1.ListMachineFragmentsResponse
	104, // 251: viam.app.v1.AppService.GetFragmentHistory:output_type -> viam.app.v1.GetFragmentHistoryResponse
	125, // 252: viam.app.v1.AppService.AddRole:output_type -> viam.app.v1.AddRoleResponse
	127, // 253: viam.app.v1.AppService.RemoveRole:output_type -> viam.app.v1.RemoveRoleResponse
	129, // 254: viam.app.v1.AppService.ChangeRole:output_type -> viam.app.v1.ChangeRoleResponse
	131, // 255: viam.app.v1.AppService.ListAuthorizations:output_type -> viam.app.v1.ListAuthorizationsResponse
	134, // 256: viam.app.v1.AppService.CheckPermissions:output_type -> viam.app.v1.CheckPermissionsResponse
	142, // 257: viam.app.v1.AppService.GetRegistryItem:output_type -> viam.app.v1.GetRegistryItemResponse
	144, // 258: viam.app.v1.AppService.CreateRegistryItem:output_type -> viam.app.v1.CreateRegistryItemResponse
	146, // 259: viam.app.v1.AppService.UpdateRegistryItem:output_type -> viam.app.v1.UpdateRegistryItemResponse
	148, // 260: viam.app.v1.AppService.ListRegistryItems:output_type -> viam.app.v1.ListRegistryItemsResponse
	150, // 261: viam.app.v1.AppService.DeleteRegistryItem:output_type -> viam.app.v1.DeleteRegistryItemResponse
	152, // 262: viam.app.v1.AppService.TransferRegistryItem:output_type -> viam.app.v1.TransferRegistryItemResponse
	154, // 263: viam.app.v1.AppService.CreateModule:output_type -> viam.app.v1.CreateModuleResponse
	156, // 264: viam.app.v1.AppService.UpdateModule:output_type -> viam.app.v1.UpdateModuleResponse
	160, // 265: viam.app.v1.AppService.UploadModuleFile:output_type -> viam.app.v1.UploadModuleFileResponse
	162, // 266: viam.app.v1.AppService.GetModule:output_type -> viam.app.v1.GetModuleResponse
	167, // 267: viam.app.v1.AppService.ListModules:output_type -> viam.app.v1.ListModulesResponse
	174, // 268: viam.app.v1.AppService.CreateKey:output_type -> viam.app.v1.CreateKeyResponse
	176, // 269: viam.app.v1.AppService.DeleteKey:output_type -> viam.app.v1.DeleteKeyResponse
	182, // 270: viam.app.v1.AppService.ListKeys:output_type -> viam.app.v1.ListKeysResponse
	178, // 271: viam.app.v1.AppService.RenameKey:output_type -> viam.app.v1.RenameKeyResponse
	184, // 272: viam.app.v1.AppService.RotateKey:output_type -> viam.app.v1.RotateKeyResponse
	186, // 273: viam.app.v1.AppService.CreateKeyFromExistingKeyAuthorizations:output_type -> viam.app.v1.CreateKeyFromExistingKeyAuthorizationsResponse
	200, // [200:274] is the sub-list for method output_type
	126, // [126:200] is the sub-list for method input_type
