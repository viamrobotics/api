 ...
 */
const methodDescriptor_ShellService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.service.shell.v1.ShellServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.service.shell.v1.ShellService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_ShellService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.service.shell.v1.ShellServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.service.shell.v1.ShellService/GetStatus',
      request,
