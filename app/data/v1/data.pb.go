...
// GetTagsByFilterRequest requests the tags that exist for the given filter
...
func (x *GetTagsByFilterRequest) GetFilter() *Filter {
	if x != nil {
		return x.Filter
	}
	return nil
...
// GetTagsByFilterResponse returns the tags that exist for the given filter
...
func (x *GetTagsByFilterResponse) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
var file_app_data_v1_data_proto_rawDesc = []byte{
	...
	0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x4a, 0x0a, 0x16, 0x47, 0x65, 0x74, 0x54, 0x61, 0x67,
	...
	0x65, 0x72, 0x22, 0x2d, 0x0a, 0x17, 0x47, 0x65, 0x74, 0x54, 0x61, 0x67, 0x73, 0x42, 0x79, 0x46,
	...
	0x03, 0x32, 0x9f, 0x0b, 0x0a, 0x0b, 0x44, 0x61, 0x74, 0x61, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x74, 0x65, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x66, 0x0a, 0x0f, 0x47,
	0x65, 0x74, 0x54, 0x61, 0x67, 0x73, 0x42, 0x79, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x12, 0x28,
	0x2e, 0x76, 0x69, 0x61, 0x6d, 0x2e, 0x61, 0x70, 0x70, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x76,
	0x31, 0x2e, 0x47, 0x65, 0x74, 0x54, 0x61, 0x67, 0x73, 0x42, 0x79, 0x46, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e, 0x76, 0x69, 0x61, 0x6d, 0x2e,
...
var file_app_data_v1_data_proto_goTypes = []interface{}{
	...
	(*GetTagsByFilterRequest)(nil),                    // 32: viam.app.data.v1.GetTagsByFilterRequest
	(*GetTagsByFilterResponse)(nil),                   // 33: viam.app.data.v1.GetTagsByFilterResponse
...
var file_app_data_v1_data_proto_depIdxs = []int32{
	...
	5,  // 29: viam.app.data.v1.GetTagsByFilterRequest.filter:type_name -> viam.app.data.v1.Filter
	...
	32, // 41: viam.app.data.v1.DataService.GetTagsByFilter:input_type -> viam.app.data.v1.GetTagsByFilterRequest
	...
	33, // 52: viam.app.data.v1.DataService.GetTagsByFilter:output_type -> viam.app.data.v1.GetTagsByFilterResponse
