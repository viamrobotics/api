...
goog.exportSymbol('proto.viam.app.data.v1.GetTagsByFilterRequest', null, global);
goog.exportSymbol('proto.viam.app.data.v1.GetTagsByFilterResponse', null, global);
 ...
 * @constructor
 */
proto.viam.app.data.v1.GetTagsByFilterRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.viam.app.data.v1.GetTagsByFilterRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viam.app.data.v1.GetTagsByFilterRequest.displayName = 'proto.viam.app.data.v1.GetTagsByFilterRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.viam.app.data.v1.GetTagsByFilterResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.viam.app.data.v1.GetTagsByFilterResponse.repeatedFields_, null);
};
goog.inherits(proto.viam.app.data.v1.GetTagsByFilterResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viam.app.data.v1.GetTagsByFilterResponse.displayName = 'proto.viam.app.data.v1.GetTagsByFilterResponse';
}
 ...
 * @return {!Object}
 */
proto.viam.app.data.v1.GetTagsByFilterRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.app.data.v1.GetTagsByFilterRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.app.data.v1.GetTagsByFilterRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.GetTagsByFilterRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    filter: (f = msg.getFilter()) && proto.viam.app.data.v1.Filter.toObject(includeInstance, f)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.viam.app.data.v1.GetTagsByFilterRequest}
 */
proto.viam.app.data.v1.GetTagsByFilterRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.app.data.v1.GetTagsByFilterRequest;
  return proto.viam.app.data.v1.GetTagsByFilterRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.app.data.v1.GetTagsByFilterRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.app.data.v1.GetTagsByFilterRequest}
 */
proto.viam.app.data.v1.GetTagsByFilterRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.app.data.v1.GetTagsByFilterRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.app.data.v1.GetTagsByFilterRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.app.data.v1.GetTagsByFilterRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.GetTagsByFilterRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getFilter();
  if (f != null) {
    writer.writeMessage(
 ...
 * @return {?proto.viam.app.data.v1.Filter}
 */
proto.viam.app.data.v1.GetTagsByFilterRequest.prototype.getFilter = function() {
  return /** @type{?proto.viam.app.data.v1.Filter} */ (
    jspb.Message.getWrapperField(this, proto.viam.app.data.v1.Filter, 1));
};
...
/**
 * @param {?proto.viam.app.data.v1.Filter|undefined} value
 * @return {!proto.viam.app.data.v1.GetTagsByFilterRequest} returns this
*/
proto.viam.app.data.v1.GetTagsByFilterRequest.prototype.setFilter = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.viam.app.data.v1.GetTagsByFilterRequest} returns this
 */
proto.viam.app.data.v1.GetTagsByFilterRequest.prototype.clearFilter = function() {
  return this.setFilter(undefined);
};
 ...
 * @return {boolean}
 */
proto.viam.app.data.v1.GetTagsByFilterRequest.prototype.hasFilter = function() {
  return jspb.Message.getField(this, 1) != null;
};
 ...
 * @const
 */
proto.viam.app.data.v1.GetTagsByFilterResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.viam.app.data.v1.GetTagsByFilterResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.app.data.v1.GetTagsByFilterResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.app.data.v1.GetTagsByFilterResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.GetTagsByFilterResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.viam.app.data.v1.GetTagsByFilterResponse}
 */
proto.viam.app.data.v1.GetTagsByFilterResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.app.data.v1.GetTagsByFilterResponse;
  return proto.viam.app.data.v1.GetTagsByFilterResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.app.data.v1.GetTagsByFilterResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.app.data.v1.GetTagsByFilterResponse}
 */
proto.viam.app.data.v1.GetTagsByFilterResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.app.data.v1.GetTagsByFilterResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.app.data.v1.GetTagsByFilterResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.app.data.v1.GetTagsByFilterResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.data.v1.GetTagsByFilterResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTagsList();
  if (f.length > 0) {
    writer.writeRepeatedString(
 ...
 * @return {!Array<string>}
 */
proto.viam.app.data.v1.GetTagsByFilterResponse.prototype.getTagsList = function() {
  return /** @type {!Array<string>} */ (jspb.Message.getRepeatedField(this, 1));
};
...
/**
 * @param {!Array<string>} value
 * @return {!proto.viam.app.data.v1.GetTagsByFilterResponse} returns this
 */
proto.viam.app.data.v1.GetTagsByFilterResponse.prototype.setTagsList = function(value) {
  return jspb.Message.setField(this, 1, value || []);
};
 ...
 * @return {!proto.viam.app.data.v1.GetTagsByFilterResponse} returns this
 */
proto.viam.app.data.v1.GetTagsByFilterResponse.prototype.addTags = function(value, opt_index) {
  return jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};
 ...
 * @return {!proto.viam.app.data.v1.GetTagsByFilterResponse} returns this
 */
proto.viam.app.data.v1.GetTagsByFilterResponse.prototype.clearTagsList = function() {
  return this.setTagsList([]);
};
