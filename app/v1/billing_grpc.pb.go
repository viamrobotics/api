...
type BillingServiceClient interface {
	...
	// Create a new billing tier
	CreateBillingTier(ctx context.Context, in *CreateBillingTierRequest, opts ...grpc.CallOption) (*CreateBillingTierResponse, error)
}
...
func (c *billingServiceClient) CreateBillingTier(ctx context.Context, in *CreateBillingTierRequest, opts ...grpc.CallOption) (*CreateBillingTierResponse, error) {
	out := new(CreateBillingTierResponse)
	err := c.cc.Invoke(ctx, "/viam.app.v1.BillingService/CreateBillingTier", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BillingServiceServer interface {
	...
	// Create a new billing tier
	CreateBillingTier(context.Context, *CreateBillingTierRequest) (*CreateBillingTierResponse, error)
...
func (UnimplementedBillingServiceServer) CreateBillingTier(context.Context, *CreateBillingTierRequest) (*CreateBillingTierResponse, error) {
...
func _BillingService_CreateBillingTier_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/viam.app.v1.BillingService/CreateBillingTier",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
