...
DataManagerService.UploadBinaryDataToDataset = {
  methodName: "UploadBinaryDataToDataset",
  service: DataManagerService,
  requestStream: false,
  responseStream: false,
  requestType: service_datamanager_v1_data_manager_pb.UploadBinaryDataToDatasetRequest,
  responseType: service_datamanager_v1_data_manager_pb.UploadBinaryDataToDatasetResponse
};
...
DataManagerServiceClient.prototype.uploadBinaryDataToDataset = function uploadBinaryDataToDataset(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(DataManagerService.UploadBinaryDataToDataset, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
