...
var file_app_v1_app_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xad, 0x01, 0x0a, 0x0a, 0x4f, 0x72, 0x67, 0x44, 0x65, 0x74,
	...
	0x65, 0x88, 0x01, 0x01, 0x42, 0x0a, 0x0a, 0x08, 0x5f, 0x6f, 0x72, 0x67, 0x5f, 0x63, 0x69, 0x64,
	0x42, 0x13, 0x0a, 0x11, 0x5f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x6e, 0x61, 0x6d, 0x65,
	0x73, 0x70, 0x61, 0x63, 0x65, 0x22, 0x4e, 0x0a, 0x1f, 0x4c, 0x69, 0x73, 0x74, 0x4f, 0x72, 0x67,
	...
	0x32, 0x89, 0x45, 0x0a, 0x0a, 0x41, 0x70, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
...
var file_app_v1_app_proto_msgTypes = make([]protoimpl.MessageInfo, 216)
var file_app_v1_app_proto_goTypes = []any{
	...
	(*SearchOrganizationsRequest)(nil),                     // 191: viam.app.v1.SearchOrganizationsRequest
	(*SearchOrganizationsResponse)(nil),                    // 192: viam.app.v1.SearchOrganizationsResponse
	(*CreateKeyRequest)(nil),                               // 193: viam.app.v1.CreateKeyRequest
	(*CreateKeyResponse)(nil),                              // 194: viam.app.v1.CreateKeyResponse
	(*DeleteKeyRequest)(nil),                               // 195: viam.app.v1.DeleteKeyRequest
	(*DeleteKeyResponse)(nil),                              // 196: viam.app.v1.DeleteKeyResponse
	(*RenameKeyRequest)(nil),                               // 197: viam.app.v1.RenameKeyRequest
	(*RenameKeyResponse)(nil),                              // 198: viam.app.v1.RenameKeyResponse
	(*AuthorizationDetails)(nil),                           // 199: viam.app.v1.AuthorizationDetails
	(*APIKeyWithAuthorizations)(nil),                       // 200: viam.app.v1.APIKeyWithAuthorizations
	(*ListKeysRequest)(nil),                                // 201: viam.app.v1.ListKeysRequest
	(*ListKeysResponse)(nil),                               // 202: viam.app.v1.ListKeysResponse
	(*RotateKeyRequest)(nil),                               // 203: viam.app.v1.RotateKeyRequest
	(*RotateKeyResponse)(nil),                              // 204: viam.app.v1.RotateKeyResponse
	(*CreateKeyFromExistingKeyAuthorizationsRequest)(nil),  // 205: viam.app.v1.CreateKeyFromExistingKeyAuthorizationsRequest
	(*CreateKeyFromExistingKeyAuthorizationsResponse)(nil), // 206: viam.app.v1.CreateKeyFromExistingKeyAuthorizationsResponse
	(*OrganizationSetLogoRequest)(nil),                     // 207: viam.app.v1.OrganizationSetLogoRequest
	(*OrganizationSetLogoResponse)(nil),                    // 208: viam.app.v1.OrganizationSetLogoResponse
	(*OrganizationGetLogoRequest)(nil),                     // 209: viam.app.v1.OrganizationGetLogoRequest
	(*OrganizationGetLogoResponse)(nil),                    // 210: viam.app.v1.OrganizationGetLogoResponse
	(*EnableAuthServiceRequest)(nil),                       // 211: viam.app.v1.EnableAuthServiceRequest
	(*EnableAuthServiceResponse)(nil),                      // 212: viam.app.v1.EnableAuthServiceResponse
	(*DisableAuthServiceRequest)(nil),                      // 213: viam.app.v1.DisableAuthServiceRequest
	(*DisableAuthServiceResponse)(nil),                     // 214: viam.app.v1.DisableAuthServiceResponse
	(*CreateOAuthAppRequest)(nil),                          // 215: viam.app.v1.CreateOAuthAppRequest
	(*CreateOAuthAppResponse)(nil),                         // 216: viam.app.v1.CreateOAuthAppResponse
	(*ReadOAuthAppRequest)(nil),                            // 217: viam.app.v1.ReadOAuthAppRequest
	(*ReadOAuthAppResponse)(nil),                           // 218: viam.app.v1.ReadOAuthAppResponse
	(*UpdateOAuthAppRequest)(nil),                          // 219: viam.app.v1.UpdateOAuthAppRequest
	(*UpdateOAuthAppResponse)(nil),                         // 220: viam.app.v1.UpdateOAuthAppResponse
	(*DeleteOAuthAppRequest)(nil),                          // 221: viam.app.v1.DeleteOAuthAppRequest
	(*DeleteOAuthAppResponse)(nil),                         // 222: viam.app.v1.DeleteOAuthAppResponse
	(*ListOAuthAppsRequest)(nil),                           // 223: viam.app.v1.ListOAuthAppsRequest
	(*ListOAuthAppsResponse)(nil),                          // 224: viam.app.v1.ListOAuthAppsResponse
	(*OAuthConfig)(nil),                                    // 225: viam.app.v1.OAuthConfig
	(*timestamppb.Timestamp)(nil),                          // 226: google.protobuf.Timestamp
	(*structpb.Struct)(nil),                                // 227: google.protobuf.Struct
	(*v1.LogEntry)(nil),                                    // 228: viam.common.v1.LogEntry
	(v11.ModelType)(0),                                     // 229: viam.app.mltraining.v1.ModelType
	(v11.ModelFramework)(0),                                // 230: viam.app.mltraining.v1.ModelFramework
	(v12.PackageType)(0),                                   // 231: viam.app.packages.v1.PackageType
}
var file_app_v1_app_proto_depIdxs = []int32{
	226, // 0: viam.app.v1.Robot.last_access:type_name -> google.protobuf.Timestamp
	226, // 1: viam.app.v1.Robot.created_on:type_name -> google.protobuf.Timestamp
	227, // 2: viam.app.v1.RobotPart.robot_config:type_name -> google.protobuf.Struct
	226, // 3: viam.app.v1.RobotPart.last_access:type_name -> google.protobuf.Timestamp
	227, // 4: viam.app.v1.RobotPart.user_supplied_info:type_name -> google.protobuf.Struct
	226, // 5: viam.app.v1.RobotPart.created_on:type_name -> google.protobuf.Timestamp
	59,  // 6: viam.app.v1.RobotPart.secrets:type_name -> viam.app.v1.SharedSecret
	226, // 7: viam.app.v1.RobotPart.last_updated:type_name -> google.protobuf.Timestamp
	226, // 8: viam.app.v1.RobotPartHistoryEntry.when:type_name -> google.protobuf.Timestamp
	...
	226, // 12: viam.app.v1.Organization.created_on:type_name -> google.protobuf.Timestamp
	226, // 13: viam.app.v1.OrganizationMember.date_added:type_name -> google.protobuf.Timestamp
	226, // 14: viam.app.v1.OrganizationMember.last_login:type_name -> google.protobuf.Timestamp
	15,  // 15: viam.app.v1.ListOrganizationsResponse.organizations:type_name -> viam.app.v1.Organization
	226, // 16: viam.app.v1.OrganizationInvite.created_on:type_name -> google.protobuf.Timestamp
	...
	226, // 35: viam.app.v1.Location.created_on:type_name -> google.protobuf.Timestamp
	57,  // 36: viam.app.v1.Location.config:type_name -> viam.app.v1.StorageConfig
	226, // 37: viam.app.v1.SharedSecret.created_on:type_name -> google.protobuf.Timestamp
	...
	226, // 50: viam.app.v1.GetRobotPartLogsRequest.start:type_name -> google.protobuf.Timestamp
	226, // 51: viam.app.v1.GetRobotPartLogsRequest.end:type_name -> google.protobuf.Timestamp
	228, // 52: viam.app.v1.GetRobotPartLogsResponse.logs:type_name -> viam.common.v1.LogEntry
	228, // 53: viam.app.v1.TailRobotPartLogsResponse.logs:type_name -> viam.common.v1.LogEntry
	12,  // 54: viam.app.v1.GetRobotPartHistoryResponse.history:type_name -> viam.app.v1.RobotPartHistoryEntry
	227, // 55: viam.app.v1.UpdateRobotPartRequest.robot_config:type_name -> google.protobuf.Struct
	11,  // 56: viam.app.v1.UpdateRobotPartResponse.part:type_name -> viam.app.v1.RobotPart
	226, // 57: viam.app.v1.APIKey.created_on:type_name -> google.protobuf.Timestamp
	200, // 58: viam.app.v1.GetRobotAPIKeysResponse.api_keys:type_name -> viam.app.v1.APIKeyWithAuthorizations
	227, // 59: viam.app.v1.Fragment.fragment:type_name -> google.protobuf.Struct
	226, // 60: viam.app.v1.Fragment.created_on:type_name -> google.protobuf.Timestamp
	1,   // 61: viam.app.v1.Fragment.visibility:type_name -> viam.app.v1.FragmentVisibility
	226, // 62: viam.app.v1.Fragment.last_updated:type_name -> google.protobuf.Timestamp
	226, // 63: viam.app.v1.FragmentHistoryEntry.edited_on:type_name -> google.protobuf.Timestamp
	...
	227, // 67: viam.app.v1.ResolvedFragment.resolved_config:type_name -> google.protobuf.Struct
	...
	227, // 74: viam.app.v1.CreateFragmentRequest.config:type_name -> google.protobuf.Struct
	...
	227, // 77: viam.app.v1.UpdateFragmentRequest.config:type_name -> google.protobuf.Struct
	...
	229, // 97: viam.app.v1.MLModelMetadata.model_type:type_name -> viam.app.mltraining.v1.ModelType
	230, // 98: viam.app.v1.MLModelMetadata.model_framework:type_name -> viam.app.mltraining.v1.ModelFramework
	226, // 99: viam.app.v1.MLTrainingVersion.created_on:type_name -> google.protobuf.Timestamp
	156, // 100: viam.app.v1.MLTrainingMetadata.versions:type_name -> viam.app.v1.MLTrainingVersion
	229, // 101: viam.app.v1.MLTrainingMetadata.model_type:type_name -> viam.app.mltraining.v1.ModelType
	230, // 102: viam.app.v1.MLTrainingMetadata.model_framework:type_name -> viam.app.mltraining.v1.ModelFramework
	231, // 103: viam.app.v1.RegistryItem.type:type_name -> viam.app.packages.v1.PackageType
	...
	226, // 108: viam.app.v1.RegistryItem.created_at:type_name -> google.protobuf.Timestamp
	226, // 109: viam.app.v1.RegistryItem.updated_at:type_name -> google.protobuf.Timestamp
	158, // 110: viam.app.v1.GetRegistryItemResponse.item:type_name -> viam.app.v1.RegistryItem
	231, // 111: viam.app.v1.CreateRegistryItemRequest.type:type_name -> viam.app.packages.v1.PackageType
	231, // 112: viam.app.v1.UpdateRegistryItemRequest.type:type_name -> viam.app.packages.v1.PackageType
	4,   // 113: viam.app.v1.UpdateRegistryItemRequest.visibility:type_name -> viam.app.v1.Visibility
	231, // 114: viam.app.v1.ListRegistryItemsRequest.types:type_name -> viam.app.packages.v1.PackageType
	...
	226, // 127: viam.app.v1.Uploads.uploaded_at:type_name -> google.protobuf.Timestamp
	...
	189, // 130: viam.app.v1.SearchOrganizationsResponse.organizations:type_name -> viam.app.v1.OrgDetails
	141, // 131: viam.app.v1.CreateKeyRequest.authorizations:type_name -> viam.app.v1.Authorization
	103, // 132: viam.app.v1.APIKeyWithAuthorizations.api_key:type_name -> viam.app.v1.APIKey
	199, // 133: viam.app.v1.APIKeyWithAuthorizations.authorizations:type_name -> viam.app.v1.AuthorizationDetails
	200, // 134: viam.app.v1.ListKeysResponse.api_keys:type_name -> viam.app.v1.APIKeyWithAuthorizations
	225, // 135: viam.app.v1.CreateOAuthAppRequest.oauth_config:type_name -> viam.app.v1.OAuthConfig
	225, // 136: viam.app.v1.ReadOAuthAppResponse.oauth_config:type_name -> viam.app.v1.OAuthConfig
	225, // 137: viam.app.v1.UpdateOAuthAppRequest.oauth_config:type_name -> viam.app.v1.OAuthConfig
	5,   // 138: viam.app.v1.OAuthConfig.client_authentication:type_name -> viam.app.v1.ClientAuthentication
	6,   // 139: viam.app.v1.OAuthConfig.pkce:type_name -> viam.app.v1.PKCE
	7,   // 140: viam.app.v1.OAuthConfig.url_validation:type_name -> viam.app.v1.URLValidation
	8,   // 141: viam.app.v1.OAuthConfig.enabled_grants:type_name -> viam.app.v1.EnabledGrant
	186, // 142: viam.app.v1.AppService.GetUserIDByEmail:input_type -> viam.app.v1.GetUserIDByEmailRequest
	19,  // 143: viam.app.v1.AppService.CreateOrganization:input_type -> viam.app.v1.CreateOrganizationRequest
	14,  // 144: viam.app.v1.AppService.ListOrganizations:input_type -> viam.app.v1.ListOrganizationsRequest
	68,  // 145: viam.app.v1.AppService.GetOrganizationsWithAccessToLocation:input_type -> viam.app.v1.GetOrganizationsWithAccessToLocationRequest
	188, // 146: viam.app.v1.AppService.ListOrganizationsByUser:input_type -> viam.app.v1.ListOrganizationsByUserRequest
	191, // 147: viam.app.v1.AppService.SearchOrganizations:input_type -> viam.app.v1.SearchOrganizationsRequest
	21,  // 148: viam.app.v1.AppService.GetOrganization:input_type -> viam.app.v1.GetOrganizationRequest
	23,  // 149: viam.app.v1.AppService.GetOrganizationNamespaceAvailability:input_type -> viam.app.v1.GetOrganizationNamespaceAvailabilityRequest
	25,  // 150: viam.app.v1.AppService.UpdateOrganization:input_type -> viam.app.v1.UpdateOrganizationRequest
	27,  // 151: viam.app.v1.AppService.DeleteOrganization:input_type -> viam.app.v1.DeleteOrganizationRequest
	29,  // 152: viam.app.v1.AppService.ListOrganizationMembers:input_type -> viam.app.v1.ListOrganizationMembersRequest
	31,  // 153: viam.app.v1.AppService.CreateOrganizationInvite:input_type -> viam.app.v1.CreateOrganizationInviteRequest
	33,  // 154: viam.app.v1.AppService.UpdateOrganizationInviteAuthorizations:input_type -> viam.app.v1.UpdateOrganizationInviteAuthorizationsRequest
	39,  // 155: viam.app.v1.AppService.DeleteOrganizationMember:input_type -> viam.app.v1.DeleteOrganizationMemberRequest
	35,  // 156: viam.app.v1.AppService.DeleteOrganizationInvite:input_type -> viam.app.v1.DeleteOrganizationInviteRequest
	37,  // 157: viam.app.v1.AppService.ResendOrganizationInvite:input_type -> viam.app.v1.ResendOrganizationInviteRequest
	42,  // 158: viam.app.v1.AppService.EnableBillingService:input_type -> viam.app.v1.EnableBillingServiceRequest
	48,  // 159: viam.app.v1.AppService.DisableBillingService:input_type -> viam.app.v1.DisableBillingServiceRequest
	44,  // 160: viam.app.v1.AppService.UpdateBillingService:input_type -> viam.app.v1.UpdateBillingServiceRequest
	46,  // 161: viam.app.v1.AppService.GetBillingServiceConfig:input_type -> viam.app.v1.GetBillingServiceConfigRequest
	50,  // 162: viam.app.v1.AppService.OrganizationSetSupportEmail:input_type -> viam.app.v1.OrganizationSetSupportEmailRequest
	52,  // 163: viam.app.v1.AppService.OrganizationGetSupportEmail:input_type -> viam.app.v1.OrganizationGetSupportEmailRequest
	207, // 164: viam.app.v1.AppService.OrganizationSetLogo:input_type -> viam.app.v1.OrganizationSetLogoRequest
	209, // 165: viam.app.v1.AppService.OrganizationGetLogo:input_type -> viam.app.v1.OrganizationGetLogoRequest
	211, // 166: viam.app.v1.AppService.EnableAuthService:input_type -> viam.app.v1.EnableAuthServiceRequest
	213, // 167: viam.app.v1.AppService.DisableAuthService:input_type -> viam.app.v1.DisableAuthServiceRequest
	215, // 168: viam.app.v1.AppService.CreateOAuthApp:input_type -> viam.app.v1.CreateOAuthAppRequest
	217, // 169: viam.app.v1.AppService.ReadOAuthApp:input_type -> viam.app.v1.ReadOAuthAppRequest
	219, // 170: viam.app.v1.AppService.UpdateOAuthApp:input_type -> viam.app.v1.UpdateOAuthAppRequest
	221, // 171: viam.app.v1.AppService.DeleteOAuthApp:input_type -> viam.app.v1.DeleteOAuthAppRequest
	223, // 172: viam.app.v1.AppService.ListOAuthApps:input_type -> viam.app.v1.ListOAuthAppsRequest
	60,  // 173: viam.app.v1.AppService.CreateLocation:input_type -> viam.app.v1.CreateLocationRequest
	62,  // 174: viam.app.v1.AppService.GetLocation:input_type -> viam.app.v1.GetLocationRequest
	64,  // 175: viam.app.v1.AppService.UpdateLocation:input_type -> viam.app.v1.UpdateLocationRequest
	66,  // 176: viam.app.v1.AppService.DeleteLocation:input_type -> viam.app.v1.DeleteLocationRequest
	70,  // 177: viam.app.v1.AppService.ListLocations:input_type -> viam.app.v1.ListLocationsRequest
	71,  // 178: viam.app.v1.AppService.ShareLocation:input_type -> viam.app.v1.ShareLocationRequest
	73,  // 179: viam.app.v1.AppService.UnshareLocation:input_type -> viam.app.v1.UnshareLocationRequest
	80,  // 180: viam.app.v1.AppService.LocationAuth:input_type -> viam.app.v1.LocationAuthRequest
	76,  // 181: viam.app.v1.AppService.CreateLocationSecret:input_type -> viam.app.v1.CreateLocationSecretRequest
	78,  // 182: viam.app.v1.AppService.DeleteLocationSecret:input_type -> viam.app.v1.DeleteLocationSecretRequest
	82,  // 183: viam.app.v1.AppService.GetRobot:input_type -> viam.app.v1.GetRobotRequest
	83,  // 184: viam.app.v1.AppService.GetRoverRentalRobots:input_type -> viam.app.v1.GetRoverRentalRobotsRequest
	87,  // 185: viam.app.v1.AppService.GetRobotParts:input_type -> viam.app.v1.GetRobotPartsRequest
	89,  // 186: viam.app.v1.AppService.GetRobotPart:input_type -> viam.app.v1.GetRobotPartRequest
	91,  // 187: viam.app.v1.AppService.GetRobotPartLogs:input_type -> viam.app.v1.GetRobotPartLogsRequest
	93,  // 188: viam.app.v1.AppService.TailRobotPartLogs:input_type -> viam.app.v1.TailRobotPartLogsRequest
	95,  // 189: viam.app.v1.AppService.GetRobotPartHistory:input_type -> viam.app.v1.GetRobotPartHistoryRequest
	97,  // 190: viam.app.v1.AppService.UpdateRobotPart:input_type -> viam.app.v1.UpdateRobotPartRequest
	99,  // 191: viam.app.v1.AppService.NewRobotPart:input_type -> viam.app.v1.NewRobotPartRequest
	101, // 192: viam.app.v1.AppService.DeleteRobotPart:input_type -> viam.app.v1.DeleteRobotPartRequest
	102, // 193: viam.app.v1.AppService.GetRobotAPIKeys:input_type -> viam.app.v1.GetRobotAPIKeysRequest
	133, // 194: viam.app.v1.AppService.MarkPartAsMain:input_type -> viam.app.v1.MarkPartAsMainRequest
	135, // 195: viam.app.v1.AppService.MarkPartForRestart:input_type -> viam.app.v1.MarkPartForRestartRequest
	137, // 196: viam.app.v1.AppService.CreateRobotPartSecret:input_type -> viam.app.v1.CreateRobotPartSecretRequest
	139, // 197: viam.app.v1.AppService.DeleteRobotPartSecret:input_type -> viam.app.v1.DeleteRobotPartSecretRequest
	123, // 198: viam.app.v1.AppService.ListRobots:input_type -> viam.app.v1.ListRobotsRequest
	127, // 199: viam.app.v1.AppService.NewRobot:input_type -> viam.app.v1.NewRobotRequest
	129, // 200: viam.app.v1.AppService.UpdateRobot:input_type -> viam.app.v1.UpdateRobotRequest
	131, // 201: viam.app.v1.AppService.DeleteRobot:input_type -> viam.app.v1.DeleteRobotRequest
	111, // 202: viam.app.v1.AppService.ListFragments:input_type -> viam.app.v1.ListFragmentsRequest
	113, // 203: viam.app.v1.AppService.GetFragment:input_type -> viam.app.v1.GetFragmentRequest
	115, // 204: viam.app.v1.AppService.CreateFragment:input_type -> viam.app.v1.CreateFragmentRequest
	117, // 205: viam.app.v1.AppService.UpdateFragment:input_type -> viam.app.v1.UpdateFragmentRequest
	119, // 206: viam.app.v1.AppService.DeleteFragment:input_type -> viam.app.v1.DeleteFragmentRequest
	124, // 207: viam.app.v1.AppService.ListMachineFragments:input_type -> viam.app.v1.ListMachineFragmentsRequest
	121, // 208: viam.app.v1.AppService.GetFragmentHistory:input_type -> viam.app.v1.GetFragmentHistoryRequest
	142, // 209: viam.app.v1.AppService.AddRole:input_type -> viam.app.v1.AddRoleRequest
	144, // 210: viam.app.v1.AppService.RemoveRole:input_type -> viam.app.v1.RemoveRoleRequest
	146, // 211: viam.app.v1.AppService.ChangeRole:input_type -> viam.app.v1.ChangeRoleRequest
	148, // 212: viam.app.v1.AppService.ListAuthorizations:input_type -> viam.app.v1.ListAuthorizationsRequest
	150, // 213: viam.app.v1.AppService.CheckPermissions:input_type -> viam.app.v1.CheckPermissionsRequest
	159, // 214: viam.app.v1.AppService.GetRegistryItem:input_type -> viam.app.v1.GetRegistryItemRequest
	161, // 215: viam.app.v1.AppService.CreateRegistryItem:input_type -> viam.app.v1.CreateRegistryItemRequest
	163, // 216: viam.app.v1.AppService.UpdateRegistryItem:input_type -> viam.app.v1.UpdateRegistryItemRequest
	165, // 217: viam.app.v1.AppService.ListRegistryItems:input_type -> viam.app.v1.ListRegistryItemsRequest
	167, // 218: viam.app.v1.AppService.DeleteRegistryItem:input_type -> viam.app.v1.DeleteRegistryItemRequest
	169, // 219: viam.app.v1.AppService.TransferRegistryItem:input_type -> viam.app.v1.TransferRegistryItemRequest
	171, // 220: viam.app.v1.AppService.CreateModule:input_type -> viam.app.v1.CreateModuleRequest
	173, // 221: viam.app.v1.AppService.UpdateModule:input_type -> viam.app.v1.UpdateModuleRequest
	177, // 222: viam.app.v1.AppService.UploadModuleFile:input_type -> viam.app.v1.UploadModuleFileRequest
	179, // 223: viam.app.v1.AppService.GetModule:input_type -> viam.app.v1.GetModuleRequest
	184, // 224: viam.app.v1.AppService.ListModules:input_type -> viam.app.v1.ListModulesRequest
	193, // 225: viam.app.v1.AppService.CreateKey:input_type -> viam.app.v1.CreateKeyRequest
	195, // 226: viam.app.v1.AppService.DeleteKey:input_type -> viam.app.v1.DeleteKeyRequest
	201, // 227: viam.app.v1.AppService.ListKeys:input_type -> viam.app.v1.ListKeysRequest
	197, // 228: viam.app.v1.AppService.RenameKey:input_type -> viam.app.v1.RenameKeyRequest
	203, // 229: viam.app.v1.AppService.RotateKey:input_type -> viam.app.v1.RotateKeyRequest
	205, // 230: viam.app.v1.AppService.CreateKeyFromExistingKeyAuthorizations:input_type -> viam.app.v1.CreateKeyFromExistingKeyAuthorizationsRequest
	187, // 231: viam.app.v1.AppService.GetUserIDByEmail:output_type -> viam.app.v1.GetUserIDByEmailResponse
	20,  // 232: viam.app.v1.AppService.CreateOrganization:output_type -> viam.app.v1.CreateOrganizationResponse
	17,  // 233: viam.app.v1.AppService.ListOrganizations:output_type -> viam.app.v1.ListOrganizationsResponse
	69,  // 234: viam.app.v1.AppService.GetOrganizationsWithAccessToLocation:output_type -> viam.app.v1.GetOrganizationsWithAccessToLocationResponse
	190, // 235: viam.app.v1.AppService.ListOrganizationsByUser:output_type -> viam.app.v1.ListOrganizationsByUserResponse
	192, // 236: viam.app.v1.AppService.SearchOrganizations:output_type -> viam.app.v1.SearchOrganizationsResponse
	22,  // 237: viam.app.v1.AppService.GetOrganization:output_type -> viam.app.v1.GetOrganizationResponse
	24,  // 238: viam.app.v1.AppService.GetOrganizationNamespaceAvailability:output_type -> viam.app.v1.GetOrganizationNamespaceAvailabilityResponse
	26,  // 239: viam.app.v1.AppService.UpdateOrganization:output_type -> viam.app.v1.UpdateOrganizationResponse
	28,  // 240: viam.app.v1.AppService.DeleteOrganization:output_type -> viam.app.v1.DeleteOrganizationResponse
	30,  // 241: viam.app.v1.AppService.ListOrganizationMembers:output_type -> viam.app.v1.ListOrganizationMembersResponse
	32,  // 242: viam.app.v1.AppService.CreateOrganizationInvite:output_type -> viam.app.v1.CreateOrganizationInviteResponse
	34,  // 243: viam.app.v1.AppService.UpdateOrganizationInviteAuthorizations:output_type -> viam.app.v1.UpdateOrganizationInviteAuthorizationsResponse
	40,  // 244: viam.app.v1.AppService.DeleteOrganizationMember:output_type -> viam.app.v1.DeleteOrganizationMemberResponse
	36,  // 245: viam.app.v1.AppService.DeleteOrganizationInvite:output_type -> viam.app.v1.DeleteOrganizationInviteResponse
	38,  // 246: viam.app.v1.AppService.ResendOrganizationInvite:output_type -> viam.app.v1.ResendOrganizationInviteResponse
	43,  // 247: viam.app.v1.AppService.EnableBillingService:output_type -> viam.app.v1.EnableBillingServiceResponse
	49,  // 248: viam.app.v1.AppService.DisableBillingService:output_type -> viam.app.v1.DisableBillingServiceResponse
	45,  // 249: viam.app.v1.AppService.UpdateBillingService:output_type -> viam.app.v1.UpdateBillingServiceResponse
	47,  // 250: viam.app.v1.AppService.GetBillingServiceConfig:output_type -> viam.app.v1.GetBillingServiceConfigResponse
	51,  // 251: viam.app.v1.AppService.OrganizationSetSupportEmail:output_type -> viam.app.v1.OrganizationSetSupportEmailResponse
	53,  // 252: viam.app.v1.AppService.OrganizationGetSupportEmail:output_type -> viam.app.v1.OrganizationGetSupportEmailResponse
	208, // 253: viam.app.v1.AppService.OrganizationSetLogo:output_type -> viam.app.v1.OrganizationSetLogoResponse
	210, // 254: viam.app.v1.AppService.OrganizationGetLogo:output_type -> viam.app.v1.OrganizationGetLogoResponse
	212, // 255: viam.app.v1.AppService.EnableAuthService:output_type -> viam.app.v1.EnableAuthServiceResponse
	214, // 256: viam.app.v1.AppService.DisableAuthService:output_type -> viam.app.v1.DisableAuthServiceResponse
	216, // 257: viam.app.v1.AppService.CreateOAuthApp:output_type -> viam.app.v1.CreateOAuthAppResponse
	218, // 258: viam.app.v1.AppService.ReadOAuthApp:output_type -> viam.app.v1.ReadOAuthAppResponse
	220, // 259: viam.app.v1.AppService.UpdateOAuthApp:output_type -> viam.app.v1.UpdateOAuthAppResponse
	222, // 260: viam.app.v1.AppService.DeleteOAuthApp:output_type -> viam.app.v1.DeleteOAuthAppResponse
	224, // 261: viam.app.v1.AppService.ListOAuthApps:output_type -> viam.app.v1.ListOAuthAppsResponse
	61,  // 262: viam.app.v1.AppService.CreateLocation:output_type -> viam.app.v1.CreateLocationResponse
	63,  // 263: viam.app.v1.AppService.GetLocation:output_type -> viam.app.v1.GetLocationResponse
	65,  // 264: viam.app.v1.AppService.UpdateLocation:output_type -> viam.app.v1.UpdateLocationResponse
	67,  // 265: viam.app.v1.AppService.DeleteLocation:output_type -> viam.app.v1.DeleteLocationResponse
	75,  // 266: viam.app.v1.AppService.ListLocations:output_type -> viam.app.v1.ListLocationsResponse
	72,  // 267: viam.app.v1.AppService.ShareLocation:output_type -> viam.app.v1.ShareLocationResponse
	74,  // 268: viam.app.v1.AppService.UnshareLocation:output_type -> viam.app.v1.UnshareLocationResponse
	81,  // 269: viam.app.v1.AppService.LocationAuth:output_type -> viam.app.v1.LocationAuthResponse
	77,  // 270: viam.app.v1.AppService.CreateLocationSecret:output_type -> viam.app.v1.CreateLocationSecretResponse
	79,  // 271: viam.app.v1.AppService.DeleteLocationSecret:output_type -> viam.app.v1.DeleteLocationSecretResponse
	86,  // 272: viam.app.v1.AppService.GetRobot:output_type -> viam.app.v1.GetRobotResponse
	85,  // 273: viam.app.v1.AppService.GetRoverRentalRobots:output_type -> viam.app.v1.GetRoverRentalRobotsResponse
	88,  // 274: viam.app.v1.AppService.GetRobotParts:output_type -> viam.app.v1.GetRobotPartsResponse
	90,  // 275: viam.app.v1.AppService.GetRobotPart:output_type -> viam.app.v1.GetRobotPartResponse
	92,  // 276: viam.app.v1.AppService.GetRobotPartLogs:output_type -> viam.app.v1.GetRobotPartLogsResponse
	94,  // 277: viam.app.v1.AppService.TailRobotPartLogs:output_type -> viam.app.v1.TailRobotPartLogsResponse
	96,  // 278: viam.app.v1.AppService.GetRobotPartHistory:output_type -> viam.app.v1.GetRobotPartHistoryResponse
	98,  // 279: viam.app.v1.AppService.UpdateRobotPart:output_type -> viam.app.v1.UpdateRobotPartResponse
	100, // 280: viam.app.v1.AppService.NewRobotPart:output_type -> viam.app.v1.NewRobotPartResponse
	105, // 281: viam.app.v1.AppService.DeleteRobotPart:output_type -> viam.app.v1.DeleteRobotPartResponse
	104, // 282: viam.app.v1.AppService.GetRobotAPIKeys:output_type -> viam.app.v1.GetRobotAPIKeysResponse
	134, // 283: viam.app.v1.AppService.MarkPartAsMain:output_type -> viam.app.v1.MarkPartAsMainResponse
	136, // 284: viam.app.v1.AppService.MarkPartForRestart:output_type -> viam.app.v1.MarkPartForRestartResponse
	138, // 285: viam.app.v1.AppService.CreateRobotPartSecret:output_type -> viam.app.v1.CreateRobotPartSecretResponse
	140, // 286: viam.app.v1.AppService.DeleteRobotPartSecret:output_type -> viam.app.v1.DeleteRobotPartSecretResponse
	126, // 287: viam.app.v1.AppService.ListRobots:output_type -> viam.app.v1.ListRobotsResponse
	128, // 288: viam.app.v1.AppService.NewRobot:output_type -> viam.app.v1.NewRobotResponse
	130, // 289: viam.app.v1.AppService.UpdateRobot:output_type -> viam.app.v1.UpdateRobotResponse
	132, // 290: viam.app.v1.AppService.DeleteRobot:output_type -> viam.app.v1.DeleteRobotResponse
	112, // 291: viam.app.v1.AppService.ListFragments:output_type -> viam.app.v1.ListFragmentsResponse
	114, // 292: viam.app.v1.AppService.GetFragment:output_type -> viam.app.v1.GetFragmentResponse
	116, // 293: viam.app.v1.AppService.CreateFragment:output_type -> viam.app.v1.CreateFragmentResponse
	118, // 294: viam.app.v1.AppService.UpdateFragment:output_type -> viam.app.v1.UpdateFragmentResponse
	120, // 295: viam.app.v1.AppService.DeleteFragment:output_type -> viam.app.v1.DeleteFragmentResponse
	125, // 296: viam.app.v1.AppService.ListMachineFragments:output_type -> viam.app.v1.ListMachineFragmentsResponse
	122, // 297: viam.app.v1.AppService.GetFragmentHistory:output_type -> viam.app.v1.GetFragmentHistoryResponse
	143, // 298: viam.app.v1.AppService.AddRole:output_type -> viam.app.v1.AddRoleResponse
	145, // 299: viam.app.v1.AppService.RemoveRole:output_type -> viam.app.v1.RemoveRoleResponse
	147, // 300: viam.app.v1.AppService.ChangeRole:output_type -> viam.app.v1.ChangeRoleResponse
	149, // 301: viam.app.v1.AppService.ListAuthorizations:output_type -> viam.app.v1.ListAuthorizationsResponse
	152, // 302: viam.app.v1.AppService.CheckPermissions:output_type -> viam.app.v1.CheckPermissionsResponse
	160, // 303: viam.app.v1.AppService.GetRegistryItem:output_type -> viam.app.v1.GetRegistryItemResponse
	162, // 304: viam.app.v1.AppService.CreateRegistryItem:output_type -> viam.app.v1.CreateRegistryItemResponse
	164, // 305: viam.app.v1.AppService.UpdateRegistryItem:output_type -> viam.app.v1.UpdateRegistryItemResponse
	166, // 306: viam.app.v1.AppService.ListRegistryItems:output_type -> viam.app.v1.ListRegistryItemsResponse
	168, // 307: viam.app.v1.AppService.DeleteRegistryItem:output_type -> viam.app.v1.DeleteRegistryItemResponse
	170, // 308: viam.app.v1.AppService.TransferRegistryItem:output_type -> viam.app.v1.TransferRegistryItemResponse
	172, // 309: viam.app.v1.AppService.CreateModule:output_type -> viam.app.v1.CreateModuleResponse
	174, // 310: viam.app.v1.AppService.UpdateModule:output_type -> viam.app.v1.UpdateModuleResponse
	178, // 311: viam.app.v1.AppService.UploadModuleFile:output_type -> viam.app.v1.UploadModuleFileResponse
	180, // 312: viam.app.v1.AppService.GetModule:output_type -> viam.app.v1.GetModuleResponse
	185, // 313: viam.app.v1.AppService.ListModules:output_type -> viam.app.v1.ListModulesResponse
	194, // 314: viam.app.v1.AppService.CreateKey:output_type -> viam.app.v1.CreateKeyResponse
	196, // 315: viam.app.v1.AppService.DeleteKey:output_type -> viam.app.v1.DeleteKeyResponse
	202, // 316: viam.app.v1.AppService.ListKeys:output_type -> viam.app.v1.ListKeysResponse
	198, // 317: viam.app.v1.AppService.RenameKey:output_type -> viam.app.v1.RenameKeyResponse
	204, // 318: viam.app.v1.AppService.RotateKey:output_type -> viam.app.v1.RotateKeyResponse
	206, // 319: viam.app.v1.AppService.CreateKeyFromExistingKeyAuthorizations:output_type -> viam.app.v1.CreateKeyFromExistingKeyAuthorizationsResponse
