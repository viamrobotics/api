 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.viam.robot.v1.ModuleLogRequest,
 *   !proto.viam.robot.v1.ModuleLogResponse>}
 */
const methodDescriptor_RobotService_ModuleLog = new grpc.web.MethodDescriptor(
  '/viam.robot.v1.RobotService/ModuleLog',
  grpc.web.MethodType.UNARY,
  proto.viam.robot.v1.ModuleLogRequest,
  proto.viam.robot.v1.ModuleLogResponse,
  /**
   * @param {!proto.viam.robot.v1.ModuleLogRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.viam.robot.v1.ModuleLogResponse.deserializeBinary
);


/**
 * @param {!proto.viam.robot.v1.ModuleLogRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.viam.robot.v1.ModuleLogResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.viam.robot.v1.ModuleLogResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.viam.robot.v1.RobotServiceClient.prototype.moduleLog =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.robot.v1.RobotService/ModuleLog',
      request,
      metadata || {},
      methodDescriptor_RobotService_ModuleLog,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.viam.robot.v1.ModuleLogResponse>}
 *     Promise that resolves to the response
 */
proto.viam.robot.v1.RobotServicePromiseClient.prototype.moduleLog =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.robot.v1.RobotService/ModuleLog',
      request,
