...
AppService.ListFragmentNestedFragments = {
  methodName: "ListFragmentNestedFragments",
  service: AppService,
  requestStream: false,
  responseStream: false,
  requestType: app_v1_app_pb.ListFragmentNestedFragmentsRequest,
  responseType: app_v1_app_pb.ListFragmentNestedFragmentsResponse
};
...
AppServiceClient.prototype.listFragmentNestedFragments = function listFragmentNestedFragments(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(AppService.ListFragmentNestedFragments, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
