...
var file_app_v1_app_proto_rawDesc = []byte{
	...
	0x61, 0x69, 0x6c, 0x73, 0x52, 0x04, 0x6f, 0x72, 0x67, 0x73, 0x2a, 0x57, 0x0a, 0x0a, 0x56, 0x69,
	...
	0x43, 0x10, 0x02, 0x32, 0xdc, 0x2a, 0x0a, 0x0a, 0x41, 0x70, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69,
...
var file_app_v1_app_proto_depIdxs = []int32{
	...
	136, // 12: viam.app.v1.OrganizationInvite.created_on:type_name -> google.protobuf.Timestamp
	...
	106, // 18: viam.app.v1.CreateOrganizationInviteRequest.authorizations:type_name -> viam.app.v1.Authorization
	9,   // 19: viam.app.v1.CreateOrganizationInviteResponse.invite:type_name -> viam.app.v1.OrganizationInvite
	106, // 20: viam.app.v1.UpdateOrganizationInviteAuthorizationsRequest.add_authorizations:type_name -> viam.app.v1.Authorization
	106, // 21: viam.app.v1.UpdateOrganizationInviteAuthorizationsRequest.remove_authorizations:type_name -> viam.app.v1.Authorization
	9,   // 22: viam.app.v1.UpdateOrganizationInviteAuthorizationsResponse.invite:type_name -> viam.app.v1.OrganizationInvite
	9,   // 23: viam.app.v1.ResendOrganizationInviteResponse.invite:type_name -> viam.app.v1.OrganizationInvite
	36,  // 24: viam.app.v1.LocationAuth.secrets:type_name -> viam.app.v1.SharedSecret
	33,  // 25: viam.app.v1.Location.auth:type_name -> viam.app.v1.LocationAuth
	32,  // 26: viam.app.v1.Location.organizations:type_name -> viam.app.v1.LocationOrganization
	136, // 27: viam.app.v1.Location.created_on:type_name -> google.protobuf.Timestamp
	34,  // 28: viam.app.v1.Location.config:type_name -> viam.app.v1.StorageConfig
	136, // 29: viam.app.v1.SharedSecret.created_on:type_name -> google.protobuf.Timestamp
	1,   // 30: viam.app.v1.SharedSecret.state:type_name -> viam.app.v1.SharedSecret.State
	35,  // 31: viam.app.v1.CreateLocationResponse.location:type_name -> viam.app.v1.Location
	35,  // 32: viam.app.v1.GetLocationResponse.location:type_name -> viam.app.v1.Location
	35,  // 33: viam.app.v1.UpdateLocationResponse.location:type_name -> viam.app.v1.Location
	35,  // 34: viam.app.v1.ListLocationsResponse.locations:type_name -> viam.app.v1.Location
	33,  // 35: viam.app.v1.CreateLocationSecretResponse.auth:type_name -> viam.app.v1.LocationAuth
	33,  // 36: viam.app.v1.LocationAuthResponse.auth:type_name -> viam.app.v1.LocationAuth
	59,  // 37: viam.app.v1.GetRoverRentalRobotsResponse.robots:type_name -> viam.app.v1.RoverRentalRobot
	2,   // 38: viam.app.v1.GetRobotResponse.robot:type_name -> viam.app.v1.Robot
	3,   // 39: viam.app.v1.GetRobotPartsResponse.parts:type_name -> viam.app.v1.RobotPart
	3,   // 40: viam.app.v1.GetRobotPartResponse.part:type_name -> viam.app.v1.RobotPart
	136, // 41: viam.app.v1.LogEntry.time:type_name -> google.protobuf.Timestamp
	137, // 42: viam.app.v1.LogEntry.caller:type_name -> google.protobuf.Struct
	137, // 43: viam.app.v1.LogEntry.fields:type_name -> google.protobuf.Struct
	67,  // 44: viam.app.v1.GetRobotPartLogsResponse.logs:type_name -> viam.app.v1.LogEntry
	67,  // 45: viam.app.v1.TailRobotPartLogsResponse.logs:type_name -> viam.app.v1.LogEntry
	4,   // 46: viam.app.v1.GetRobotPartHistoryResponse.history:type_name -> viam.app.v1.RobotPartHistoryEntry
	137, // 47: viam.app.v1.UpdateRobotPartRequest.robot_config:type_name -> google.protobuf.Struct
	3,   // 48: viam.app.v1.UpdateRobotPartResponse.part:type_name -> viam.app.v1.RobotPart
	137, // 49: viam.app.v1.Fragment.fragment:type_name -> google.protobuf.Struct
	136, // 50: viam.app.v1.Fragment.created_on:type_name -> google.protobuf.Timestamp
	79,  // 51: viam.app.v1.ListFragmentsResponse.fragments:type_name -> viam.app.v1.Fragment
	79,  // 52: viam.app.v1.GetFragmentResponse.fragment:type_name -> viam.app.v1.Fragment
	137, // 53: viam.app.v1.CreateFragmentRequest.config:type_name -> google.protobuf.Struct
	79,  // 54: viam.app.v1.CreateFragmentResponse.fragment:type_name -> viam.app.v1.Fragment
	137, // 55: viam.app.v1.UpdateFragmentRequest.config:type_name -> google.protobuf.Struct
	79,  // 56: viam.app.v1.UpdateFragmentResponse.fragment:type_name -> viam.app.v1.Fragment
	2,   // 57: viam.app.v1.ListRobotsResponse.robots:type_name -> viam.app.v1.Robot
	2,   // 58: viam.app.v1.UpdateRobotResponse.robot:type_name -> viam.app.v1.Robot
	3,   // 59: viam.app.v1.CreateRobotPartSecretResponse.part:type_name -> viam.app.v1.RobotPart
	106, // 60: viam.app.v1.AddRoleRequest.authorization:type_name -> viam.app.v1.Authorization
	106, // 61: viam.app.v1.RemoveRoleRequest.authorization:type_name -> viam.app.v1.Authorization
	106, // 62: viam.app.v1.ListAuthorizationsResponse.authorizations:type_name -> viam.app.v1.Authorization
	114, // 63: viam.app.v1.CheckPermissionsRequest.permissions:type_name -> viam.app.v1.AuthorizedPermissions
	114, // 64: viam.app.v1.CheckPermissionsResponse.authorized_permissions:type_name -> viam.app.v1.AuthorizedPermissions
	0,   // 65: viam.app.v1.UpdateModuleRequest.visibility:type_name -> viam.app.v1.Visibility
	120, // 66: viam.app.v1.UpdateModuleRequest.models:type_name -> viam.app.v1.Model
	121, // 67: viam.app.v1.UploadModuleFileRequest.module_file_info:type_name -> viam.app.v1.ModuleFileInfo
	126, // 68: viam.app.v1.GetModuleResponse.module:type_name -> viam.app.v1.Module
	0,   // 69: viam.app.v1.Module.visibility:type_name -> viam.app.v1.Visibility
	127, // 70: viam.app.v1.Module.versions:type_name -> viam.app.v1.VersionHistory
	120, // 71: viam.app.v1.Module.models:type_name -> viam.app.v1.Model
	128, // 72: viam.app.v1.VersionHistory.files:type_name -> viam.app.v1.Uploads
	136, // 73: viam.app.v1.Uploads.uploaded_at:type_name -> google.protobuf.Timestamp
	126, // 74: viam.app.v1.ListModulesResponse.modules:type_name -> viam.app.v1.Module
	134, // 75: viam.app.v1.ListOrganizationsByUserResponse.orgs:type_name -> viam.app.v1.OrgDetails
	131, // 76: viam.app.v1.AppService.GetUserIDByEmail:input_type -> viam.app.v1.GetUserIDByEmailRequest
	10,  // 77: viam.app.v1.AppService.CreateOrganization:input_type -> viam.app.v1.CreateOrganizationRequest
	5,   // 78: viam.app.v1.AppService.ListOrganizations:input_type -> viam.app.v1.ListOrganizationsRequest
	133, // 79: viam.app.v1.AppService.ListOrganizationsByUser:input_type -> viam.app.v1.ListOrganizationsByUserRequest
	12,  // 80: viam.app.v1.AppService.GetOrganization:input_type -> viam.app.v1.GetOrganizationRequest
	14,  // 81: viam.app.v1.AppService.GetOrganizationNamespaceAvailability:input_type -> viam.app.v1.GetOrganizationNamespaceAvailabilityRequest
	16,  // 82: viam.app.v1.AppService.UpdateOrganization:input_type -> viam.app.v1.UpdateOrganizationRequest
	18,  // 83: viam.app.v1.AppService.DeleteOrganization:input_type -> viam.app.v1.DeleteOrganizationRequest
	20,  // 84: viam.app.v1.AppService.ListOrganizationMembers:input_type -> viam.app.v1.ListOrganizationMembersRequest
	22,  // 85: viam.app.v1.AppService.CreateOrganizationInvite:input_type -> viam.app.v1.CreateOrganizationInviteRequest
	24,  // 86: viam.app.v1.AppService.UpdateOrganizationInviteAuthorizations:input_type -> viam.app.v1.UpdateOrganizationInviteAuthorizationsRequest
	30,  // 87: viam.app.v1.AppService.DeleteOrganizationMember:input_type -> viam.app.v1.DeleteOrganizationMemberRequest
	26,  // 88: viam.app.v1.AppService.DeleteOrganizationInvite:input_type -> viam.app.v1.DeleteOrganizationInviteRequest
	28,  // 89: viam.app.v1.AppService.ResendOrganizationInvite:input_type -> viam.app.v1.ResendOrganizationInviteRequest
	37,  // 90: viam.app.v1.AppService.CreateLocation:input_type -> viam.app.v1.CreateLocationRequest
	39,  // 91: viam.app.v1.AppService.GetLocation:input_type -> viam.app.v1.GetLocationRequest
	41,  // 92: viam.app.v1.AppService.UpdateLocation:input_type -> viam.app.v1.UpdateLocationRequest
	43,  // 93: viam.app.v1.AppService.DeleteLocation:input_type -> viam.app.v1.DeleteLocationRequest
	45,  // 94: viam.app.v1.AppService.ListLocations:input_type -> viam.app.v1.ListLocationsRequest
	46,  // 95: viam.app.v1.AppService.ShareLocation:input_type -> viam.app.v1.ShareLocationRequest
	48,  // 96: viam.app.v1.AppService.UnshareLocation:input_type -> viam.app.v1.UnshareLocationRequest
	55,  // 97: viam.app.v1.AppService.LocationAuth:input_type -> viam.app.v1.LocationAuthRequest
	51,  // 98: viam.app.v1.AppService.CreateLocationSecret:input_type -> viam.app.v1.CreateLocationSecretRequest
	53,  // 99: viam.app.v1.AppService.DeleteLocationSecret:input_type -> viam.app.v1.DeleteLocationSecretRequest
	57,  // 100: viam.app.v1.AppService.GetRobot:input_type -> viam.app.v1.GetRobotRequest
	58,  // 101: viam.app.v1.AppService.GetRoverRentalRobots:input_type -> viam.app.v1.GetRoverRentalRobotsRequest
	62,  // 102: viam.app.v1.AppService.GetRobotParts:input_type -> viam.app.v1.GetRobotPartsRequest
	64,  // 103: viam.app.v1.AppService.GetRobotPart:input_type -> viam.app.v1.GetRobotPartRequest
	66,  // 104: viam.app.v1.AppService.GetRobotPartLogs:input_type -> viam.app.v1.GetRobotPartLogsRequest
	69,  // 105: viam.app.v1.AppService.TailRobotPartLogs:input_type -> viam.app.v1.TailRobotPartLogsRequest
	71,  // 106: viam.app.v1.AppService.GetRobotPartHistory:input_type -> viam.app.v1.GetRobotPartHistoryRequest
	73,  // 107: viam.app.v1.AppService.UpdateRobotPart:input_type -> viam.app.v1.UpdateRobotPartRequest
	75,  // 108: viam.app.v1.AppService.NewRobotPart:input_type -> viam.app.v1.NewRobotPartRequest
	77,  // 109: viam.app.v1.AppService.DeleteRobotPart:input_type -> viam.app.v1.DeleteRobotPartRequest
	98,  // 110: viam.app.v1.AppService.MarkPartAsMain:input_type -> viam.app.v1.MarkPartAsMainRequest
	100, // 111: viam.app.v1.AppService.MarkPartForRestart:input_type -> viam.app.v1.MarkPartForRestartRequest
	102, // 112: viam.app.v1.AppService.CreateRobotPartSecret:input_type -> viam.app.v1.CreateRobotPartSecretRequest
	104, // 113: viam.app.v1.AppService.DeleteRobotPartSecret:input_type -> viam.app.v1.DeleteRobotPartSecretRequest
	90,  // 114: viam.app.v1.AppService.ListRobots:input_type -> viam.app.v1.ListRobotsRequest
	92,  // 115: viam.app.v1.AppService.NewRobot:input_type -> viam.app.v1.NewRobotRequest
	94,  // 116: viam.app.v1.AppService.UpdateRobot:input_type -> viam.app.v1.UpdateRobotRequest
	96,  // 117: viam.app.v1.AppService.DeleteRobot:input_type -> viam.app.v1.DeleteRobotRequest
	80,  // 118: viam.app.v1.AppService.ListFragments:input_type -> viam.app.v1.ListFragmentsRequest
	82,  // 119: viam.app.v1.AppService.GetFragment:input_type -> viam.app.v1.GetFragmentRequest
	84,  // 120: viam.app.v1.AppService.CreateFragment:input_type -> viam.app.v1.CreateFragmentRequest
	86,  // 121: viam.app.v1.AppService.UpdateFragment:input_type -> viam.app.v1.UpdateFragmentRequest
	88,  // 122: viam.app.v1.AppService.DeleteFragment:input_type -> viam.app.v1.DeleteFragmentRequest
	107, // 123: viam.app.v1.AppService.AddRole:input_type -> viam.app.v1.AddRoleRequest
	109, // 124: viam.app.v1.AppService.RemoveRole:input_type -> viam.app.v1.RemoveRoleRequest
	111, // 125: viam.app.v1.AppService.ListAuthorizations:input_type -> viam.app.v1.ListAuthorizationsRequest
	113, // 126: viam.app.v1.AppService.CheckPermissions:input_type -> viam.app.v1.CheckPermissionsRequest
	116, // 127: viam.app.v1.AppService.CreateModule:input_type -> viam.app.v1.CreateModuleRequest
	118, // 128: viam.app.v1.AppService.UpdateModule:input_type -> viam.app.v1.UpdateModuleRequest
	122, // 129: viam.app.v1.AppService.UploadModuleFile:input_type -> viam.app.v1.UploadModuleFileRequest
	124, // 130: viam.app.v1.AppService.GetModule:input_type -> viam.app.v1.GetModuleRequest
	129, // 131: viam.app.v1.AppService.ListModules:input_type -> viam.app.v1.ListModulesRequest
	132, // 132: viam.app.v1.AppService.GetUserIDByEmail:output_type -> viam.app.v1.GetUserIDByEmailResponse
	11,  // 133: viam.app.v1.AppService.CreateOrganization:output_type -> viam.app.v1.CreateOrganizationResponse
	8,   // 134: viam.app.v1.AppService.ListOrganizations:output_type -> viam.app.v1.ListOrganizationsResponse
	135, // 135: viam.app.v1.AppService.ListOrganizationsByUser:output_type -> viam.app.v1.ListOrganizationsByUserResponse
	13,  // 136: viam.app.v1.AppService.GetOrganization:output_type -> viam.app.v1.GetOrganizationResponse
	15,  // 137: viam.app.v1.AppService.GetOrganizationNamespaceAvailability:output_type -> viam.app.v1.GetOrganizationNamespaceAvailabilityResponse
	17,  // 138: viam.app.v1.AppService.UpdateOrganization:output_type -> viam.app.v1.UpdateOrganizationResponse
	19,  // 139: viam.app.v1.AppService.DeleteOrganization:output_type -> viam.app.v1.DeleteOrganizationResponse
	21,  // 140: viam.app.v1.AppService.ListOrganizationMembers:output_type -> viam.app.v1.ListOrganizationMembersResponse
	23,  // 141: viam.app.v1.AppService.CreateOrganizationInvite:output_type -> viam.app.v1.CreateOrganizationInviteResponse
	25,  // 142: viam.app.v1.AppService.UpdateOrganizationInviteAuthorizations:output_type -> viam.app.v1.UpdateOrganizationInviteAuthorizationsResponse
	31,  // 143: viam.app.v1.AppService.DeleteOrganizationMember:output_type -> viam.app.v1.DeleteOrganizationMemberResponse
	27,  // 144: viam.app.v1.AppService.DeleteOrganizationInvite:output_type -> viam.app.v1.DeleteOrganizationInviteResponse
	29,  // 145: viam.app.v1.AppService.ResendOrganizationInvite:output_type -> viam.app.v1.ResendOrganizationInviteResponse
	38,  // 146: viam.app.v1.AppService.CreateLocation:output_type -> viam.app.v1.CreateLocationResponse
	40,  // 147: viam.app.v1.AppService.GetLocation:output_type -> viam.app.v1.GetLocationResponse
	42,  // 148: viam.app.v1.AppService.UpdateLocation:output_type -> viam.app.v1.UpdateLocationResponse
	44,  // 149: viam.app.v1.AppService.DeleteLocation:output_type -> viam.app.v1.DeleteLocationResponse
	50,  // 150: viam.app.v1.AppService.ListLocations:output_type -> viam.app.v1.ListLocationsResponse
	47,  // 151: viam.app.v1.AppService.ShareLocation:output_type -> viam.app.v1.ShareLocationResponse
	49,  // 152: viam.app.v1.AppService.UnshareLocation:output_type -> viam.app.v1.UnshareLocationResponse
	56,  // 153: viam.app.v1.AppService.LocationAuth:output_type -> viam.app.v1.LocationAuthResponse
	52,  // 154: viam.app.v1.AppService.CreateLocationSecret:output_type -> viam.app.v1.CreateLocationSecretResponse
	54,  // 155: viam.app.v1.AppService.DeleteLocationSecret:output_type -> viam.app.v1.DeleteLocationSecretResponse
	61,  // 156: viam.app.v1.AppService.GetRobot:output_type -> viam.app.v1.GetRobotResponse
	60,  // 157: viam.app.v1.AppService.GetRoverRentalRobots:output_type -> viam.app.v1.GetRoverRentalRobotsResponse
	63,  // 158: viam.app.v1.AppService.GetRobotParts:output_type -> viam.app.v1.GetRobotPartsResponse
	65,  // 159: viam.app.v1.AppService.GetRobotPart:output_type -> viam.app.v1.GetRobotPartResponse
	68,  // 160: viam.app.v1.AppService.GetRobotPartLogs:output_type -> viam.app.v1.GetRobotPartLogsResponse
	70,  // 161: viam.app.v1.AppService.TailRobotPartLogs:output_type -> viam.app.v1.TailRobotPartLogsResponse
	72,  // 162: viam.app.v1.AppService.GetRobotPartHistory:output_type -> viam.app.v1.GetRobotPartHistoryResponse
	74,  // 163: viam.app.v1.AppService.UpdateRobotPart:output_type -> viam.app.v1.UpdateRobotPartResponse
	76,  // 164: viam.app.v1.AppService.NewRobotPart:output_type -> viam.app.v1.NewRobotPartResponse
	78,  // 165: viam.app.v1.AppService.DeleteRobotPart:output_type -> viam.app.v1.DeleteRobotPartResponse
	99,  // 166: viam.app.v1.AppService.MarkPartAsMain:output_type -> viam.app.v1.MarkPartAsMainResponse
	101, // 167: viam.app.v1.AppService.MarkPartForRestart:output_type -> viam.app.v1.MarkPartForRestartResponse
	103, // 168: viam.app.v1.AppService.CreateRobotPartSecret:output_type -> viam.app.v1.CreateRobotPartSecretResponse
	105, // 169: viam.app.v1.AppService.DeleteRobotPartSecret:output_type -> viam.app.v1.DeleteRobotPartSecretResponse
	91,  // 170: viam.app.v1.AppService.ListRobots:output_type -> viam.app.v1.ListRobotsResponse
	93,  // 171: viam.app.v1.AppService.NewRobot:output_type -> viam.app.v1.NewRobotResponse
	95,  // 172: viam.app.v1.AppService.UpdateRobot:output_type -> viam.app.v1.UpdateRobotResponse
	97,  // 173: viam.app.v1.AppService.DeleteRobot:output_type -> viam.app.v1.DeleteRobotResponse
	81,  // 174: viam.app.v1.AppService.ListFragments:output_type -> viam.app.v1.ListFragmentsResponse
	83,  // 175: viam.app.v1.AppService.GetFragment:output_type -> viam.app.v1.GetFragmentResponse
	85,  // 176: viam.app.v1.AppService.CreateFragment:output_type -> viam.app.v1.CreateFragmentResponse
	87,  // 177: viam.app.v1.AppService.UpdateFragment:output_type -> viam.app.v1.UpdateFragmentResponse
	89,  // 178: viam.app.v1.AppService.DeleteFragment:output_type -> viam.app.v1.DeleteFragmentResponse
	108, // 179: viam.app.v1.AppService.AddRole:output_type -> viam.app.v1.AddRoleResponse
	110, // 180: viam.app.v1.AppService.RemoveRole:output_type -> viam.app.v1.RemoveRoleResponse
	112, // 181: viam.app.v1.AppService.ListAuthorizations:output_type -> viam.app.v1.ListAuthorizationsResponse
	115, // 182: viam.app.v1.AppService.CheckPermissions:output_type -> viam.app.v1.CheckPermissionsResponse
	117, // 183: viam.app.v1.AppService.CreateModule:output_type -> viam.app.v1.CreateModuleResponse
	119, // 184: viam.app.v1.AppService.UpdateModule:output_type -> viam.app.v1.UpdateModuleResponse
	123, // 185: viam.app.v1.AppService.UploadModuleFile:output_type -> viam.app.v1.UploadModuleFileResponse
	125, // 186: viam.app.v1.AppService.GetModule:output_type -> viam.app.v1.GetModuleResponse
	130, // 187: viam.app.v1.AppService.ListModules:output_type -> viam.app.v1.ListModulesResponse
	132, // [132:188] is the sub-list for method output_type
	76,  // [76:132] is the sub-list for method input_type
