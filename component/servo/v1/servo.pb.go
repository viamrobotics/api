...
var file_component_servo_v1_servo_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x67, 0x32, 0x89, 0x08, 0x0a, 0x0c, 0x53, 0x65, 0x72, 0x76, 0x6f, 0x53, 0x65, 0x72,
	...
	0x65, 0x7d, 0x2f, 0x64, 0x6f, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x88, 0x01,
	...
	0x2f, 0x73, 0x65, 0x72, 0x76, 0x6f, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x2f, 0x67, 0x65,
	0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x94, 0x01, 0x0a, 0x0d, 0x47, 0x65, 0x74,
	...
	0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x6f, 0x2e, 0x76, 0x31, 0x5a, 0x22,
...
var file_component_servo_v1_servo_proto_goTypes = []any{
	...
	(*v1.GetStatusRequest)(nil),      // 11: viam.common.v1.GetStatusRequest
...
var file_component_servo_v1_servo_proto_depIdxs = []int32{
	...
	11, // 8: viam.component.servo.v1.ServoService.GetStatus:input_type -> viam.common.v1.GetStatusRequest
	12, // 9: viam.component.servo.v1.ServoService.GetGeometries:input_type -> viam.common.v1.GetGeometriesRequest
	1,  // 10: viam.component.servo.v1.ServoService.Move:output_type -> viam.component.servo.v1.MoveResponse
	3,  // 11: viam.component.servo.v1.ServoService.GetPosition:output_type -> viam.component.servo.v1.GetPositionResponse
	5,  // 12: viam.component.servo.v1.ServoService.Stop:output_type -> viam.component.servo.v1.StopResponse
	8,  // 13: viam.component.servo.v1.ServoService.IsMoving:output_type -> viam.component.servo.v1.IsMovingResponse
	13, // 14: viam.component.servo.v1.ServoService.DoCommand:output_type -> viam.common.v1.DoCommandResponse
	14, // 15: viam.component.servo.v1.ServoService.GetStatus:output_type -> viam.common.v1.GetStatusResponse
	15, // 16: viam.component.servo.v1.ServoService.GetGeometries:output_type -> viam.common.v1.GetGeometriesResponse
