 ...
 */
const methodDescriptor_PowerSensorService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.component.powersensor.v1.PowerSensorServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.component.powersensor.v1.PowerSensorService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_PowerSensorService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.component.powersensor.v1.PowerSensorServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.component.powersensor.v1.PowerSensorService/GetStatus',
      request,
