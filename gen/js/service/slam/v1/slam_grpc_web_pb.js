 ...
 */
const methodDescriptor_SLAMService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.service.slam.v1.SLAMServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.service.slam.v1.SLAMService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_SLAMService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.service.slam.v1.SLAMServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.service.slam.v1.SLAMService/GetStatus',
      request,
