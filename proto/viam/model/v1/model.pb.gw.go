...
var (
	pattern_ModelService_Upload_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"proto.viam.model.v1.ModelService", "Upload"}, ""))

	pattern_ModelService_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"proto.viam.model.v1.ModelService", "Delete"}, ""))

	pattern_ModelService_Deploy_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"proto.viam.model.v1.ModelService", "Deploy"}, ""))
)
