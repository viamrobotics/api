...
var (
	filter_DataManagerService_UploadBinaryDataToDataset_0 = &utilities.DoubleArray{Encoding: map[string]int{"name": 0}, Base: []int{1, 1, 0}, Check: []int{0, 1, 2}}
)

func request_DataManagerService_UploadBinaryDataToDataset_0(ctx context.Context, marshaler runtime.Marshaler, client DataManagerServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UploadBinaryDataToDatasetRequest
	var metadata runtime.ServerMetadata
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_DataManagerService_UploadBinaryDataToDataset_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}

	msg, err := client.UploadBinaryDataToDataset(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_DataManagerService_UploadBinaryDataToDataset_0(ctx context.Context, marshaler runtime.Marshaler, server DataManagerServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UploadBinaryDataToDatasetRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UploadBinaryDataToDataset(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterDataManagerServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server DataManagerServiceServer) error {
	...
	mux.Handle("POST", pattern_DataManagerService_UploadBinaryDataToDataset_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/viam.service.datamanager.v1.DataManagerService/UploadBinaryDataToDataset", runtime.WithHTTPPathPattern("/viam/api/v1/service/datamanager/{name}/upload_binary_data_to_dataset"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_DataManagerService_UploadBinaryDataToDataset_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_DataManagerService_UploadBinaryDataToDataset_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterDataManagerServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client DataManagerServiceClient) error {
	...
	mux.Handle("POST", pattern_DataManagerService_UploadBinaryDataToDataset_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/viam.service.datamanager.v1.DataManagerService/UploadBinaryDataToDataset", runtime.WithHTTPPathPattern("/viam/api/v1/service/datamanager/{name}/upload_binary_data_to_dataset"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_DataManagerService_UploadBinaryDataToDataset_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_DataManagerService_UploadBinaryDataToDataset_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4, 1, 0, 4, 1, 5, 5, 2, 6}, []string{"viam", "api", "v1", "service", "datamanager", "name", "upload_binary_data_to_dataset"}, ""))
)
...
var (
	...
	forward_DataManagerService_UploadBinaryDataToDataset_0 = runtime.ForwardResponseMessage
)
