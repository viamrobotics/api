...
var file_app_v1_app_proto_rawDesc = []byte{
	...
	0x32, 0xac, 0x1b, 0x0a, 0x0a, 0x41, 0x70, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
...
var file_app_v1_app_proto_msgTypes = make([]protoimpl.MessageInfo, 84)
var file_app_v1_app_proto_goTypes = []interface{}{
	...
	(*NewRobotRequest)(nil),                  // 73: viam.app.v1.NewRobotRequest
	(*NewRobotResponse)(nil),                 // 74: viam.app.v1.NewRobotResponse
	(*UpdateRobotRequest)(nil),               // 75: viam.app.v1.UpdateRobotRequest
	(*UpdateRobotResponse)(nil),              // 76: viam.app.v1.UpdateRobotResponse
	(*DeleteRobotRequest)(nil),               // 77: viam.app.v1.DeleteRobotRequest
	(*DeleteRobotResponse)(nil),              // 78: viam.app.v1.DeleteRobotResponse
	(*MarkPartAsMainRequest)(nil),            // 79: viam.app.v1.MarkPartAsMainRequest
	(*MarkPartAsMainResponse)(nil),           // 80: viam.app.v1.MarkPartAsMainResponse
	(*CreateRobotPartSecretRequest)(nil),     // 81: viam.app.v1.CreateRobotPartSecretRequest
	(*CreateRobotPartSecretResponse)(nil),    // 82: viam.app.v1.CreateRobotPartSecretResponse
	(*DeleteRobotPartSecretRequest)(nil),     // 83: viam.app.v1.DeleteRobotPartSecretRequest
	(*DeleteRobotPartSecretResponse)(nil),    // 84: viam.app.v1.DeleteRobotPartSecretResponse
...
var file_app_v1_app_proto_depIdxs = []int32{
	85, // 0: viam.app.v1.Robot.last_access:type_name -> google.protobuf.Timestamp
	85, // 1: viam.app.v1.Robot.created_on:type_name -> google.protobuf.Timestamp
	86, // 2: viam.app.v1.RobotPart.robot_config:type_name -> google.protobuf.Struct
	85, // 3: viam.app.v1.RobotPart.last_access:type_name -> google.protobuf.Timestamp
	86, // 4: viam.app.v1.RobotPart.user_supplied_info:type_name -> google.protobuf.Struct
	85, // 5: viam.app.v1.RobotPart.created_on:type_name -> google.protobuf.Timestamp
	30, // 6: viam.app.v1.RobotPart.secrets:type_name -> viam.app.v1.SharedSecret
	85, // 7: viam.app.v1.RobotPartHistoryEntry.when:type_name -> google.protobuf.Timestamp
	2,  // 8: viam.app.v1.RobotPartHistoryEntry.old:type_name -> viam.app.v1.RobotPart
	85, // 9: viam.app.v1.Organization.created_on:type_name -> google.protobuf.Timestamp
	85, // 10: viam.app.v1.OrganizationMember.date_added:type_name -> google.protobuf.Timestamp
	5,  // 11: viam.app.v1.ListOrganizationsResponse.organizations:type_name -> viam.app.v1.Organization
	85, // 12: viam.app.v1.OrganizationInvite.created_on:type_name -> google.protobuf.Timestamp
	...
	85, // 23: viam.app.v1.Location.created_on:type_name -> google.protobuf.Timestamp
	85, // 24: viam.app.v1.SharedSecret.created_on:type_name -> google.protobuf.Timestamp
	...
	85, // 35: viam.app.v1.LogEntry.time:type_name -> google.protobuf.Timestamp
	86, // 36: viam.app.v1.LogEntry.caller:type_name -> google.protobuf.Struct
	86, // 37: viam.app.v1.LogEntry.fields:type_name -> google.protobuf.Struct
	...
	86, // 41: viam.app.v1.UpdateRobotPartRequest.robot_config:type_name -> google.protobuf.Struct
	2,  // 42: viam.app.v1.UpdateRobotPartResponse.part:type_name -> viam.app.v1.RobotPart
	86, // 43: viam.app.v1.Fragment.fragment:type_name -> google.protobuf.Struct
	85, // 44: viam.app.v1.Fragment.created_on:type_name -> google.protobuf.Timestamp
	1,  // 45: viam.app.v1.ListRobotsResponse.robots:type_name -> viam.app.v1.Robot
	1,  // 46: viam.app.v1.UpdateRobotResponse.robot:type_name -> viam.app.v1.Robot
	2,  // 47: viam.app.v1.CreateRobotPartSecretResponse.part:type_name -> viam.app.v1.RobotPart
	9,  // 48: viam.app.v1.AppService.CreateOrganization:input_type -> viam.app.v1.CreateOrganizationRequest
	4,  // 49: viam.app.v1.AppService.ListOrganizations:input_type -> viam.app.v1.ListOrganizationsRequest
	11, // 50: viam.app.v1.AppService.GetOrganization:input_type -> viam.app.v1.GetOrganizationRequest
	13, // 51: viam.app.v1.AppService.UpdateOrganization:input_type -> viam.app.v1.UpdateOrganizationRequest
	15, // 52: viam.app.v1.AppService.DeleteOrganization:input_type -> viam.app.v1.DeleteOrganizationRequest
	17, // 53: viam.app.v1.AppService.ListOrganizationMembers:input_type -> viam.app.v1.ListOrganizationMembersRequest
	19, // 54: viam.app.v1.AppService.CreateOrganizationInvite:input_type -> viam.app.v1.CreateOrganizationInviteRequest
	25, // 55: viam.app.v1.AppService.DeleteOrganizationMember:input_type -> viam.app.v1.DeleteOrganizationMemberRequest
	21, // 56: viam.app.v1.AppService.DeleteOrganizationInvite:input_type -> viam.app.v1.DeleteOrganizationInviteRequest
	23, // 57: viam.app.v1.AppService.ResendOrganizationInvite:input_type -> viam.app.v1.ResendOrganizationInviteRequest
	31, // 58: viam.app.v1.AppService.CreateLocation:input_type -> viam.app.v1.CreateLocationRequest
	33, // 59: viam.app.v1.AppService.GetLocation:input_type -> viam.app.v1.GetLocationRequest
	35, // 60: viam.app.v1.AppService.UpdateLocation:input_type -> viam.app.v1.UpdateLocationRequest
	37, // 61: viam.app.v1.AppService.DeleteLocation:input_type -> viam.app.v1.DeleteLocationRequest
	39, // 62: viam.app.v1.AppService.ListLocations:input_type -> viam.app.v1.ListLocationsRequest
	40, // 63: viam.app.v1.AppService.ShareLocation:input_type -> viam.app.v1.ShareLocationRequest
	42, // 64: viam.app.v1.AppService.UnshareLocation:input_type -> viam.app.v1.UnshareLocationRequest
	49, // 65: viam.app.v1.AppService.LocationAuth:input_type -> viam.app.v1.LocationAuthRequest
	45, // 66: viam.app.v1.AppService.CreateLocationSecret:input_type -> viam.app.v1.CreateLocationSecretRequest
	47, // 67: viam.app.v1.AppService.DeleteLocationSecret:input_type -> viam.app.v1.DeleteLocationSecretRequest
	51, // 68: viam.app.v1.AppService.GetRobot:input_type -> viam.app.v1.GetRobotRequest
	53, // 69: viam.app.v1.AppService.GetRobotParts:input_type -> viam.app.v1.GetRobotPartsRequest
	55, // 70: viam.app.v1.AppService.GetRobotPart:input_type -> viam.app.v1.GetRobotPartRequest
	57, // 71: viam.app.v1.AppService.GetRobotPartLogs:input_type -> viam.app.v1.GetRobotPartLogsRequest
	60, // 72: viam.app.v1.AppService.TailRobotPartLogs:input_type -> viam.app.v1.TailRobotPartLogsRequest
	62, // 73: viam.app.v1.AppService.GetRobotPartHistory:input_type -> viam.app.v1.GetRobotPartHistoryRequest
	64, // 74: viam.app.v1.AppService.UpdateRobotPart:input_type -> viam.app.v1.UpdateRobotPartRequest
	66, // 75: viam.app.v1.AppService.NewRobotPart:input_type -> viam.app.v1.NewRobotPartRequest
	68, // 76: viam.app.v1.AppService.DeleteRobotPart:input_type -> viam.app.v1.DeleteRobotPartRequest
	79, // 77: viam.app.v1.AppService.MarkPartAsMain:input_type -> viam.app.v1.MarkPartAsMainRequest
	81, // 78: viam.app.v1.AppService.CreateRobotPartSecret:input_type -> viam.app.v1.CreateRobotPartSecretRequest
	83, // 79: viam.app.v1.AppService.DeleteRobotPartSecret:input_type -> viam.app.v1.DeleteRobotPartSecretRequest
	71, // 80: viam.app.v1.AppService.ListRobots:input_type -> viam.app.v1.ListRobotsRequest
	73, // 81: viam.app.v1.AppService.NewRobot:input_type -> viam.app.v1.NewRobotRequest
	75, // 82: viam.app.v1.AppService.UpdateRobot:input_type -> viam.app.v1.UpdateRobotRequest
	77, // 83: viam.app.v1.AppService.DeleteRobot:input_type -> viam.app.v1.DeleteRobotRequest
	10, // 84: viam.app.v1.AppService.CreateOrganization:output_type -> viam.app.v1.CreateOrganizationResponse
	7,  // 85: viam.app.v1.AppService.ListOrganizations:output_type -> viam.app.v1.ListOrganizationsResponse
	12, // 86: viam.app.v1.AppService.GetOrganization:output_type -> viam.app.v1.GetOrganizationResponse
	14, // 87: viam.app.v1.AppService.UpdateOrganization:output_type -> viam.app.v1.UpdateOrganizationResponse
	16, // 88: viam.app.v1.AppService.DeleteOrganization:output_type -> viam.app.v1.DeleteOrganizationResponse
	18, // 89: viam.app.v1.AppService.ListOrganizationMembers:output_type -> viam.app.v1.ListOrganizationMembersResponse
	20, // 90: viam.app.v1.AppService.CreateOrganizationInvite:output_type -> viam.app.v1.CreateOrganizationInviteResponse
	26, // 91: viam.app.v1.AppService.DeleteOrganizationMember:output_type -> viam.app.v1.DeleteOrganizationMemberResponse
	22, // 92: viam.app.v1.AppService.DeleteOrganizationInvite:output_type -> viam.app.v1.DeleteOrganizationInviteResponse
	24, // 93: viam.app.v1.AppService.ResendOrganizationInvite:output_type -> viam.app.v1.ResendOrganizationInviteResponse
	32, // 94: viam.app.v1.AppService.CreateLocation:output_type -> viam.app.v1.CreateLocationResponse
	34, // 95: viam.app.v1.AppService.GetLocation:output_type -> viam.app.v1.GetLocationResponse
	36, // 96: viam.app.v1.AppService.UpdateLocation:output_type -> viam.app.v1.UpdateLocationResponse
	38, // 97: viam.app.v1.AppService.DeleteLocation:output_type -> viam.app.v1.DeleteLocationResponse
	44, // 98: viam.app.v1.AppService.ListLocations:output_type -> viam.app.v1.ListLocationsResponse
	41, // 99: viam.app.v1.AppService.ShareLocation:output_type -> viam.app.v1.ShareLocationResponse
	43, // 100: viam.app.v1.AppService.UnshareLocation:output_type -> viam.app.v1.UnshareLocationResponse
	50, // 101: viam.app.v1.AppService.LocationAuth:output_type -> viam.app.v1.LocationAuthResponse
	46, // 102: viam.app.v1.AppService.CreateLocationSecret:output_type -> viam.app.v1.CreateLocationSecretResponse
	48, // 103: viam.app.v1.AppService.DeleteLocationSecret:output_type -> viam.app.v1.DeleteLocationSecretResponse
	52, // 104: viam.app.v1.AppService.GetRobot:output_type -> viam.app.v1.GetRobotResponse
	54, // 105: viam.app.v1.AppService.GetRobotParts:output_type -> viam.app.v1.GetRobotPartsResponse
	56, // 106: viam.app.v1.AppService.GetRobotPart:output_type -> viam.app.v1.GetRobotPartResponse
	59, // 107: viam.app.v1.AppService.GetRobotPartLogs:output_type -> viam.app.v1.GetRobotPartLogsResponse
	61, // 108: viam.app.v1.AppService.TailRobotPartLogs:output_type -> viam.app.v1.TailRobotPartLogsResponse
	63, // 109: viam.app.v1.AppService.GetRobotPartHistory:output_type -> viam.app.v1.GetRobotPartHistoryResponse
	65, // 110: viam.app.v1.AppService.UpdateRobotPart:output_type -> viam.app.v1.UpdateRobotPartResponse
	67, // 111: viam.app.v1.AppService.NewRobotPart:output_type -> viam.app.v1.NewRobotPartResponse
	69, // 112: viam.app.v1.AppService.DeleteRobotPart:output_type -> viam.app.v1.DeleteRobotPartResponse
	80, // 113: viam.app.v1.AppService.MarkPartAsMain:output_type -> viam.app.v1.MarkPartAsMainResponse
	82, // 114: viam.app.v1.AppService.CreateRobotPartSecret:output_type -> viam.app.v1.CreateRobotPartSecretResponse
	84, // 115: viam.app.v1.AppService.DeleteRobotPartSecret:output_type -> viam.app.v1.DeleteRobotPartSecretResponse
	72, // 116: viam.app.v1.AppService.ListRobots:output_type -> viam.app.v1.ListRobotsResponse
	74, // 117: viam.app.v1.AppService.NewRobot:output_type -> viam.app.v1.NewRobotResponse
	76, // 118: viam.app.v1.AppService.UpdateRobot:output_type -> viam.app.v1.UpdateRobotResponse
	78, // 119: viam.app.v1.AppService.DeleteRobot:output_type -> viam.app.v1.DeleteRobotResponse
