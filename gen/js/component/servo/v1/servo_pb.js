...
goog.exportSymbol('proto.viam.component.servo.v1.IsMovingRequest', null, global);
goog.exportSymbol('proto.viam.component.servo.v1.IsMovingResponse', null, global);
 ...
 * @constructor
 */
proto.viam.component.servo.v1.IsMovingRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.viam.component.servo.v1.IsMovingRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viam.component.servo.v1.IsMovingRequest.displayName = 'proto.viam.component.servo.v1.IsMovingRequest';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.viam.component.servo.v1.IsMovingResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.viam.component.servo.v1.IsMovingResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viam.component.servo.v1.IsMovingResponse.displayName = 'proto.viam.component.servo.v1.IsMovingResponse';
}
 ...
 * @return {!Object}
 */
proto.viam.component.servo.v1.IsMovingRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.component.servo.v1.IsMovingRequest.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.component.servo.v1.IsMovingRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.component.servo.v1.IsMovingRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    name: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.viam.component.servo.v1.IsMovingRequest}
 */
proto.viam.component.servo.v1.IsMovingRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.component.servo.v1.IsMovingRequest;
  return proto.viam.component.servo.v1.IsMovingRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.component.servo.v1.IsMovingRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.component.servo.v1.IsMovingRequest}
 */
proto.viam.component.servo.v1.IsMovingRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.component.servo.v1.IsMovingRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.component.servo.v1.IsMovingRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.component.servo.v1.IsMovingRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.component.servo.v1.IsMovingRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getName();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.viam.component.servo.v1.IsMovingRequest.prototype.getName = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.viam.component.servo.v1.IsMovingRequest} returns this
 */
proto.viam.component.servo.v1.IsMovingRequest.prototype.setName = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.viam.component.servo.v1.IsMovingResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.component.servo.v1.IsMovingResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.component.servo.v1.IsMovingResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.component.servo.v1.IsMovingResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.viam.component.servo.v1.IsMovingResponse}
 */
proto.viam.component.servo.v1.IsMovingResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.component.servo.v1.IsMovingResponse;
  return proto.viam.component.servo.v1.IsMovingResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.component.servo.v1.IsMovingResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.component.servo.v1.IsMovingResponse}
 */
proto.viam.component.servo.v1.IsMovingResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.component.servo.v1.IsMovingResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.component.servo.v1.IsMovingResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.component.servo.v1.IsMovingResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.component.servo.v1.IsMovingResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getIsMoving();
  if (f) {
    writer.writeBool(
 ...
 * @return {boolean}
 */
proto.viam.component.servo.v1.IsMovingResponse.prototype.getIsMoving = function() {
...
/**
 * @param {boolean} value
 * @return {!proto.viam.component.servo.v1.IsMovingResponse} returns this
 */
proto.viam.component.servo.v1.IsMovingResponse.prototype.setIsMoving = function(value) {
