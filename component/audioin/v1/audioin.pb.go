...
var file_component_audioin_v1_audioin_proto_rawDesc = []byte{
	...
	0x32, 0xf9, 0x05, 0x0a, 0x0e, 0x41, 0x75, 0x64, 0x69, 0x6f, 0x49, 0x6e, 0x53, 0x65, 0x72, 0x76,
	...
	0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x88, 0x01, 0x0a, 0x09, 0x47, 0x65, 0x74,
	...
	0x31, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x61, 0x75, 0x64, 0x69, 0x6f, 0x69,
	0x6e, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65, 0x7d, 0x2f, 0x67, 0x65, 0x74, 0x5f, 0x73, 0x74, 0x61,
	0x74, 0x75, 0x73, 0x12, 0x96, 0x01, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x47, 0x65, 0x6f, 0x6d, 0x65,
	...
	0x6e, 0x74, 0x2f, 0x61, 0x75, 0x64, 0x69, 0x6f, 0x69, 0x6e, 0x2f, 0x7b, 0x6e, 0x61, 0x6d, 0x65,
	0x7d, 0x2f, 0x67, 0x65, 0x6f, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x65, 0x73, 0x42, 0x45, 0x0a, 0x1d,
...
var file_component_audioin_v1_audioin_proto_goTypes = []any{
	...
	(*v1.GetStatusRequest)(nil),      // 7: viam.common.v1.GetStatusRequest
	(*v1.GetGeometriesRequest)(nil),  // 8: viam.common.v1.GetGeometriesRequest
	(*v1.GetPropertiesResponse)(nil), // 9: viam.common.v1.GetPropertiesResponse
	(*v1.DoCommandResponse)(nil),     // 10: viam.common.v1.DoCommandResponse
	(*v1.GetStatusResponse)(nil),     // 11: viam.common.v1.GetStatusResponse
...
var file_component_audioin_v1_audioin_proto_depIdxs = []int32{
	...
	7,  // 6: viam.component.audioin.v1.AudioInService.GetStatus:input_type -> viam.common.v1.GetStatusRequest
	8,  // 7: viam.component.audioin.v1.AudioInService.GetGeometries:input_type -> viam.common.v1.GetGeometriesRequest
	1,  // 8: viam.component.audioin.v1.AudioInService.GetAudio:output_type -> viam.component.audioin.v1.GetAudioResponse
	9,  // 9: viam.component.audioin.v1.AudioInService.GetProperties:output_type -> viam.common.v1.GetPropertiesResponse
	10, // 10: viam.component.audioin.v1.AudioInService.DoCommand:output_type -> viam.common.v1.DoCommandResponse
	11, // 11: viam.component.audioin.v1.AudioInService.GetStatus:output_type -> viam.common.v1.GetStatusResponse
	12, // 12: viam.component.audioin.v1.AudioInService.GetGeometries:output_type -> viam.common.v1.GetGeometriesResponse
