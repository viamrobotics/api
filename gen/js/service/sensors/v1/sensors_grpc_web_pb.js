 ...
 *   !proto.viam.service.sensors.v1.GetSensorsResponse>}
 */
const methodInfo_SensorsService_GetSensors = new grpc.web.AbstractClientBase.MethodInfo(
  proto.viam.service.sensors.v1.GetSensorsResponse,
  /**
   * @param {!proto.viam.service.sensors.v1.GetSensorsRequest} request
   * @return {!Uint8Array}
 ...
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.viam.service.sensors.v1.GetSensorsResponse)}
 ...
 *   !proto.viam.service.sensors.v1.GetReadingsResponse>}
 */
const methodInfo_SensorsService_GetReadings = new grpc.web.AbstractClientBase.MethodInfo(
  proto.viam.service.sensors.v1.GetReadingsResponse,
  /**
   * @param {!proto.viam.service.sensors.v1.GetReadingsRequest} request
   * @return {!Uint8Array}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.viam.service.sensors.v1.GetReadingsResponse)}
 *     callback The callback function(error, response)
 ...
 */
const methodDescriptor_SensorsService_DoCommand = new grpc.web.MethodDescriptor(
 ...
 *   !proto.viam.common.v1.DoCommandResponse>}
 */
const methodInfo_SensorsService_DoCommand = new grpc.web.AbstractClientBase.MethodInfo(
  common_v1_common_pb.DoCommandResponse,
  /**
   * @param {!proto.viam.common.v1.DoCommandRequest} request
   * @return {!Uint8Array}
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.service.sensors.v1.SensorsServiceClient.prototype.doCommand =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.service.sensors.v1.SensorsService/DoCommand',
      request,
      metadata || {},
      methodDescriptor_SensorsService_DoCommand,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.service.sensors.v1.SensorsServicePromiseClient.prototype.doCommand =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.service.sensors.v1.SensorsService/DoCommand',
      request,
