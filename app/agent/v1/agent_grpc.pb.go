...
const (
	AgentDeviceService_DeviceAgentConfig_FullMethodName = "/viam.app.agent.v1.AgentDeviceService/DeviceAgentConfig"
)
...
func (c *agentDeviceServiceClient) DeviceAgentConfig(ctx context.Context, in *DeviceAgentConfigRequest, opts ...grpc.CallOption) (*DeviceAgentConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, AgentDeviceService_DeviceAgentConfig_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAgentDeviceServiceServer must be embedded to have
...
func (UnimplementedAgentDeviceServiceServer) testEmbeddedByValue()                            {}
...
func RegisterAgentDeviceServiceServer(s grpc.ServiceRegistrar, srv AgentDeviceServiceServer) {
	// If the following call pancis, it indicates UnimplementedAgentDeviceServiceServer was
...
func _AgentDeviceService_DeviceAgentConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AgentDeviceService_DeviceAgentConfig_FullMethodName,
	}
