...
var service_video_v1_video_pb = require("../../../service/video/v1/video_pb");
...
VideoService.GetVideo = {
  ...
  requestStream: false,
  responseStream: true,
  requestType: service_video_v1_video_pb.GetVideoRequest,
  responseType: service_video_v1_video_pb.GetVideoResponse
};
...
VideoServiceClient.prototype.getStatus = function getStatus(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(VideoService.GetStatus, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
