 ...
 */
const methodDescriptor_DataManagerService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.service.datamanager.v1.DataManagerServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.service.datamanager.v1.DataManagerService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_DataManagerService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.service.datamanager.v1.DataManagerServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.service.datamanager.v1.DataManagerService/GetStatus',
      request,
