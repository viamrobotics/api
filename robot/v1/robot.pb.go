...
var file_robot_v1_robot_proto_rawDesc = []byte{
	...
	0x22, 0x6b, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x30, 0x0a, 0x04, 0x6e, 0x61,
	...
	0x74, 0x72, 0x75, 0x63, 0x74, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0x57, 0x0a,
	...
	0x32, 0xf8, 0x0f, 0x0a, 0x0c, 0x52, 0x6f, 0x62, 0x6f, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x7d, 0x2f, 0x68, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x42, 0x2d, 0x0a, 0x11, 0x63,
...
var file_robot_v1_robot_proto_depIdxs = []int32{
	...
	43, // 22: viam.robot.v1.GetStatusRequest.resource_names:type_name -> viam.common.v1.ResourceName
	28, // 23: viam.robot.v1.GetStatusResponse.status:type_name -> viam.robot.v1.Status
	43, // 24: viam.robot.v1.StreamStatusRequest.resource_names:type_name -> viam.common.v1.ResourceName
	45, // 25: viam.robot.v1.StreamStatusRequest.every:type_name -> google.protobuf.Duration
	28, // 26: viam.robot.v1.StreamStatusResponse.status:type_name -> viam.robot.v1.Status
	43, // 27: viam.robot.v1.StopExtraParameters.name:type_name -> viam.common.v1.ResourceName
	41, // 28: viam.robot.v1.StopExtraParameters.params:type_name -> google.protobuf.Struct
	33, // 29: viam.robot.v1.StopAllRequest.extra:type_name -> viam.robot.v1.StopExtraParameters
	45, // 30: viam.robot.v1.StartSessionResponse.heartbeat_window:type_name -> google.protobuf.Duration
	14, // 31: viam.robot.v1.RobotService.GetOperations:input_type -> viam.robot.v1.GetOperationsRequest
	22, // 32: viam.robot.v1.RobotService.GetSessions:input_type -> viam.robot.v1.GetSessionsRequest
	8,  // 33: viam.robot.v1.RobotService.ResourceNames:input_type -> viam.robot.v1.ResourceNamesRequest
	11, // 34: viam.robot.v1.RobotService.ResourceRPCSubtypes:input_type -> viam.robot.v1.ResourceRPCSubtypesRequest
	16, // 35: viam.robot.v1.RobotService.CancelOperation:input_type -> viam.robot.v1.CancelOperationRequest
	18, // 36: viam.robot.v1.RobotService.BlockForOperation:input_type -> viam.robot.v1.BlockForOperationRequest
	26, // 37: viam.robot.v1.RobotService.DiscoverComponents:input_type -> viam.robot.v1.DiscoverComponentsRequest
	...
	6,  // 40: viam.robot.v1.RobotService.TransformPCD:input_type -> viam.robot.v1.TransformPCDRequest
	29, // 41: viam.robot.v1.RobotService.GetStatus:input_type -> viam.robot.v1.GetStatusRequest
	31, // 42: viam.robot.v1.RobotService.StreamStatus:input_type -> viam.robot.v1.StreamStatusRequest
	34, // 43: viam.robot.v1.RobotService.StopAll:input_type -> viam.robot.v1.StopAllRequest
	36, // 44: viam.robot.v1.RobotService.StartSession:input_type -> viam.robot.v1.StartSessionRequest
	38, // 45: viam.robot.v1.RobotService.SendSessionHeartbeat:input_type -> viam.robot.v1.SendSessionHeartbeatRequest
	15, // 46: viam.robot.v1.RobotService.GetOperations:output_type -> viam.robot.v1.GetOperationsResponse
	23, // 47: viam.robot.v1.RobotService.GetSessions:output_type -> viam.robot.v1.GetSessionsResponse
	9,  // 48: viam.robot.v1.RobotService.ResourceNames:output_type -> viam.robot.v1.ResourceNamesResponse
	12, // 49: viam.robot.v1.RobotService.ResourceRPCSubtypes:output_type -> viam.robot.v1.ResourceRPCSubtypesResponse
	17, // 50: viam.robot.v1.RobotService.CancelOperation:output_type -> viam.robot.v1.CancelOperationResponse
	19, // 51: viam.robot.v1.RobotService.BlockForOperation:output_type -> viam.robot.v1.BlockForOperationResponse
	27, // 52: viam.robot.v1.RobotService.DiscoverComponents:output_type -> viam.robot.v1.DiscoverComponentsResponse
	3,  // 53: viam.robot.v1.RobotService.FrameSystemConfig:output_type -> viam.robot.v1.FrameSystemConfigResponse
	5,  // 54: viam.robot.v1.RobotService.TransformPose:output_type -> viam.robot.v1.TransformPoseResponse
	7,  // 55: viam.robot.v1.RobotService.TransformPCD:output_type -> viam.robot.v1.TransformPCDResponse
	30, // 56: viam.robot.v1.RobotService.GetStatus:output_type -> viam.robot.v1.GetStatusResponse
	32, // 57: viam.robot.v1.RobotService.StreamStatus:output_type -> viam.robot.v1.StreamStatusResponse
	35, // 58: viam.robot.v1.RobotService.StopAll:output_type -> viam.robot.v1.StopAllResponse
	37, // 59: viam.robot.v1.RobotService.StartSession:output_type -> viam.robot.v1.StartSessionResponse
	39, // 60: viam.robot.v1.RobotService.SendSessionHeartbeat:output_type -> viam.robot.v1.SendSessionHeartbeatResponse
