...
type BinaryDataByFilterResponse struct {
	...
	Metadata []*BinaryMetadata `protobuf:"bytes,1,rep,name=metadata,proto3" json:"metadata,omitempty"`
...
func (x *BinaryDataByFilterResponse) GetMetadata() []*BinaryMetadata {
	if x != nil {
		return x.Metadata
	}
	return nil
...
type BinaryMetadata struct {
	...
	CaptureMetadata *CaptureMetadata       `protobuf:"bytes,1,opt,name=capture_metadata,json=captureMetadata,proto3" json:"capture_metadata,omitempty"`
	TimeRequested   *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=time_requested,json=timeRequested,proto3" json:"time_requested,omitempty"`
	TimeReceived    *timestamppb.Timestamp `protobuf:"bytes,3,opt,name=time_received,json=timeReceived,proto3" json:"time_received,omitempty"`
...
var file_app_data_v1_data_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x65, 0x52, 0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x64, 0x22, 0x34, 0x0a, 0x0a, 0x42,
	0x69, 0x6e, 0x61, 0x72, 0x79, 0x44, 0x61, 0x74, 0x61, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x62, 0x69, 0x6e,
	0x61, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x62, 0x69, 0x6e, 0x61, 0x72,
	0x79, 0x22, 0xa3, 0x01, 0x0a, 0x19, 0x42, 0x69, 0x6e, 0x61, 0x72, 0x79, 0x44, 0x61, 0x74, 0x61,
	...
	0x75, 0x6e, 0x74, 0x4f, 0x6e, 0x6c, 0x79, 0x22, 0xa2, 0x01, 0x0a, 0x1a, 0x42, 0x69, 0x6e, 0x61,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0xa3, 0x02, 0x0a, 0x0e,
	0x42, 0x69, 0x6e, 0x61, 0x72, 0x79, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x4c,
	...
	0x74, 0x69, 0x6d, 0x65, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x65, 0x64, 0x18, 0x02,
	...
	0x6e, 0x61, 0x6d, 0x65, 0x12, 0x19, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x5f, 0x65, 0x78, 0x74,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x66, 0x69, 0x6c, 0x65, 0x45, 0x78, 0x74, 0x12,
	0x10, 0x0a, 0x03, 0x75, 0x72, 0x69, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72,
	0x69, 0x32, 0xda, 0x02, 0x0a, 0x0b, 0x44, 0x61, 0x74, 0x61, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_app_data_v1_data_proto_goTypes = []interface{}{
	...
	nil,                                 // 13: viam.app.data.v1.CaptureMetadata.MethodParametersEntry
...
var file_app_data_v1_data_proto_depIdxs = []int32{
	...
	13, // 2: viam.app.data.v1.CaptureMetadata.method_parameters:type_name -> viam.app.data.v1.CaptureMetadata.MethodParametersEntry
	14, // 3: viam.app.data.v1.CaptureInterval.start:type_name -> google.protobuf.Timestamp
	14, // 4: viam.app.data.v1.CaptureInterval.end:type_name -> google.protobuf.Timestamp
	...
	15, // 8: viam.app.data.v1.TabularData.data:type_name -> google.protobuf.Struct
	14, // 9: viam.app.data.v1.TabularData.time_requested:type_name -> google.protobuf.Timestamp
	14, // 10: viam.app.data.v1.TabularData.time_received:type_name -> google.protobuf.Timestamp
	0,  // 11: viam.app.data.v1.BinaryDataByFilterRequest.data_request:type_name -> viam.app.data.v1.DataRequest
	12, // 12: viam.app.data.v1.BinaryDataByFilterResponse.metadata:type_name -> viam.app.data.v1.BinaryMetadata
	...
	2,  // 16: viam.app.data.v1.BinaryMetadata.capture_metadata:type_name -> viam.app.data.v1.CaptureMetadata
	14, // 17: viam.app.data.v1.BinaryMetadata.time_requested:type_name -> google.protobuf.Timestamp
	14, // 18: viam.app.data.v1.BinaryMetadata.time_received:type_name -> google.protobuf.Timestamp
	16, // 19: viam.app.data.v1.CaptureMetadata.MethodParametersEntry.value:type_name -> google.protobuf.Any
	4,  // 20: viam.app.data.v1.DataService.TabularDataByFilter:input_type -> viam.app.data.v1.TabularDataByFilterRequest
	8,  // 21: viam.app.data.v1.DataService.BinaryDataByFilter:input_type -> viam.app.data.v1.BinaryDataByFilterRequest
	10, // 22: viam.app.data.v1.DataService.BinaryDataByIDs:input_type -> viam.app.data.v1.BinaryDataByIDsRequest
	5,  // 23: viam.app.data.v1.DataService.TabularDataByFilter:output_type -> viam.app.data.v1.TabularDataByFilterResponse
	9,  // 24: viam.app.data.v1.DataService.BinaryDataByFilter:output_type -> viam.app.data.v1.BinaryDataByFilterResponse
	11, // 25: viam.app.data.v1.DataService.BinaryDataByIDs:output_type -> viam.app.data.v1.BinaryDataByIDsResponse
