...
var file_app_v1_app_proto_rawDesc = []byte{
	...
	0x43, 0x10, 0x02, 0x32, 0xf7, 0x2b, 0x0a, 0x0a, 0x41, 0x70, 0x70, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x74, 0x65, 0x4b, 0x65, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x18, 0x5a,
...
var file_app_v1_app_proto_depIdxs = []int32{
	...
	122, // 76: viam.app.v1.VersionHistory.models:type_name -> viam.app.v1.Model
	140, // 77: viam.app.v1.Uploads.uploaded_at:type_name -> google.protobuf.Timestamp
	128, // 78: viam.app.v1.ListModulesResponse.modules:type_name -> viam.app.v1.Module
	136, // 79: viam.app.v1.ListOrganizationsByUserResponse.orgs:type_name -> viam.app.v1.OrgDetails
	106, // 80: viam.app.v1.CreateKeyRequest.authorizations:type_name -> viam.app.v1.Authorization
	133, // 81: viam.app.v1.AppService.GetUserIDByEmail:input_type -> viam.app.v1.GetUserIDByEmailRequest
	10,  // 82: viam.app.v1.AppService.CreateOrganization:input_type -> viam.app.v1.CreateOrganizationRequest
	5,   // 83: viam.app.v1.AppService.ListOrganizations:input_type -> viam.app.v1.ListOrganizationsRequest
	135, // 84: viam.app.v1.AppService.ListOrganizationsByUser:input_type -> viam.app.v1.ListOrganizationsByUserRequest
	12,  // 85: viam.app.v1.AppService.GetOrganization:input_type -> viam.app.v1.GetOrganizationRequest
	14,  // 86: viam.app.v1.AppService.GetOrganizationNamespaceAvailability:input_type -> viam.app.v1.GetOrganizationNamespaceAvailabilityRequest
	16,  // 87: viam.app.v1.AppService.UpdateOrganization:input_type -> viam.app.v1.UpdateOrganizationRequest
	18,  // 88: viam.app.v1.AppService.DeleteOrganization:input_type -> viam.app.v1.DeleteOrganizationRequest
	20,  // 89: viam.app.v1.AppService.ListOrganizationMembers:input_type -> viam.app.v1.ListOrganizationMembersRequest
	22,  // 90: viam.app.v1.AppService.CreateOrganizationInvite:input_type -> viam.app.v1.CreateOrganizationInviteRequest
	24,  // 91: viam.app.v1.AppService.UpdateOrganizationInviteAuthorizations:input_type -> viam.app.v1.UpdateOrganizationInviteAuthorizationsRequest
	30,  // 92: viam.app.v1.AppService.DeleteOrganizationMember:input_type -> viam.app.v1.DeleteOrganizationMemberRequest
	26,  // 93: viam.app.v1.AppService.DeleteOrganizationInvite:input_type -> viam.app.v1.DeleteOrganizationInviteRequest
	28,  // 94: viam.app.v1.AppService.ResendOrganizationInvite:input_type -> viam.app.v1.ResendOrganizationInviteRequest
	37,  // 95: viam.app.v1.AppService.CreateLocation:input_type -> viam.app.v1.CreateLocationRequest
	39,  // 96: viam.app.v1.AppService.GetLocation:input_type -> viam.app.v1.GetLocationRequest
	41,  // 97: viam.app.v1.AppService.UpdateLocation:input_type -> viam.app.v1.UpdateLocationRequest
	43,  // 98: viam.app.v1.AppService.DeleteLocation:input_type -> viam.app.v1.DeleteLocationRequest
	45,  // 99: viam.app.v1.AppService.ListLocations:input_type -> viam.app.v1.ListLocationsRequest
	46,  // 100: viam.app.v1.AppService.ShareLocation:input_type -> viam.app.v1.ShareLocationRequest
	48,  // 101: viam.app.v1.AppService.UnshareLocation:input_type -> viam.app.v1.UnshareLocationRequest
	55,  // 102: viam.app.v1.AppService.LocationAuth:input_type -> viam.app.v1.LocationAuthRequest
	51,  // 103: viam.app.v1.AppService.CreateLocationSecret:input_type -> viam.app.v1.CreateLocationSecretRequest
	53,  // 104: viam.app.v1.AppService.DeleteLocationSecret:input_type -> viam.app.v1.DeleteLocationSecretRequest
	57,  // 105: viam.app.v1.AppService.GetRobot:input_type -> viam.app.v1.GetRobotRequest
	58,  // 106: viam.app.v1.AppService.GetRoverRentalRobots:input_type -> viam.app.v1.GetRoverRentalRobotsRequest
	62,  // 107: viam.app.v1.AppService.GetRobotParts:input_type -> viam.app.v1.GetRobotPartsRequest
	64,  // 108: viam.app.v1.AppService.GetRobotPart:input_type -> viam.app.v1.GetRobotPartRequest
	66,  // 109: viam.app.v1.AppService.GetRobotPartLogs:input_type -> viam.app.v1.GetRobotPartLogsRequest
	69,  // 110: viam.app.v1.AppService.TailRobotPartLogs:input_type -> viam.app.v1.TailRobotPartLogsRequest
	71,  // 111: viam.app.v1.AppService.GetRobotPartHistory:input_type -> viam.app.v1.GetRobotPartHistoryRequest
	73,  // 112: viam.app.v1.AppService.UpdateRobotPart:input_type -> viam.app.v1.UpdateRobotPartRequest
	75,  // 113: viam.app.v1.AppService.NewRobotPart:input_type -> viam.app.v1.NewRobotPartRequest
	77,  // 114: viam.app.v1.AppService.DeleteRobotPart:input_type -> viam.app.v1.DeleteRobotPartRequest
	98,  // 115: viam.app.v1.AppService.MarkPartAsMain:input_type -> viam.app.v1.MarkPartAsMainRequest
	100, // 116: viam.app.v1.AppService.MarkPartForRestart:input_type -> viam.app.v1.MarkPartForRestartRequest
	102, // 117: viam.app.v1.AppService.CreateRobotPartSecret:input_type -> viam.app.v1.CreateRobotPartSecretRequest
	104, // 118: viam.app.v1.AppService.DeleteRobotPartSecret:input_type -> viam.app.v1.DeleteRobotPartSecretRequest
	90,  // 119: viam.app.v1.AppService.ListRobots:input_type -> viam.app.v1.ListRobotsRequest
	92,  // 120: viam.app.v1.AppService.NewRobot:input_type -> viam.app.v1.NewRobotRequest
	94,  // 121: viam.app.v1.AppService.UpdateRobot:input_type -> viam.app.v1.UpdateRobotRequest
	96,  // 122: viam.app.v1.AppService.DeleteRobot:input_type -> viam.app.v1.DeleteRobotRequest
	80,  // 123: viam.app.v1.AppService.ListFragments:input_type -> viam.app.v1.ListFragmentsRequest
	82,  // 124: viam.app.v1.AppService.GetFragment:input_type -> viam.app.v1.GetFragmentRequest
	84,  // 125: viam.app.v1.AppService.CreateFragment:input_type -> viam.app.v1.CreateFragmentRequest
	86,  // 126: viam.app.v1.AppService.UpdateFragment:input_type -> viam.app.v1.UpdateFragmentRequest
	88,  // 127: viam.app.v1.AppService.DeleteFragment:input_type -> viam.app.v1.DeleteFragmentRequest
	107, // 128: viam.app.v1.AppService.AddRole:input_type -> viam.app.v1.AddRoleRequest
	109, // 129: viam.app.v1.AppService.RemoveRole:input_type -> viam.app.v1.RemoveRoleRequest
	111, // 130: viam.app.v1.AppService.ChangeRole:input_type -> viam.app.v1.ChangeRoleRequest
	113, // 131: viam.app.v1.AppService.ListAuthorizations:input_type -> viam.app.v1.ListAuthorizationsRequest
	115, // 132: viam.app.v1.AppService.CheckPermissions:input_type -> viam.app.v1.CheckPermissionsRequest
	118, // 133: viam.app.v1.AppService.CreateModule:input_type -> viam.app.v1.CreateModuleRequest
	120, // 134: viam.app.v1.AppService.UpdateModule:input_type -> viam.app.v1.UpdateModuleRequest
	124, // 135: viam.app.v1.AppService.UploadModuleFile:input_type -> viam.app.v1.UploadModuleFileRequest
	126, // 136: viam.app.v1.AppService.GetModule:input_type -> viam.app.v1.GetModuleRequest
	131, // 137: viam.app.v1.AppService.ListModules:input_type -> viam.app.v1.ListModulesRequest
	138, // 138: viam.app.v1.AppService.CreateKey:input_type -> viam.app.v1.CreateKeyRequest
	134, // 139: viam.app.v1.AppService.GetUserIDByEmail:output_type -> viam.app.v1.GetUserIDByEmailResponse
	11,  // 140: viam.app.v1.AppService.CreateOrganization:output_type -> viam.app.v1.CreateOrganizationResponse
	8,   // 141: viam.app.v1.AppService.ListOrganizations:output_type -> viam.app.v1.ListOrganizationsResponse
	137, // 142: viam.app.v1.AppService.ListOrganizationsByUser:output_type -> viam.app.v1.ListOrganizationsByUserResponse
	13,  // 143: viam.app.v1.AppService.GetOrganization:output_type -> viam.app.v1.GetOrganizationResponse
	15,  // 144: viam.app.v1.AppService.GetOrganizationNamespaceAvailability:output_type -> viam.app.v1.GetOrganizationNamespaceAvailabilityResponse
	17,  // 145: viam.app.v1.AppService.UpdateOrganization:output_type -> viam.app.v1.UpdateOrganizationResponse
	19,  // 146: viam.app.v1.AppService.DeleteOrganization:output_type -> viam.app.v1.DeleteOrganizationResponse
	21,  // 147: viam.app.v1.AppService.ListOrganizationMembers:output_type -> viam.app.v1.ListOrganizationMembersResponse
	23,  // 148: viam.app.v1.AppService.CreateOrganizationInvite:output_type -> viam.app.v1.CreateOrganizationInviteResponse
	25,  // 149: viam.app.v1.AppService.UpdateOrganizationInviteAuthorizations:output_type -> viam.app.v1.UpdateOrganizationInviteAuthorizationsResponse
	31,  // 150: viam.app.v1.AppService.DeleteOrganizationMember:output_type -> viam.app.v1.DeleteOrganizationMemberResponse
	27,  // 151: viam.app.v1.AppService.DeleteOrganizationInvite:output_type -> viam.app.v1.DeleteOrganizationInviteResponse
	29,  // 152: viam.app.v1.AppService.ResendOrganizationInvite:output_type -> viam.app.v1.ResendOrganizationInviteResponse
	38,  // 153: viam.app.v1.AppService.CreateLocation:output_type -> viam.app.v1.CreateLocationResponse
	40,  // 154: viam.app.v1.AppService.GetLocation:output_type -> viam.app.v1.GetLocationResponse
	42,  // 155: viam.app.v1.AppService.UpdateLocation:output_type -> viam.app.v1.UpdateLocationResponse
	44,  // 156: viam.app.v1.AppService.DeleteLocation:output_type -> viam.app.v1.DeleteLocationResponse
	50,  // 157: viam.app.v1.AppService.ListLocations:output_type -> viam.app.v1.ListLocationsResponse
	47,  // 158: viam.app.v1.AppService.ShareLocation:output_type -> viam.app.v1.ShareLocationResponse
	49,  // 159: viam.app.v1.AppService.UnshareLocation:output_type -> viam.app.v1.UnshareLocationResponse
	56,  // 160: viam.app.v1.AppService.LocationAuth:output_type -> viam.app.v1.LocationAuthResponse
	52,  // 161: viam.app.v1.AppService.CreateLocationSecret:output_type -> viam.app.v1.CreateLocationSecretResponse
	54,  // 162: viam.app.v1.AppService.DeleteLocationSecret:output_type -> viam.app.v1.DeleteLocationSecretResponse
	61,  // 163: viam.app.v1.AppService.GetRobot:output_type -> viam.app.v1.GetRobotResponse
	60,  // 164: viam.app.v1.AppService.GetRoverRentalRobots:output_type -> viam.app.v1.GetRoverRentalRobotsResponse
	63,  // 165: viam.app.v1.AppService.GetRobotParts:output_type -> viam.app.v1.GetRobotPartsResponse
	65,  // 166: viam.app.v1.AppService.GetRobotPart:output_type -> viam.app.v1.GetRobotPartResponse
	68,  // 167: viam.app.v1.AppService.GetRobotPartLogs:output_type -> viam.app.v1.GetRobotPartLogsResponse
	70,  // 168: viam.app.v1.AppService.TailRobotPartLogs:output_type -> viam.app.v1.TailRobotPartLogsResponse
	72,  // 169: viam.app.v1.AppService.GetRobotPartHistory:output_type -> viam.app.v1.GetRobotPartHistoryResponse
	74,  // 170: viam.app.v1.AppService.UpdateRobotPart:output_type -> viam.app.v1.UpdateRobotPartResponse
	76,  // 171: viam.app.v1.AppService.NewRobotPart:output_type -> viam.app.v1.NewRobotPartResponse
	78,  // 172: viam.app.v1.AppService.DeleteRobotPart:output_type -> viam.app.v1.DeleteRobotPartResponse
	99,  // 173: viam.app.v1.AppService.MarkPartAsMain:output_type -> viam.app.v1.MarkPartAsMainResponse
	101, // 174: viam.app.v1.AppService.MarkPartForRestart:output_type -> viam.app.v1.MarkPartForRestartResponse
	103, // 175: viam.app.v1.AppService.CreateRobotPartSecret:output_type -> viam.app.v1.CreateRobotPartSecretResponse
	105, // 176: viam.app.v1.AppService.DeleteRobotPartSecret:output_type -> viam.app.v1.DeleteRobotPartSecretResponse
	91,  // 177: viam.app.v1.AppService.ListRobots:output_type -> viam.app.v1.ListRobotsResponse
	93,  // 178: viam.app.v1.AppService.NewRobot:output_type -> viam.app.v1.NewRobotResponse
	95,  // 179: viam.app.v1.AppService.UpdateRobot:output_type -> viam.app.v1.UpdateRobotResponse
	97,  // 180: viam.app.v1.AppService.DeleteRobot:output_type -> viam.app.v1.DeleteRobotResponse
	81,  // 181: viam.app.v1.AppService.ListFragments:output_type -> viam.app.v1.ListFragmentsResponse
	83,  // 182: viam.app.v1.AppService.GetFragment:output_type -> viam.app.v1.GetFragmentResponse
	85,  // 183: viam.app.v1.AppService.CreateFragment:output_type -> viam.app.v1.CreateFragmentResponse
	87,  // 184: viam.app.v1.AppService.UpdateFragment:output_type -> viam.app.v1.UpdateFragmentResponse
	89,  // 185: viam.app.v1.AppService.DeleteFragment:output_type -> viam.app.v1.DeleteFragmentResponse
	108, // 186: viam.app.v1.AppService.AddRole:output_type -> viam.app.v1.AddRoleResponse
	110, // 187: viam.app.v1.AppService.RemoveRole:output_type -> viam.app.v1.RemoveRoleResponse
	112, // 188: viam.app.v1.AppService.ChangeRole:output_type -> viam.app.v1.ChangeRoleResponse
	114, // 189: viam.app.v1.AppService.ListAuthorizations:output_type -> viam.app.v1.ListAuthorizationsResponse
	117, // 190: viam.app.v1.AppService.CheckPermissions:output_type -> viam.app.v1.CheckPermissionsResponse
	119, // 191: viam.app.v1.AppService.CreateModule:output_type -> viam.app.v1.CreateModuleResponse
	121, // 192: viam.app.v1.AppService.UpdateModule:output_type -> viam.app.v1.UpdateModuleResponse
	125, // 193: viam.app.v1.AppService.UploadModuleFile:output_type -> viam.app.v1.UploadModuleFileResponse
	127, // 194: viam.app.v1.AppService.GetModule:output_type -> viam.app.v1.GetModuleResponse
	132, // 195: viam.app.v1.AppService.ListModules:output_type -> viam.app.v1.ListModulesResponse
	139, // 196: viam.app.v1.AppService.CreateKey:output_type -> viam.app.v1.CreateKeyResponse
