...
var file_app_v1_app_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x22, 0x47, 0x0a, 0x1a, 0x4f, 0x72,
	...
	0x44, 0x45, 0x56, 0x49, 0x43, 0x45, 0x5f, 0x43, 0x4f, 0x44, 0x45, 0x10, 0x05, 0x32, 0x9f, 0x44,
...
var file_app_v1_app_proto_msgTypes = make([]protoimpl.MessageInfo, 213)
var file_app_v1_app_proto_goTypes = []any{
	...
	(*CreateKeyRequest)(nil),                               // 190: viam.app.v1.CreateKeyRequest
	(*CreateKeyResponse)(nil),                              // 191: viam.app.v1.CreateKeyResponse
	(*DeleteKeyRequest)(nil),                               // 192: viam.app.v1.DeleteKeyRequest
	(*DeleteKeyResponse)(nil),                              // 193: viam.app.v1.DeleteKeyResponse
	(*RenameKeyRequest)(nil),                               // 194: viam.app.v1.RenameKeyRequest
	(*RenameKeyResponse)(nil),                              // 195: viam.app.v1.RenameKeyResponse
	(*AuthorizationDetails)(nil),                           // 196: viam.app.v1.AuthorizationDetails
	(*APIKeyWithAuthorizations)(nil),                       // 197: viam.app.v1.APIKeyWithAuthorizations
	(*ListKeysRequest)(nil),                                // 198: viam.app.v1.ListKeysRequest
	(*ListKeysResponse)(nil),                               // 199: viam.app.v1.ListKeysResponse
	(*RotateKeyRequest)(nil),                               // 200: viam.app.v1.RotateKeyRequest
	(*RotateKeyResponse)(nil),                              // 201: viam.app.v1.RotateKeyResponse
	(*CreateKeyFromExistingKeyAuthorizationsRequest)(nil),  // 202: viam.app.v1.CreateKeyFromExistingKeyAuthorizationsRequest
	(*CreateKeyFromExistingKeyAuthorizationsResponse)(nil), // 203: viam.app.v1.CreateKeyFromExistingKeyAuthorizationsResponse
	(*OrganizationSetLogoRequest)(nil),                     // 204: viam.app.v1.OrganizationSetLogoRequest
	(*OrganizationSetLogoResponse)(nil),                    // 205: viam.app.v1.OrganizationSetLogoResponse
	(*OrganizationGetLogoRequest)(nil),                     // 206: viam.app.v1.OrganizationGetLogoRequest
	(*OrganizationGetLogoResponse)(nil),                    // 207: viam.app.v1.OrganizationGetLogoResponse
	(*EnableAuthServiceRequest)(nil),                       // 208: viam.app.v1.EnableAuthServiceRequest
	(*EnableAuthServiceResponse)(nil),                      // 209: viam.app.v1.EnableAuthServiceResponse
	(*DisableAuthServiceRequest)(nil),                      // 210: viam.app.v1.DisableAuthServiceRequest
	(*DisableAuthServiceResponse)(nil),                     // 211: viam.app.v1.DisableAuthServiceResponse
	(*CreateOAuthAppRequest)(nil),                          // 212: viam.app.v1.CreateOAuthAppRequest
	(*CreateOAuthAppResponse)(nil),                         // 213: viam.app.v1.CreateOAuthAppResponse
	(*ReadOAuthAppRequest)(nil),                            // 214: viam.app.v1.ReadOAuthAppRequest
	(*ReadOAuthAppResponse)(nil),                           // 215: viam.app.v1.ReadOAuthAppResponse
	(*UpdateOAuthAppRequest)(nil),                          // 216: viam.app.v1.UpdateOAuthAppRequest
	(*UpdateOAuthAppResponse)(nil),                         // 217: viam.app.v1.UpdateOAuthAppResponse
	(*DeleteOAuthAppRequest)(nil),                          // 218: viam.app.v1.DeleteOAuthAppRequest
	(*DeleteOAuthAppResponse)(nil),                         // 219: viam.app.v1.DeleteOAuthAppResponse
	(*ListOAuthAppsRequest)(nil),                           // 220: viam.app.v1.ListOAuthAppsRequest
	(*ListOAuthAppsResponse)(nil),                          // 221: viam.app.v1.ListOAuthAppsResponse
	(*OAuthConfig)(nil),                                    // 222: viam.app.v1.OAuthConfig
	(*timestamppb.Timestamp)(nil),                          // 223: google.protobuf.Timestamp
	(*structpb.Struct)(nil),                                // 224: google.protobuf.Struct
	(*v1.LogEntry)(nil),                                    // 225: viam.common.v1.LogEntry
	(v11.ModelType)(0),                                     // 226: viam.app.mltraining.v1.ModelType
	(v11.ModelFramework)(0),                                // 227: viam.app.mltraining.v1.ModelFramework
	(v12.PackageType)(0),                                   // 228: viam.app.packages.v1.PackageType
}
var file_app_v1_app_proto_depIdxs = []int32{
	223, // 0: viam.app.v1.Robot.last_access:type_name -> google.protobuf.Timestamp
	223, // 1: viam.app.v1.Robot.created_on:type_name -> google.protobuf.Timestamp
	224, // 2: viam.app.v1.RobotPart.robot_config:type_name -> google.protobuf.Struct
	223, // 3: viam.app.v1.RobotPart.last_access:type_name -> google.protobuf.Timestamp
	224, // 4: viam.app.v1.RobotPart.user_supplied_info:type_name -> google.protobuf.Struct
	223, // 5: viam.app.v1.RobotPart.created_on:type_name -> google.protobuf.Timestamp
	59,  // 6: viam.app.v1.RobotPart.secrets:type_name -> viam.app.v1.SharedSecret
	223, // 7: viam.app.v1.RobotPart.last_updated:type_name -> google.protobuf.Timestamp
	223, // 8: viam.app.v1.RobotPartHistoryEntry.when:type_name -> google.protobuf.Timestamp
	...
	223, // 12: viam.app.v1.Organization.created_on:type_name -> google.protobuf.Timestamp
	223, // 13: viam.app.v1.OrganizationMember.date_added:type_name -> google.protobuf.Timestamp
	223, // 14: viam.app.v1.OrganizationMember.last_login:type_name -> google.protobuf.Timestamp
	15,  // 15: viam.app.v1.ListOrganizationsResponse.organizations:type_name -> viam.app.v1.Organization
	223, // 16: viam.app.v1.OrganizationInvite.created_on:type_name -> google.protobuf.Timestamp
	...
	223, // 35: viam.app.v1.Location.created_on:type_name -> google.protobuf.Timestamp
	57,  // 36: viam.app.v1.Location.config:type_name -> viam.app.v1.StorageConfig
	223, // 37: viam.app.v1.SharedSecret.created_on:type_name -> google.protobuf.Timestamp
	...
	223, // 50: viam.app.v1.GetRobotPartLogsRequest.start:type_name -> google.protobuf.Timestamp
	223, // 51: viam.app.v1.GetRobotPartLogsRequest.end:type_name -> google.protobuf.Timestamp
	225, // 52: viam.app.v1.GetRobotPartLogsResponse.logs:type_name -> viam.common.v1.LogEntry
	225, // 53: viam.app.v1.TailRobotPartLogsResponse.logs:type_name -> viam.common.v1.LogEntry
	12,  // 54: viam.app.v1.GetRobotPartHistoryResponse.history:type_name -> viam.app.v1.RobotPartHistoryEntry
	224, // 55: viam.app.v1.UpdateRobotPartRequest.robot_config:type_name -> google.protobuf.Struct
	11,  // 56: viam.app.v1.UpdateRobotPartResponse.part:type_name -> viam.app.v1.RobotPart
	223, // 57: viam.app.v1.APIKey.created_on:type_name -> google.protobuf.Timestamp
	197, // 58: viam.app.v1.GetRobotAPIKeysResponse.api_keys:type_name -> viam.app.v1.APIKeyWithAuthorizations
	224, // 59: viam.app.v1.Fragment.fragment:type_name -> google.protobuf.Struct
	223, // 60: viam.app.v1.Fragment.created_on:type_name -> google.protobuf.Timestamp
	1,   // 61: viam.app.v1.Fragment.visibility:type_name -> viam.app.v1.FragmentVisibility
	223, // 62: viam.app.v1.Fragment.last_updated:type_name -> google.protobuf.Timestamp
	223, // 63: viam.app.v1.FragmentHistoryEntry.edited_on:type_name -> google.protobuf.Timestamp
	...
	224, // 67: viam.app.v1.ResolvedFragment.resolved_config:type_name -> google.protobuf.Struct
	...
	224, // 72: viam.app.v1.CreateFragmentRequest.config:type_name -> google.protobuf.Struct
	...
	224, // 75: viam.app.v1.UpdateFragmentRequest.config:type_name -> google.protobuf.Struct
	...
	226, // 95: viam.app.v1.MLModelMetadata.model_type:type_name -> viam.app.mltraining.v1.ModelType
	227, // 96: viam.app.v1.MLModelMetadata.model_framework:type_name -> viam.app.mltraining.v1.ModelFramework
	223, // 97: viam.app.v1.MLTrainingVersion.created_on:type_name -> google.protobuf.Timestamp
	155, // 98: viam.app.v1.MLTrainingMetadata.versions:type_name -> viam.app.v1.MLTrainingVersion
	226, // 99: viam.app.v1.MLTrainingMetadata.model_type:type_name -> viam.app.mltraining.v1.ModelType
	227, // 100: viam.app.v1.MLTrainingMetadata.model_framework:type_name -> viam.app.mltraining.v1.ModelFramework
	228, // 101: viam.app.v1.RegistryItem.type:type_name -> viam.app.packages.v1.PackageType
	...
	223, // 106: viam.app.v1.RegistryItem.created_at:type_name -> google.protobuf.Timestamp
	223, // 107: viam.app.v1.RegistryItem.updated_at:type_name -> google.protobuf.Timestamp
	157, // 108: viam.app.v1.GetRegistryItemResponse.item:type_name -> viam.app.v1.RegistryItem
	228, // 109: viam.app.v1.CreateRegistryItemRequest.type:type_name -> viam.app.packages.v1.PackageType
	228, // 110: viam.app.v1.UpdateRegistryItemRequest.type:type_name -> viam.app.packages.v1.PackageType
	4,   // 111: viam.app.v1.UpdateRegistryItemRequest.visibility:type_name -> viam.app.v1.Visibility
	228, // 112: viam.app.v1.ListRegistryItemsRequest.types:type_name -> viam.app.packages.v1.PackageType
	...
	223, // 125: viam.app.v1.Uploads.uploaded_at:type_name -> google.protobuf.Timestamp
	...
	140, // 128: viam.app.v1.CreateKeyRequest.authorizations:type_name -> viam.app.v1.Authorization
	103, // 129: viam.app.v1.APIKeyWithAuthorizations.api_key:type_name -> viam.app.v1.APIKey
	196, // 130: viam.app.v1.APIKeyWithAuthorizations.authorizations:type_name -> viam.app.v1.AuthorizationDetails
	197, // 131: viam.app.v1.ListKeysResponse.api_keys:type_name -> viam.app.v1.APIKeyWithAuthorizations
	222, // 132: viam.app.v1.CreateOAuthAppRequest.oauth_config:type_name -> viam.app.v1.OAuthConfig
	222, // 133: viam.app.v1.ReadOAuthAppResponse.oauth_config:type_name -> viam.app.v1.OAuthConfig
	222, // 134: viam.app.v1.UpdateOAuthAppRequest.oauth_config:type_name -> viam.app.v1.OAuthConfig
	5,   // 135: viam.app.v1.OAuthConfig.client_authentication:type_name -> viam.app.v1.ClientAuthentication
	6,   // 136: viam.app.v1.OAuthConfig.pkce:type_name -> viam.app.v1.PKCE
	7,   // 137: viam.app.v1.OAuthConfig.url_validation:type_name -> viam.app.v1.URLValidation
	8,   // 138: viam.app.v1.OAuthConfig.enabled_grants:type_name -> viam.app.v1.EnabledGrant
	185, // 139: viam.app.v1.AppService.GetUserIDByEmail:input_type -> viam.app.v1.GetUserIDByEmailRequest
	19,  // 140: viam.app.v1.AppService.CreateOrganization:input_type -> viam.app.v1.CreateOrganizationRequest
	14,  // 141: viam.app.v1.AppService.ListOrganizations:input_type -> viam.app.v1.ListOrganizationsRequest
	...
	21,  // 144: viam.app.v1.AppService.GetOrganization:input_type -> viam.app.v1.GetOrganizationRequest
	23,  // 145: viam.app.v1.AppService.GetOrganizationNamespaceAvailability:input_type -> viam.app.v1.GetOrganizationNamespaceAvailabilityRequest
	25,  // 146: viam.app.v1.AppService.UpdateOrganization:input_type -> viam.app.v1.UpdateOrganizationRequest
	27,  // 147: viam.app.v1.AppService.DeleteOrganization:input_type -> viam.app.v1.DeleteOrganizationRequest
	29,  // 148: viam.app.v1.AppService.ListOrganizationMembers:input_type -> viam.app.v1.ListOrganizationMembersRequest
	31,  // 149: viam.app.v1.AppService.CreateOrganizationInvite:input_type -> viam.app.v1.CreateOrganizationInviteRequest
	33,  // 150: viam.app.v1.AppService.UpdateOrganizationInviteAuthorizations:input_type -> viam.app.v1.UpdateOrganizationInviteAuthorizationsRequest
	39,  // 151: viam.app.v1.AppService.DeleteOrganizationMember:input_type -> viam.app.v1.DeleteOrganizationMemberRequest
	35,  // 152: viam.app.v1.AppService.DeleteOrganizationInvite:input_type -> viam.app.v1.DeleteOrganizationInviteRequest
	37,  // 153: viam.app.v1.AppService.ResendOrganizationInvite:input_type -> viam.app.v1.ResendOrganizationInviteRequest
	42,  // 154: viam.app.v1.AppService.EnableBillingService:input_type -> viam.app.v1.EnableBillingServiceRequest
	48,  // 155: viam.app.v1.AppService.DisableBillingService:input_type -> viam.app.v1.DisableBillingServiceRequest
	44,  // 156: viam.app.v1.AppService.UpdateBillingService:input_type -> viam.app.v1.UpdateBillingServiceRequest
	46,  // 157: viam.app.v1.AppService.GetBillingServiceConfig:input_type -> viam.app.v1.GetBillingServiceConfigRequest
	50,  // 158: viam.app.v1.AppService.OrganizationSetSupportEmail:input_type -> viam.app.v1.OrganizationSetSupportEmailRequest
	52,  // 159: viam.app.v1.AppService.OrganizationGetSupportEmail:input_type -> viam.app.v1.OrganizationGetSupportEmailRequest
	204, // 160: viam.app.v1.AppService.OrganizationSetLogo:input_type -> viam.app.v1.OrganizationSetLogoRequest
	206, // 161: viam.app.v1.AppService.OrganizationGetLogo:input_type -> viam.app.v1.OrganizationGetLogoRequest
	208, // 162: viam.app.v1.AppService.EnableAuthService:input_type -> viam.app.v1.EnableAuthServiceRequest
	210, // 163: viam.app.v1.AppService.DisableAuthService:input_type -> viam.app.v1.DisableAuthServiceRequest
	212, // 164: viam.app.v1.AppService.CreateOAuthApp:input_type -> viam.app.v1.CreateOAuthAppRequest
	214, // 165: viam.app.v1.AppService.ReadOAuthApp:input_type -> viam.app.v1.ReadOAuthAppRequest
	216, // 166: viam.app.v1.AppService.UpdateOAuthApp:input_type -> viam.app.v1.UpdateOAuthAppRequest
	218, // 167: viam.app.v1.AppService.DeleteOAuthApp:input_type -> viam.app.v1.DeleteOAuthAppRequest
	220, // 168: viam.app.v1.AppService.ListOAuthApps:input_type -> viam.app.v1.ListOAuthAppsRequest
	60,  // 169: viam.app.v1.AppService.CreateLocation:input_type -> viam.app.v1.CreateLocationRequest
	62,  // 170: viam.app.v1.AppService.GetLocation:input_type -> viam.app.v1.GetLocationRequest
	64,  // 171: viam.app.v1.AppService.UpdateLocation:input_type -> viam.app.v1.UpdateLocationRequest
	66,  // 172: viam.app.v1.AppService.DeleteLocation:input_type -> viam.app.v1.DeleteLocationRequest
	70,  // 173: viam.app.v1.AppService.ListLocations:input_type -> viam.app.v1.ListLocationsRequest
	71,  // 174: viam.app.v1.AppService.ShareLocation:input_type -> viam.app.v1.ShareLocationRequest
	73,  // 175: viam.app.v1.AppService.UnshareLocation:input_type -> viam.app.v1.UnshareLocationRequest
	80,  // 176: viam.app.v1.AppService.LocationAuth:input_type -> viam.app.v1.LocationAuthRequest
	76,  // 177: viam.app.v1.AppService.CreateLocationSecret:input_type -> viam.app.v1.CreateLocationSecretRequest
	78,  // 178: viam.app.v1.AppService.DeleteLocationSecret:input_type -> viam.app.v1.DeleteLocationSecretRequest
	82,  // 179: viam.app.v1.AppService.GetRobot:input_type -> viam.app.v1.GetRobotRequest
	83,  // 180: viam.app.v1.AppService.GetRoverRentalRobots:input_type -> viam.app.v1.GetRoverRentalRobotsRequest
	87,  // 181: viam.app.v1.AppService.GetRobotParts:input_type -> viam.app.v1.GetRobotPartsRequest
	89,  // 182: viam.app.v1.AppService.GetRobotPart:input_type -> viam.app.v1.GetRobotPartRequest
	91,  // 183: viam.app.v1.AppService.GetRobotPartLogs:input_type -> viam.app.v1.GetRobotPartLogsRequest
	93,  // 184: viam.app.v1.AppService.TailRobotPartLogs:input_type -> viam.app.v1.TailRobotPartLogsRequest
	95,  // 185: viam.app.v1.AppService.GetRobotPartHistory:input_type -> viam.app.v1.GetRobotPartHistoryRequest
	97,  // 186: viam.app.v1.AppService.UpdateRobotPart:input_type -> viam.app.v1.UpdateRobotPartRequest
	99,  // 187: viam.app.v1.AppService.NewRobotPart:input_type -> viam.app.v1.NewRobotPartRequest
	101, // 188: viam.app.v1.AppService.DeleteRobotPart:input_type -> viam.app.v1.DeleteRobotPartRequest
	102, // 189: viam.app.v1.AppService.GetRobotAPIKeys:input_type -> viam.app.v1.GetRobotAPIKeysRequest
	132, // 190: viam.app.v1.AppService.MarkPartAsMain:input_type -> viam.app.v1.MarkPartAsMainRequest
	134, // 191: viam.app.v1.AppService.MarkPartForRestart:input_type -> viam.app.v1.MarkPartForRestartRequest
	136, // 192: viam.app.v1.AppService.CreateRobotPartSecret:input_type -> viam.app.v1.CreateRobotPartSecretRequest
	138, // 193: viam.app.v1.AppService.DeleteRobotPartSecret:input_type -> viam.app.v1.DeleteRobotPartSecretRequest
	122, // 194: viam.app.v1.AppService.ListRobots:input_type -> viam.app.v1.ListRobotsRequest
	126, // 195: viam.app.v1.AppService.NewRobot:input_type -> viam.app.v1.NewRobotRequest
	128, // 196: viam.app.v1.AppService.UpdateRobot:input_type -> viam.app.v1.UpdateRobotRequest
	130, // 197: viam.app.v1.AppService.DeleteRobot:input_type -> viam.app.v1.DeleteRobotRequest
	110, // 198: viam.app.v1.AppService.ListFragments:input_type -> viam.app.v1.ListFragmentsRequest
	112, // 199: viam.app.v1.AppService.GetFragment:input_type -> viam.app.v1.GetFragmentRequest
	114, // 200: viam.app.v1.AppService.CreateFragment:input_type -> viam.app.v1.CreateFragmentRequest
	116, // 201: viam.app.v1.AppService.UpdateFragment:input_type -> viam.app.v1.UpdateFragmentRequest
	118, // 202: viam.app.v1.AppService.DeleteFragment:input_type -> viam.app.v1.DeleteFragmentRequest
	123, // 203: viam.app.v1.AppService.ListMachineFragments:input_type -> viam.app.v1.ListMachineFragmentsRequest
	120, // 204: viam.app.v1.AppService.GetFragmentHistory:input_type -> viam.app.v1.GetFragmentHistoryRequest
	141, // 205: viam.app.v1.AppService.AddRole:input_type -> viam.app.v1.AddRoleRequest
	143, // 206: viam.app.v1.AppService.RemoveRole:input_type -> viam.app.v1.RemoveRoleRequest
	145, // 207: viam.app.v1.AppService.ChangeRole:input_type -> viam.app.v1.ChangeRoleRequest
	147, // 208: viam.app.v1.AppService.ListAuthorizations:input_type -> viam.app.v1.ListAuthorizationsRequest
	149, // 209: viam.app.v1.AppService.CheckPermissions:input_type -> viam.app.v1.CheckPermissionsRequest
	158, // 210: viam.app.v1.AppService.GetRegistryItem:input_type -> viam.app.v1.GetRegistryItemRequest
	160, // 211: viam.app.v1.AppService.CreateRegistryItem:input_type -> viam.app.v1.CreateRegistryItemRequest
	162, // 212: viam.app.v1.AppService.UpdateRegistryItem:input_type -> viam.app.v1.UpdateRegistryItemRequest
	164, // 213: viam.app.v1.AppService.ListRegistryItems:input_type -> viam.app.v1.ListRegistryItemsRequest
	166, // 214: viam.app.v1.AppService.DeleteRegistryItem:input_type -> viam.app.v1.DeleteRegistryItemRequest
	168, // 215: viam.app.v1.AppService.TransferRegistryItem:input_type -> viam.app.v1.TransferRegistryItemRequest
	170, // 216: viam.app.v1.AppService.CreateModule:input_type -> viam.app.v1.CreateModuleRequest
	172, // 217: viam.app.v1.AppService.UpdateModule:input_type -> viam.app.v1.UpdateModuleRequest
	176, // 218: viam.app.v1.AppService.UploadModuleFile:input_type -> viam.app.v1.UploadModuleFileRequest
	178, // 219: viam.app.v1.AppService.GetModule:input_type -> viam.app.v1.GetModuleRequest
	183, // 220: viam.app.v1.AppService.ListModules:input_type -> viam.app.v1.ListModulesRequest
	190, // 221: viam.app.v1.AppService.CreateKey:input_type -> viam.app.v1.CreateKeyRequest
	192, // 222: viam.app.v1.AppService.DeleteKey:input_type -> viam.app.v1.DeleteKeyRequest
	198, // 223: viam.app.v1.AppService.ListKeys:input_type -> viam.app.v1.ListKeysRequest
	194, // 224: viam.app.v1.AppService.RenameKey:input_type -> viam.app.v1.RenameKeyRequest
	200, // 225: viam.app.v1.AppService.RotateKey:input_type -> viam.app.v1.RotateKeyRequest
	202, // 226: viam.app.v1.AppService.CreateKeyFromExistingKeyAuthorizations:input_type -> viam.app.v1.CreateKeyFromExistingKeyAuthorizationsRequest
	186, // 227: viam.app.v1.AppService.GetUserIDByEmail:output_type -> viam.app.v1.GetUserIDByEmailResponse
	20,  // 228: viam.app.v1.AppService.CreateOrganization:output_type -> viam.app.v1.CreateOrganizationResponse
	17,  // 229: viam.app.v1.AppService.ListOrganizations:output_type -> viam.app.v1.ListOrganizationsResponse
	69,  // 230: viam.app.v1.AppService.GetOrganizationsWithAccessToLocation:output_type -> viam.app.v1.GetOrganizationsWithAccessToLocationResponse
	189, // 231: viam.app.v1.AppService.ListOrganizationsByUser:output_type -> viam.app.v1.ListOrganizationsByUserResponse
	22,  // 232: viam.app.v1.AppService.GetOrganization:output_type -> viam.app.v1.GetOrganizationResponse
	24,  // 233: viam.app.v1.AppService.GetOrganizationNamespaceAvailability:output_type -> viam.app.v1.GetOrganizationNamespaceAvailabilityResponse
	26,  // 234: viam.app.v1.AppService.UpdateOrganization:output_type -> viam.app.v1.UpdateOrganizationResponse
	28,  // 235: viam.app.v1.AppService.DeleteOrganization:output_type -> viam.app.v1.DeleteOrganizationResponse
	30,  // 236: viam.app.v1.AppService.ListOrganizationMembers:output_type -> viam.app.v1.ListOrganizationMembersResponse
	32,  // 237: viam.app.v1.AppService.CreateOrganizationInvite:output_type -> viam.app.v1.CreateOrganizationInviteResponse
	34,  // 238: viam.app.v1.AppService.UpdateOrganizationInviteAuthorizations:output_type -> viam.app.v1.UpdateOrganizationInviteAuthorizationsResponse
	40,  // 239: viam.app.v1.AppService.DeleteOrganizationMember:output_type -> viam.app.v1.DeleteOrganizationMemberResponse
	36,  // 240: viam.app.v1.AppService.DeleteOrganizationInvite:output_type -> viam.app.v1.DeleteOrganizationInviteResponse
	38,  // 241: viam.app.v1.AppService.ResendOrganizationInvite:output_type -> viam.app.v1.ResendOrganizationInviteResponse
	43,  // 242: viam.app.v1.AppService.EnableBillingService:output_type -> viam.app.v1.EnableBillingServiceResponse
	49,  // 243: viam.app.v1.AppService.DisableBillingService:output_type -> viam.app.v1.DisableBillingServiceResponse
	45,  // 244: viam.app.v1.AppService.UpdateBillingService:output_type -> viam.app.v1.UpdateBillingServiceResponse
	47,  // 245: viam.app.v1.AppService.GetBillingServiceConfig:output_type -> viam.app.v1.GetBillingServiceConfigResponse
	51,  // 246: viam.app.v1.AppService.OrganizationSetSupportEmail:output_type -> viam.app.v1.OrganizationSetSupportEmailResponse
	53,  // 247: viam.app.v1.AppService.OrganizationGetSupportEmail:output_type -> viam.app.v1.OrganizationGetSupportEmailResponse
	205, // 248: viam.app.v1.AppService.OrganizationSetLogo:output_type -> viam.app.v1.OrganizationSetLogoResponse
	207, // 249: viam.app.v1.AppService.OrganizationGetLogo:output_type -> viam.app.v1.OrganizationGetLogoResponse
	209, // 250: viam.app.v1.AppService.EnableAuthService:output_type -> viam.app.v1.EnableAuthServiceResponse
	211, // 251: viam.app.v1.AppService.DisableAuthService:output_type -> viam.app.v1.DisableAuthServiceResponse
	213, // 252: viam.app.v1.AppService.CreateOAuthApp:output_type -> viam.app.v1.CreateOAuthAppResponse
	215, // 253: viam.app.v1.AppService.ReadOAuthApp:output_type -> viam.app.v1.ReadOAuthAppResponse
	217, // 254: viam.app.v1.AppService.UpdateOAuthApp:output_type -> viam.app.v1.UpdateOAuthAppResponse
	219, // 255: viam.app.v1.AppService.DeleteOAuthApp:output_type -> viam.app.v1.DeleteOAuthAppResponse
	221, // 256: viam.app.v1.AppService.ListOAuthApps:output_type -> viam.app.v1.ListOAuthAppsResponse
	61,  // 257: viam.app.v1.AppService.CreateLocation:output_type -> viam.app.v1.CreateLocationResponse
	63,  // 258: viam.app.v1.AppService.GetLocation:output_type -> viam.app.v1.GetLocationResponse
	65,  // 259: viam.app.v1.AppService.UpdateLocation:output_type -> viam.app.v1.UpdateLocationResponse
	67,  // 260: viam.app.v1.AppService.DeleteLocation:output_type -> viam.app.v1.DeleteLocationResponse
	75,  // 261: viam.app.v1.AppService.ListLocations:output_type -> viam.app.v1.ListLocationsResponse
	72,  // 262: viam.app.v1.AppService.ShareLocation:output_type -> viam.app.v1.ShareLocationResponse
	74,  // 263: viam.app.v1.AppService.UnshareLocation:output_type -> viam.app.v1.UnshareLocationResponse
	81,  // 264: viam.app.v1.AppService.LocationAuth:output_type -> viam.app.v1.LocationAuthResponse
	77,  // 265: viam.app.v1.AppService.CreateLocationSecret:output_type -> viam.app.v1.CreateLocationSecretResponse
	79,  // 266: viam.app.v1.AppService.DeleteLocationSecret:output_type -> viam.app.v1.DeleteLocationSecretResponse
	86,  // 267: viam.app.v1.AppService.GetRobot:output_type -> viam.app.v1.GetRobotResponse
	85,  // 268: viam.app.v1.AppService.GetRoverRentalRobots:output_type -> viam.app.v1.GetRoverRentalRobotsResponse
	88,  // 269: viam.app.v1.AppService.GetRobotParts:output_type -> viam.app.v1.GetRobotPartsResponse
	90,  // 270: viam.app.v1.AppService.GetRobotPart:output_type -> viam.app.v1.GetRobotPartResponse
	92,  // 271: viam.app.v1.AppService.GetRobotPartLogs:output_type -> viam.app.v1.GetRobotPartLogsResponse
	94,  // 272: viam.app.v1.AppService.TailRobotPartLogs:output_type -> viam.app.v1.TailRobotPartLogsResponse
	96,  // 273: viam.app.v1.AppService.GetRobotPartHistory:output_type -> viam.app.v1.GetRobotPartHistoryResponse
	98,  // 274: viam.app.v1.AppService.UpdateRobotPart:output_type -> viam.app.v1.UpdateRobotPartResponse
	100, // 275: viam.app.v1.AppService.NewRobotPart:output_type -> viam.app.v1.NewRobotPartResponse
	105, // 276: viam.app.v1.AppService.DeleteRobotPart:output_type -> viam.app.v1.DeleteRobotPartResponse
	104, // 277: viam.app.v1.AppService.GetRobotAPIKeys:output_type -> viam.app.v1.GetRobotAPIKeysResponse
	133, // 278: viam.app.v1.AppService.MarkPartAsMain:output_type -> viam.app.v1.MarkPartAsMainResponse
	135, // 279: viam.app.v1.AppService.MarkPartForRestart:output_type -> viam.app.v1.MarkPartForRestartResponse
	137, // 280: viam.app.v1.AppService.CreateRobotPartSecret:output_type -> viam.app.v1.CreateRobotPartSecretResponse
	139, // 281: viam.app.v1.AppService.DeleteRobotPartSecret:output_type -> viam.app.v1.DeleteRobotPartSecretResponse
	125, // 282: viam.app.v1.AppService.ListRobots:output_type -> viam.app.v1.ListRobotsResponse
	127, // 283: viam.app.v1.AppService.NewRobot:output_type -> viam.app.v1.NewRobotResponse
	129, // 284: viam.app.v1.AppService.UpdateRobot:output_type -> viam.app.v1.UpdateRobotResponse
	131, // 285: viam.app.v1.AppService.DeleteRobot:output_type -> viam.app.v1.DeleteRobotResponse
	111, // 286: viam.app.v1.AppService.ListFragments:output_type -> viam.app.v1.ListFragmentsResponse
	113, // 287: viam.app.v1.AppService.GetFragment:output_type -> viam.app.v1.GetFragmentResponse
	115, // 288: viam.app.v1.AppService.CreateFragment:output_type -> viam.app.v1.CreateFragmentResponse
	117, // 289: viam.app.v1.AppService.UpdateFragment:output_type -> viam.app.v1.UpdateFragmentResponse
	119, // 290: viam.app.v1.AppService.DeleteFragment:output_type -> viam.app.v1.DeleteFragmentResponse
	124, // 291: viam.app.v1.AppService.ListMachineFragments:output_type -> viam.app.v1.ListMachineFragmentsResponse
	121, // 292: viam.app.v1.AppService.GetFragmentHistory:output_type -> viam.app.v1.GetFragmentHistoryResponse
	142, // 293: viam.app.v1.AppService.AddRole:output_type -> viam.app.v1.AddRoleResponse
	144, // 294: viam.app.v1.AppService.RemoveRole:output_type -> viam.app.v1.RemoveRoleResponse
	146, // 295: viam.app.v1.AppService.ChangeRole:output_type -> viam.app.v1.ChangeRoleResponse
	148, // 296: viam.app.v1.AppService.ListAuthorizations:output_type -> viam.app.v1.ListAuthorizationsResponse
	151, // 297: viam.app.v1.AppService.CheckPermissions:output_type -> viam.app.v1.CheckPermissionsResponse
	159, // 298: viam.app.v1.AppService.GetRegistryItem:output_type -> viam.app.v1.GetRegistryItemResponse
	161, // 299: viam.app.v1.AppService.CreateRegistryItem:output_type -> viam.app.v1.CreateRegistryItemResponse
	163, // 300: viam.app.v1.AppService.UpdateRegistryItem:output_type -> viam.app.v1.UpdateRegistryItemResponse
	165, // 301: viam.app.v1.AppService.ListRegistryItems:output_type -> viam.app.v1.ListRegistryItemsResponse
	167, // 302: viam.app.v1.AppService.DeleteRegistryItem:output_type -> viam.app.v1.DeleteRegistryItemResponse
	169, // 303: viam.app.v1.AppService.TransferRegistryItem:output_type -> viam.app.v1.TransferRegistryItemResponse
	171, // 304: viam.app.v1.AppService.CreateModule:output_type -> viam.app.v1.CreateModuleResponse
	173, // 305: viam.app.v1.AppService.UpdateModule:output_type -> viam.app.v1.UpdateModuleResponse
	177, // 306: viam.app.v1.AppService.UploadModuleFile:output_type -> viam.app.v1.UploadModuleFileResponse
	179, // 307: viam.app.v1.AppService.GetModule:output_type -> viam.app.v1.GetModuleResponse
	184, // 308: viam.app.v1.AppService.ListModules:output_type -> viam.app.v1.ListModulesResponse
	191, // 309: viam.app.v1.AppService.CreateKey:output_type -> viam.app.v1.CreateKeyResponse
	193, // 310: viam.app.v1.AppService.DeleteKey:output_type -> viam.app.v1.DeleteKeyResponse
	199, // 311: viam.app.v1.AppService.ListKeys:output_type -> viam.app.v1.ListKeysResponse
	195, // 312: viam.app.v1.AppService.RenameKey:output_type -> viam.app.v1.RenameKeyResponse
	201, // 313: viam.app.v1.AppService.RotateKey:output_type -> viam.app.v1.RotateKeyResponse
	203, // 314: viam.app.v1.AppService.CreateKeyFromExistingKeyAuthorizations:output_type -> viam.app.v1.CreateKeyFromExistingKeyAuthorizationsResponse
	227, // [227:315] is the sub-list for method output_type
	139, // [139:227] is the sub-list for method input_type
