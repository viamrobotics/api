...
func request_AgentDeviceService_GetSubsystemVersionStatus_0(ctx context.Context, marshaler runtime.Marshaler, client AgentDeviceServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetSubsystemVersionStatusRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.GetSubsystemVersionStatus(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_AgentDeviceService_GetSubsystemVersionStatus_0(ctx context.Context, marshaler runtime.Marshaler, server AgentDeviceServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetSubsystemVersionStatusRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetSubsystemVersionStatus(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterAgentDeviceServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AgentDeviceServiceServer) error {
	...
	mux.Handle("POST", pattern_AgentDeviceService_GetSubsystemVersionStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/viam.app.agent.v1.AgentDeviceService/GetSubsystemVersionStatus", runtime.WithHTTPPathPattern("/viam.app.agent.v1.AgentDeviceService/GetSubsystemVersionStatus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_AgentDeviceService_GetSubsystemVersionStatus_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_AgentDeviceService_GetSubsystemVersionStatus_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterAgentDeviceServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AgentDeviceServiceClient) error {
	...
	mux.Handle("POST", pattern_AgentDeviceService_GetSubsystemVersionStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/viam.app.agent.v1.AgentDeviceService/GetSubsystemVersionStatus", runtime.WithHTTPPathPattern("/viam.app.agent.v1.AgentDeviceService/GetSubsystemVersionStatus"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_AgentDeviceService_GetSubsystemVersionStatus_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_AgentDeviceService_GetSubsystemVersionStatus_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"viam.app.agent.v1.AgentDeviceService", "GetSubsystemVersionStatus"}, ""))
)

var (
	forward_AgentDeviceService_DeviceAgentConfig_0 = runtime.ForwardResponseMessage

	forward_AgentDeviceService_GetSubsystemVersionStatus_0 = runtime.ForwardResponseMessage
)
