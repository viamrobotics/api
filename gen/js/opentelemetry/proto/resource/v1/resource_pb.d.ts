...
export class Resource extends jspb.Message {
  ...
  clearEntityRefsList(): void;
  getEntityRefsList(): Array<opentelemetry_proto_common_v1_common_pb.EntityRef>;
  setEntityRefsList(value: Array<opentelemetry_proto_common_v1_common_pb.EntityRef>): void;
  addEntityRefs(value?: opentelemetry_proto_common_v1_common_pb.EntityRef, index?: number): opentelemetry_proto_common_v1_common_pb.EntityRef;
...
export namespace Resource {
  export type AsObject = {
    ...
    entityRefsList: Array<opentelemetry_proto_common_v1_common_pb.EntityRef.AsObject>,
  }
}
