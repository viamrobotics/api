...
goog.exportSymbol('proto.viam.common.v1.StaticFrame', null, global);
...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.viam.common.v1.StaticFrame.displayName = 'proto.viam.common.v1.StaticFrame';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.viam.common.v1.StaticFrame.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.common.v1.StaticFrame.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.common.v1.StaticFrame} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
 ...
 */
proto.viam.common.v1.StaticFrame.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.common.v1.StaticFrame;
  return proto.viam.common.v1.StaticFrame.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.common.v1.StaticFrame} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.common.v1.StaticFrame}
 */
proto.viam.common.v1.StaticFrame.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.common.v1.StaticFrame.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.common.v1.StaticFrame.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.common.v1.StaticFrame} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
