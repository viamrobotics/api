...
goog.exportSymbol('proto.viam.app.data.v1.TagsOption', null, global);
/**
...
proto.viam.app.data.v1.Filter.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    tagsOption: jspb.Message.getFieldWithDefault(msg, 14, 0)
  };
...
proto.viam.app.data.v1.Filter.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 13:
      ...
      break;
    case 14:
      var value = /** @type {!proto.viam.app.data.v1.TagsOption} */ (reader.readEnum());
      msg.setTagsOption(value);
      break;
    default:
      reader.skipField();
      break;
...
/**
 * optional TagsOption tags_option = 14;
 * @return {!proto.viam.app.data.v1.TagsOption}
 */
proto.viam.app.data.v1.Filter.prototype.getTagsOption = function() {
  return /** @type {!proto.viam.app.data.v1.TagsOption} */ (jspb.Message.getFieldWithDefault(this, 14, 0));
};


/**
 * @param {!proto.viam.app.data.v1.TagsOption} value
 * @return {!proto.viam.app.data.v1.Filter} returns this
 */
proto.viam.app.data.v1.Filter.prototype.setTagsOption = function(value) {
 ...
 * @enum {number}
 */
proto.viam.app.data.v1.TagsOption = {
