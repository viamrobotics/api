...
type AppServiceClient interface {
	...
	GetBillingService(ctx context.Context, in *GetBillingServiceRequest, opts ...grpc.CallOption) (*GetBillingServiceResponse, error)
...
func (c *appServiceClient) GetBillingService(ctx context.Context, in *GetBillingServiceRequest, opts ...grpc.CallOption) (*GetBillingServiceResponse, error) {
	out := new(GetBillingServiceResponse)
	err := c.cc.Invoke(ctx, "/viam.app.v1.AppService/GetBillingService", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AppServiceServer interface {
	...
	GetBillingService(context.Context, *GetBillingServiceRequest) (*GetBillingServiceResponse, error)
...
func (UnimplementedAppServiceServer) GetBillingService(context.Context, *GetBillingServiceRequest) (*GetBillingServiceResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBillingService not implemented")
}
...
func _AppService_GetBillingService_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBillingServiceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppServiceServer).GetBillingService(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/viam.app.v1.AppService/GetBillingService",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServiceServer).GetBillingService(ctx, req.(*GetBillingServiceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AppService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AppService_GetBillingService_Handler,
		},
		{
