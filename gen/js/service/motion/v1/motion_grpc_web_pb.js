 ...
 */
const methodDescriptor_MotionService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.service.motion.v1.MotionServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.service.motion.v1.MotionService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_MotionService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.service.motion.v1.MotionServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.service.motion.v1.MotionService/GetStatus',
      request,
