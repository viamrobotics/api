...
goog.exportSymbol('proto.viam.app.v1.Geometry', null, global);
 ...
 * @constructor
 */
proto.viam.app.v1.Geometry = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.viam.app.v1.Geometry, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.viam.app.v1.Geometry.displayName = 'proto.viam.app.v1.Geometry';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
...
proto.viam.app.v1.Frame.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    geometry: (f = msg.getGeometry()) && proto.viam.app.v1.Geometry.toObject(includeInstance, f)
  };
...
proto.viam.app.v1.Frame.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 4:
      var value = new proto.viam.app.v1.Geometry;
      reader.readMessage(value,proto.viam.app.v1.Geometry.deserializeBinaryFromReader);
...
proto.viam.app.v1.Frame.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      4,
      f,
      proto.viam.app.v1.Geometry.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {?proto.viam.app.v1.Geometry}
 */
proto.viam.app.v1.Frame.prototype.getGeometry = function() {
  return /** @type{?proto.viam.app.v1.Geometry} */ (
    jspb.Message.getWrapperField(this, proto.viam.app.v1.Geometry, 4));
};


/**
 * @param {?proto.viam.app.v1.Geometry|undefined} value
 * @return {!proto.viam.app.v1.Frame} returns this
*/
 ...
 * @return {!Object}
 */
proto.viam.app.v1.Geometry.prototype.toObject = function(opt_includeInstance) {
  return proto.viam.app.v1.Geometry.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.viam.app.v1.Geometry} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.v1.Geometry.toObject = function(includeInstance, msg) {
  var f, obj = {
    type: jspb.Message.getFieldWithDefault(msg, 1, ""),
    x: jspb.Message.getFloatingPointFieldWithDefault(msg, 2, 0.0),
    y: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0.0),
 ...
 * @return {!proto.viam.app.v1.Geometry}
 */
proto.viam.app.v1.Geometry.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.viam.app.v1.Geometry;
  return proto.viam.app.v1.Geometry.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.viam.app.v1.Geometry} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.viam.app.v1.Geometry}
 */
proto.viam.app.v1.Geometry.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.viam.app.v1.Geometry.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.viam.app.v1.Geometry.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.viam.app.v1.Geometry} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.viam.app.v1.Geometry.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getType();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.viam.app.v1.Geometry.prototype.getType = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
...
/**
 * @param {string} value
 * @return {!proto.viam.app.v1.Geometry} returns this
 */
proto.viam.app.v1.Geometry.prototype.setType = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
 ...
 * @return {number}
 */
proto.viam.app.v1.Geometry.prototype.getX = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 2, 0.0));
};
 ...
 * @return {!proto.viam.app.v1.Geometry} returns this
 */
proto.viam.app.v1.Geometry.prototype.setX = function(value) {
  return jspb.Message.setProto3FloatField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.viam.app.v1.Geometry.prototype.getY = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 3, 0.0));
};
 ...
 * @return {!proto.viam.app.v1.Geometry} returns this
 */
proto.viam.app.v1.Geometry.prototype.setY = function(value) {
  return jspb.Message.setProto3FloatField(this, 3, value);
};
 ...
 * @return {number}
 */
proto.viam.app.v1.Geometry.prototype.getZ = function() {
  return /** @type {number} */ (jspb.Message.getFloatingPointFieldWithDefault(this, 4, 0.0));
};
 ...
 * @return {!proto.viam.app.v1.Geometry} returns this
 */
proto.viam.app.v1.Geometry.prototype.setZ = function(value) {
  return jspb.Message.setProto3FloatField(this, 4, value);
};
 ...
 * @return {number}
 */
proto.viam.app.v1.Geometry.prototype.getR = function() {
 ...
 * @return {!proto.viam.app.v1.Geometry} returns this
 */
proto.viam.app.v1.Geometry.prototype.setR = function(value) {
  return jspb.Message.setProto3FloatField(this, 5, value);
};


/**
 * optional Translation translation = 6;
 * @return {?proto.viam.app.v1.Translation}
 */
proto.viam.app.v1.Geometry.prototype.getTranslation = function() {
  return /** @type{?proto.viam.app.v1.Translation} */ (
    jspb.Message.getWrapperField(this, proto.viam.app.v1.Translation, 6));
};
 ...
 * @return {!proto.viam.app.v1.Geometry} returns this
*/
proto.viam.app.v1.Geometry.prototype.setTranslation = function(value) {
  return jspb.Message.setWrapperField(this, 6, value);
};
 ...
 * @return {!proto.viam.app.v1.Geometry} returns this
 */
proto.viam.app.v1.Geometry.prototype.clearTranslation = function() {
  return this.setTranslation(undefined);
};
 ...
 * @return {boolean}
 */
proto.viam.app.v1.Geometry.prototype.hasTranslation = function() {
  return jspb.Message.getField(this, 6) != null;
};


/**
 * optional Orientation orientation = 7;
 * @return {?proto.viam.app.v1.Orientation}
 */
proto.viam.app.v1.Geometry.prototype.getOrientation = function() {
  return /** @type{?proto.viam.app.v1.Orientation} */ (
    jspb.Message.getWrapperField(this, proto.viam.app.v1.Orientation, 7));
};
 ...
 * @return {!proto.viam.app.v1.Geometry} returns this
*/
proto.viam.app.v1.Geometry.prototype.setOrientation = function(value) {
  return jspb.Message.setWrapperField(this, 7, value);
};
 ...
 * @return {!proto.viam.app.v1.Geometry} returns this
 */
proto.viam.app.v1.Geometry.prototype.clearOrientation = function() {
  return this.setOrientation(undefined);
};
 ...
 * @return {boolean}
 */
proto.viam.app.v1.Geometry.prototype.hasOrientation = function() {
  return jspb.Message.getField(this, 7) != null;
};
 ...
 * @return {string}
 */
proto.viam.app.v1.Geometry.prototype.getLabel = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 8, ""));
};
 ...
 * @return {!proto.viam.app.v1.Geometry} returns this
 */
proto.viam.app.v1.Geometry.prototype.setLabel = function(value) {
  return jspb.Message.setProto3StringField(this, 8, value);
};
