...
func request_MLTrainingService_BinaryMetadataToJSONLines_0(ctx context.Context, marshaler runtime.Marshaler, client MLTrainingServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_MLTrainingService_BinaryMetadataToJSONLines_0(ctx context.Context, marshaler runtime.Marshaler, server MLTrainingServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq BinaryMetadataToJSONLinesRequest
	var metadata runtime.ServerMetadata
...
func RegisterMLTrainingServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MLTrainingServiceServer) error {
	...
	mux.Handle("POST", pattern_MLTrainingService_BinaryMetadataToJSONLines_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/viam.app.mltraining.v1.MLTrainingService/BinaryMetadataToJSONLines", runtime.WithHTTPPathPattern("/viam.app.mltraining.v1.MLTrainingService/BinaryMetadataToJSONLines"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_MLTrainingService_BinaryMetadataToJSONLines_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_MLTrainingService_BinaryMetadataToJSONLines_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterMLTrainingServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MLTrainingServiceClient) error {
	...
	mux.Handle("POST", pattern_MLTrainingService_BinaryMetadataToJSONLines_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/viam.app.mltraining.v1.MLTrainingService/BinaryMetadataToJSONLines", runtime.WithHTTPPathPattern("/viam.app.mltraining.v1.MLTrainingService/BinaryMetadataToJSONLines"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_MLTrainingService_BinaryMetadataToJSONLines_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_MLTrainingService_BinaryMetadataToJSONLines_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"viam.app.mltraining.v1.MLTrainingService", "BinaryMetadataToJSONLines"}, ""))
)
...
var (
	...
	forward_MLTrainingService_BinaryMetadataToJSONLines_0 = runtime.ForwardResponseMessage
)
