 ...
 *     The XHR Node Readable Stream
 */
proto.viam.component.generic.v1.GenericServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.component.generic.v1.GenericService/GetStatus',
      request,
 ...
 *     Promise that resolves to the response
 */
proto.viam.component.generic.v1.GenericServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.component.generic.v1.GenericService/GetStatus',
      request,
