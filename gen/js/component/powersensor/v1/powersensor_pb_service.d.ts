...
import * as component_powersensor_v1_powersensor_pb from "../../../component/powersensor/v1/powersensor_pb";
...
type PowerSensorServiceGetVoltage = {
  ...
  readonly requestType: typeof component_powersensor_v1_powersensor_pb.GetVoltageRequest;
  readonly responseType: typeof component_powersensor_v1_powersensor_pb.GetVoltageResponse;
};
...
type PowerSensorServiceGetCurrent = {
  ...
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof component_powersensor_v1_powersensor_pb.GetCurrentRequest;
  readonly responseType: typeof component_powersensor_v1_powersensor_pb.GetCurrentResponse;
};
...
type PowerSensorServiceGetPower = {
  ...
  readonly requestStream: false;
  readonly responseStream: false;
  readonly requestType: typeof component_powersensor_v1_powersensor_pb.GetPowerRequest;
...
type PowerSensorServiceGetStatus = {
  readonly methodName: string;
  readonly service: typeof PowerSensorService;
  readonly requestStream: false;
  readonly responseStream: false;
...
export class PowerSensorService {
  ...
  static readonly GetStatus: PowerSensorServiceGetStatus;
}
...
export class PowerSensorServiceClient {
  ...
  getVoltage(
    requestMessage: component_powersensor_v1_powersensor_pb.GetVoltageRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: component_powersensor_v1_powersensor_pb.GetVoltageResponse|null) => void
  ): UnaryResponse;
  getVoltage(
    requestMessage: component_powersensor_v1_powersensor_pb.GetVoltageRequest,
    callback: (error: ServiceError|null, responseMessage: component_powersensor_v1_powersensor_pb.GetVoltageResponse|null) => void
  ...
  getCurrent(
    requestMessage: component_powersensor_v1_powersensor_pb.GetCurrentRequest,
    metadata: grpc.Metadata,
    callback: (error: ServiceError|null, responseMessage: component_powersensor_v1_powersensor_pb.GetCurrentResponse|null) => void
  ): UnaryResponse;
  getCurrent(
    requestMessage: component_powersensor_v1_powersensor_pb.GetCurrentRequest,
    callback: (error: ServiceError|null, responseMessage: component_powersensor_v1_powersensor_pb.GetCurrentResponse|null) => void
