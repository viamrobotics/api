...
export class ResourceSpans extends jspb.Message {
  ...
  clearScopeSpansList(): void;
  getScopeSpansList(): Array<ScopeSpans>;
  setScopeSpansList(value: Array<ScopeSpans>): void;
  addScopeSpans(value?: ScopeSpans, index?: number): ScopeSpans;
...
export namespace ResourceSpans {
  export type AsObject = {
    ...
    scopeSpansList: Array<ScopeSpans.AsObject>,
    schemaUrl: string,
  }
}

export class ScopeSpans extends jspb.Message {
  hasScope(): boolean;
  clearScope(): void;
  getScope(): opentelemetry_proto_common_v1_common_pb.InstrumentationScope | undefined;
  setScope(value?: opentelemetry_proto_common_v1_common_pb.InstrumentationScope): void;
  ...
  serializeBinary(): Uint8Array;
  toObject(includeInstance?: boolean): ScopeSpans.AsObject;
  static toObject(includeInstance: boolean, msg: ScopeSpans): ScopeSpans.AsObject;
  static extensions: {[key: number]: jspb.ExtensionFieldInfo<jspb.Message>};
  static extensionsBinary: {[key: number]: jspb.ExtensionFieldBinaryInfo<jspb.Message>};
  static serializeBinaryToWriter(message: ScopeSpans, writer: jspb.BinaryWriter): void;
  static deserializeBinary(bytes: Uint8Array): ScopeSpans;
  static deserializeBinaryFromReader(message: ScopeSpans, reader: jspb.BinaryReader): ScopeSpans;
}

export namespace ScopeSpans {
  export type AsObject = {
    scope?: opentelemetry_proto_common_v1_common_pb.InstrumentationScope.AsObject,
...
export const SpanFlags: SpanFlagsMap;
