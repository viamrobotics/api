...
var file_robot_v1_robot_proto_rawDesc = []byte{
	...
	,
	...
	0x57, 0x45, 0x42, 0x52, 0x54, 0x43, 0x10, 0x02, 0x32, 0xdb, 0x11, 0x0a, 0x0c, 0x52, 0x6f, 0x62,
	...
	0x63, 0x6b, 0x12, 0x94, 0x01, 0x0a, 0x12, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x76, 0x65, 0x72, 0x43,
	...
	0x72, 0x6d, 0x5f, 0x70, 0x63, 0x64, 0x12, 0x6b, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x53, 0x74, 0x61,
	...
	0x74, 0x75, 0x73, 0x12, 0x7d, 0x0a, 0x0c, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x53, 0x74, 0x61,
	...
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x42, 0x2d, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x69,
...
var file_robot_v1_robot_proto_msgTypes = make([]protoimpl.MessageInfo, 43)
var file_robot_v1_robot_proto_goTypes = []interface{}{
	...
	(*v1.Transform)(nil),                 // 44: viam.common.v1.Transform
	(*structpb.Struct)(nil),              // 45: google.protobuf.Struct
	(*v1.PoseInFrame)(nil),               // 46: viam.common.v1.PoseInFrame
	(*v1.ResourceName)(nil),              // 47: viam.common.v1.ResourceName
	(*timestamppb.Timestamp)(nil),        // 48: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),          // 49: google.protobuf.Duration
	(*v1.LogEntry)(nil),                  // 50: viam.common.v1.LogEntry
}
var file_robot_v1_robot_proto_depIdxs = []int32{
	44, // 0: viam.robot.v1.FrameSystemConfig.frame:type_name -> viam.common.v1.Transform
	45, // 1: viam.robot.v1.FrameSystemConfig.kinematics:type_name -> google.protobuf.Struct
	44, // 2: viam.robot.v1.FrameSystemConfigRequest.supplemental_transforms:type_name -> viam.common.v1.Transform
	1,  // 3: viam.robot.v1.FrameSystemConfigResponse.frame_system_configs:type_name -> viam.robot.v1.FrameSystemConfig
	46, // 4: viam.robot.v1.TransformPoseRequest.source:type_name -> viam.common.v1.PoseInFrame
	44, // 5: viam.robot.v1.TransformPoseRequest.supplemental_transforms:type_name -> viam.common.v1.Transform
	46, // 6: viam.robot.v1.TransformPoseResponse.pose:type_name -> viam.common.v1.PoseInFrame
	47, // 7: viam.robot.v1.ResourceNamesResponse.resources:type_name -> viam.common.v1.ResourceName
	47, // 8: viam.robot.v1.ResourceRPCSubtype.subtype:type_name -> viam.common.v1.ResourceName
	10, // 9: viam.robot.v1.ResourceRPCSubtypesResponse.resource_rpc_subtypes:type_name -> viam.robot.v1.ResourceRPCSubtype
	45, // 10: viam.robot.v1.Operation.arguments:type_name -> google.protobuf.Struct
	48, // 11: viam.robot.v1.Operation.started:type_name -> google.protobuf.Timestamp
	...
	45, // 17: viam.robot.v1.Discovery.results:type_name -> google.protobuf.Struct
	...
	47, // 20: viam.robot.v1.Status.name:type_name -> viam.common.v1.ResourceName
	45, // 21: viam.robot.v1.Status.status:type_name -> google.protobuf.Struct
	48, // 22: viam.robot.v1.Status.last_reconfigured:type_name -> google.protobuf.Timestamp
	47, // 23: viam.robot.v1.GetStatusRequest.resource_names:type_name -> viam.common.v1.ResourceName
	28, // 24: viam.robot.v1.GetStatusResponse.status:type_name -> viam.robot.v1.Status
	47, // 25: viam.robot.v1.StreamStatusRequest.resource_names:type_name -> viam.common.v1.ResourceName
	49, // 26: viam.robot.v1.StreamStatusRequest.every:type_name -> google.protobuf.Duration
	28, // 27: viam.robot.v1.StreamStatusResponse.status:type_name -> viam.robot.v1.Status
	47, // 28: viam.robot.v1.StopExtraParameters.name:type_name -> viam.common.v1.ResourceName
	45, // 29: viam.robot.v1.StopExtraParameters.params:type_name -> google.protobuf.Struct
	33, // 30: viam.robot.v1.StopAllRequest.extra:type_name -> viam.robot.v1.StopExtraParameters
	49, // 31: viam.robot.v1.StartSessionResponse.heartbeat_window:type_name -> google.protobuf.Duration
	50, // 32: viam.robot.v1.LogRequest.logs:type_name -> viam.common.v1.LogEntry
	...
	15, // 50: viam.robot.v1.RobotService.GetOperations:output_type -> viam.robot.v1.GetOperationsResponse
	23, // 51: viam.robot.v1.RobotService.GetSessions:output_type -> viam.robot.v1.GetSessionsResponse
	9,  // 52: viam.robot.v1.RobotService.ResourceNames:output_type -> viam.robot.v1.ResourceNamesResponse
	12, // 53: viam.robot.v1.RobotService.ResourceRPCSubtypes:output_type -> viam.robot.v1.ResourceRPCSubtypesResponse
	17, // 54: viam.robot.v1.RobotService.CancelOperation:output_type -> viam.robot.v1.CancelOperationResponse
	19, // 55: viam.robot.v1.RobotService.BlockForOperation:output_type -> viam.robot.v1.BlockForOperationResponse
	27, // 56: viam.robot.v1.RobotService.DiscoverComponents:output_type -> viam.robot.v1.DiscoverComponentsResponse
	3,  // 57: viam.robot.v1.RobotService.FrameSystemConfig:output_type -> viam.robot.v1.FrameSystemConfigResponse
	5,  // 58: viam.robot.v1.RobotService.TransformPose:output_type -> viam.robot.v1.TransformPoseResponse
	7,  // 59: viam.robot.v1.RobotService.TransformPCD:output_type -> viam.robot.v1.TransformPCDResponse
	30, // 60: viam.robot.v1.RobotService.GetStatus:output_type -> viam.robot.v1.GetStatusResponse
	32, // 61: viam.robot.v1.RobotService.StreamStatus:output_type -> viam.robot.v1.StreamStatusResponse
	35, // 62: viam.robot.v1.RobotService.StopAll:output_type -> viam.robot.v1.StopAllResponse
	37, // 63: viam.robot.v1.RobotService.StartSession:output_type -> viam.robot.v1.StartSessionResponse
	39, // 64: viam.robot.v1.RobotService.SendSessionHeartbeat:output_type -> viam.robot.v1.SendSessionHeartbeatResponse
	41, // 65: viam.robot.v1.RobotService.Log:output_type -> viam.robot.v1.LogResponse
	43, // 66: viam.robot.v1.RobotService.GetCloudMetadata:output_type -> viam.robot.v1.GetCloudMetadataResponse
