 ...
 */
const methodDescriptor_BaseService_GetStatus = new grpc.web.MethodDescriptor(
 ...
 *     The XHR Node Readable Stream
 */
proto.viam.component.base.v1.BaseServiceClient.prototype.getStatus =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.component.base.v1.BaseService/GetStatus',
      request,
      metadata || {},
      methodDescriptor_BaseService_GetStatus,
      callback);
};
 ...
 *     Promise that resolves to the response
 */
proto.viam.component.base.v1.BaseServicePromiseClient.prototype.getStatus =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.component.base.v1.BaseService/GetStatus',
      request,
