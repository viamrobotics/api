 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.viam.app.dataset.v1.MergeDatasetsRequest,
 *   !proto.viam.app.dataset.v1.MergeDatasetsResponse>}
 */
const methodDescriptor_DatasetService_MergeDatasets = new grpc.web.MethodDescriptor(
  ...
  proto.viam.app.dataset.v1.MergeDatasetsResponse,
  /**
   * @param {!proto.viam.app.dataset.v1.MergeDatasetsRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.viam.app.dataset.v1.MergeDatasetsResponse.deserializeBinary
);


/**
 * @param {!proto.viam.app.dataset.v1.MergeDatasetsRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.viam.app.dataset.v1.MergeDatasetsResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.viam.app.dataset.v1.MergeDatasetsResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.viam.app.dataset.v1.DatasetServiceClient.prototype.mergeDatasets =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.app.dataset.v1.DatasetService/MergeDatasets',
      request,
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.viam.app.dataset.v1.MergeDatasetsResponse>}
 *     Promise that resolves to the response
 */
proto.viam.app.dataset.v1.DatasetServicePromiseClient.prototype.mergeDatasets =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.app.dataset.v1.DatasetService/MergeDatasets',
      request,
