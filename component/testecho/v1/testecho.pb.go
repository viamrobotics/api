...
func file_component_testecho_v1_testecho_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_component_testecho_v1_testecho_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_component_testecho_v1_testecho_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
