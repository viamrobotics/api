 ...
 * @generated from protobuf service google.bytestream.ByteStream
 */
export class ByteStreamClient implements IByteStreamClient, ServiceInfo {
    typeName = ByteStream.typeName;
    methods = ByteStream.methods;
    options = ByteStream.options;
    ...
    queryWriteStatus(input: QueryWriteStatusRequest, options?: RpcOptions): UnaryCall<QueryWriteStatusRequest, QueryWriteStatusResponse> {
        ...
        return stackIntercept<QueryWriteStatusRequest, QueryWriteStatusResponse>("unary", this._transport, method, opt, input);
    }
}
