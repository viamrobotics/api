...
var file_service_slam_v1_slam_proto_rawDesc = []byte{
	...
	0x32, 0xc3, 0x09, 0x0a, 0x0b, 0x53, 0x4c, 0x41, 0x4d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x72, 0x65, 0x61, 0x6d, 0x30, 0x01, 0x42, 0x3b, 0x0a, 0x18, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x69,
	0x61, 0x6d, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x73, 0x6c, 0x61, 0x6d, 0x2e,
	0x76, 0x31, 0x5a, 0x1f, 0x67, 0x6f, 0x2e, 0x76, 0x69, 0x61, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x2f,
	0x61, 0x70, 0x69, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f, 0x73, 0x6c, 0x61, 0x6d,
...
var file_service_slam_v1_slam_proto_depIdxs = []int32{
	...
	1,  // 15: viam.service.slam.v1.SLAMService.GetPosition:output_type -> viam.service.slam.v1.GetPositionResponse
	3,  // 16: viam.service.slam.v1.SLAMService.GetMap:output_type -> viam.service.slam.v1.GetMapResponse
	5,  // 17: viam.service.slam.v1.SLAMService.GetPositionNew:output_type -> viam.service.slam.v1.GetPositionNewResponse
	7,  // 18: viam.service.slam.v1.SLAMService.GetPointCloudMap:output_type -> viam.service.slam.v1.GetPointCloudMapResponse
	9,  // 19: viam.service.slam.v1.SLAMService.GetInternalState:output_type -> viam.service.slam.v1.GetInternalStateResponse
	11, // 20: viam.service.slam.v1.SLAMService.GetPointCloudMapStream:output_type -> viam.service.slam.v1.GetPointCloudMapStreamResponse
	13, // 21: viam.service.slam.v1.SLAMService.GetInternalStateStream:output_type -> viam.service.slam.v1.GetInternalStateStreamResponse
