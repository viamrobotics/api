...
var file_service_navigation_v1_navigation_proto_rawDesc = []byte{
	...
	0x45, 0x10, 0x03, 0x32, 0xa5, 0x0e, 0x0a, 0x11, 0x4e, 0x61, 0x76, 0x69, 0x67, 0x61, 0x74, 0x69,
	...
	0x65, 0x7d, 0x2f, 0x64, 0x6f, 0x5f, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x8b, 0x01,
	...
	0x2f, 0x67, 0x65, 0x74, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42, 0x47, 0x0a, 0x1e, 0x63,
...
var file_service_navigation_v1_navigation_proto_goTypes = []any{
	...
	(*v1.GetStatusRequest)(nil),    // 26: viam.common.v1.GetStatusRequest
	(*v1.DoCommandResponse)(nil),   // 27: viam.common.v1.DoCommandResponse
	(*v1.GetStatusResponse)(nil),   // 28: viam.common.v1.GetStatusResponse
}
var file_service_navigation_v1_navigation_proto_depIdxs = []int32{
	...
	26, // 28: viam.service.navigation.v1.NavigationService.GetStatus:input_type -> viam.common.v1.GetStatusRequest
	3,  // 29: viam.service.navigation.v1.NavigationService.GetMode:output_type -> viam.service.navigation.v1.GetModeResponse
	5,  // 30: viam.service.navigation.v1.NavigationService.SetMode:output_type -> viam.service.navigation.v1.SetModeResponse
	8,  // 31: viam.service.navigation.v1.NavigationService.GetLocation:output_type -> viam.service.navigation.v1.GetLocationResponse
	10, // 32: viam.service.navigation.v1.NavigationService.GetWaypoints:output_type -> viam.service.navigation.v1.GetWaypointsResponse
	12, // 33: viam.service.navigation.v1.NavigationService.AddWaypoint:output_type -> viam.service.navigation.v1.AddWaypointResponse
	14, // 34: viam.service.navigation.v1.NavigationService.RemoveWaypoint:output_type -> viam.service.navigation.v1.RemoveWaypointResponse
	16, // 35: viam.service.navigation.v1.NavigationService.GetObstacles:output_type -> viam.service.navigation.v1.GetObstaclesResponse
	19, // 36: viam.service.navigation.v1.NavigationService.GetPaths:output_type -> viam.service.navigation.v1.GetPathsResponse
	21, // 37: viam.service.navigation.v1.NavigationService.GetProperties:output_type -> viam.service.navigation.v1.GetPropertiesResponse
	27, // 38: viam.service.navigation.v1.NavigationService.DoCommand:output_type -> viam.common.v1.DoCommandResponse
	28, // 39: viam.service.navigation.v1.NavigationService.GetStatus:output_type -> viam.common.v1.GetStatusResponse
