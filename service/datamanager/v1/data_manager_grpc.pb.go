...
const (
	DataManagerService_Sync_FullMethodName      = "/viam.service.datamanager.v1.DataManagerService/Sync"
	DataManagerService_DoCommand_FullMethodName = "/viam.service.datamanager.v1.DataManagerService/DoCommand"
)
...
func (c *dataManagerServiceClient) Sync(ctx context.Context, in *SyncRequest, opts ...grpc.CallOption) (*SyncResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataManagerService_Sync_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dataManagerServiceClient) DoCommand(ctx context.Context, in *v1.DoCommandRequest, opts ...grpc.CallOption) (*v1.DoCommandResponse, error) {
	...
	err := c.cc.Invoke(ctx, DataManagerService_DoCommand_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedDataManagerServiceServer must be embedded to have
...
func (UnimplementedDataManagerServiceServer) testEmbeddedByValue()                            {}
...
func RegisterDataManagerServiceServer(s grpc.ServiceRegistrar, srv DataManagerServiceServer) {
	// If the following call pancis, it indicates UnimplementedDataManagerServiceServer was
...
func _DataManagerService_Sync_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataManagerService_Sync_FullMethodName,
	}
...
func _DataManagerService_DoCommand_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DataManagerService_DoCommand_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
