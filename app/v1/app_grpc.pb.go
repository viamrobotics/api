...
type AppServiceClient interface {
	...
	// List information regarding all parts owned by an organization
	GetOrganizationSummary(ctx context.Context, in *GetOrganizationSummaryRequest, opts ...grpc.CallOption) (*GetOrganizationSummaryResponse, error)
...
func (c *appServiceClient) GetOrganizationSummary(ctx context.Context, in *GetOrganizationSummaryRequest, opts ...grpc.CallOption) (*GetOrganizationSummaryResponse, error) {
	out := new(GetOrganizationSummaryResponse)
	err := c.cc.Invoke(ctx, "/viam.app.v1.AppService/GetOrganizationSummary", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AppServiceServer interface {
	...
	// List information regarding all parts owned by an organization
	GetOrganizationSummary(context.Context, *GetOrganizationSummaryRequest) (*GetOrganizationSummaryResponse, error)
	// Create an organization invite to an organization
...
func (UnimplementedAppServiceServer) GetOrganizationSummary(context.Context, *GetOrganizationSummaryRequest) (*GetOrganizationSummaryResponse, error) {
...
func _AppService_GetOrganizationSummary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetOrganizationSummaryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppServiceServer).GetOrganizationSummary(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/viam.app.v1.AppService/GetOrganizationSummary",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppServiceServer).GetOrganizationSummary(ctx, req.(*GetOrganizationSummaryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AppService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AppService_GetOrganizationSummary_Handler,
		},
		{
