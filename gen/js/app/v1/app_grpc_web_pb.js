 ...
 * @const
 * @type {!grpc.web.MethodDescriptor<
 *   !proto.viam.app.v1.ListFragmentNestedFragmentsRequest,
 *   !proto.viam.app.v1.ListFragmentNestedFragmentsResponse>}
 */
const methodDescriptor_AppService_ListFragmentNestedFragments = new grpc.web.MethodDescriptor(
  '/viam.app.v1.AppService/ListFragmentNestedFragments',
  grpc.web.MethodType.UNARY,
  proto.viam.app.v1.ListFragmentNestedFragmentsRequest,
  proto.viam.app.v1.ListFragmentNestedFragmentsResponse,
  /**
   * @param {!proto.viam.app.v1.ListFragmentNestedFragmentsRequest} request
   * @return {!Uint8Array}
   */
  function(request) {
    return request.serializeBinary();
  },
  proto.viam.app.v1.ListFragmentNestedFragmentsResponse.deserializeBinary
);


/**
 * @param {!proto.viam.app.v1.ListFragmentNestedFragmentsRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.viam.app.v1.ListFragmentNestedFragmentsResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.viam.app.v1.ListFragmentNestedFragmentsResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.viam.app.v1.AppServiceClient.prototype.listFragmentNestedFragments =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/viam.app.v1.AppService/ListFragmentNestedFragments',
      request,
      metadata || {},
      methodDescriptor_AppService_ListFragmentNestedFragments,
      callback);
};
 ...
 * @param {?Object<string, string>=} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.viam.app.v1.ListFragmentNestedFragmentsResponse>}
 *     Promise that resolves to the response
 */
proto.viam.app.v1.AppServicePromiseClient.prototype.listFragmentNestedFragments =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/viam.app.v1.AppService/ListFragmentNestedFragments',
      request,
