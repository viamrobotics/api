...
var file_component_servo_v1_servo_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x67, 0x32, 0xdc, 0x04, 0x0a, 0x0c, 0x53, 0x65, 0x72, 0x76, 0x6f, 0x53, 0x65, 0x72,
	...
	0x6e, 0x67, 0x42, 0x41, 0x0a, 0x1b, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x69, 0x61, 0x6d, 0x2e, 0x63,
...
var file_component_servo_v1_servo_proto_depIdxs = []int32{
	...
	1, // 7: viam.component.servo.v1.ServoService.Move:output_type -> viam.component.servo.v1.MoveResponse
	3, // 8: viam.component.servo.v1.ServoService.GetPosition:output_type -> viam.component.servo.v1.GetPositionResponse
	5, // 9: viam.component.servo.v1.ServoService.Stop:output_type -> viam.component.servo.v1.StopResponse
	8, // 10: viam.component.servo.v1.ServoService.IsMoving:output_type -> viam.component.servo.v1.IsMovingResponse
