...
var file_component_gripper_v1_gripper_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x69, 0x73, 0x4d, 0x6f, 0x76, 0x69, 0x6e, 0x67, 0x32, 0xe1, 0x04, 0x0a, 0x0e, 0x47,
	...
	0x61, 0x6d, 0x65, 0x7d, 0x2f, 0x69, 0x73, 0x5f, 0x6d, 0x6f, 0x76, 0x69, 0x6e, 0x67, 0x42, 0x45,
...
var file_component_gripper_v1_gripper_proto_depIdxs = []int32{
	...
	1, // 8: viam.component.gripper.v1.GripperService.Open:output_type -> viam.component.gripper.v1.OpenResponse
	3, // 9: viam.component.gripper.v1.GripperService.Grab:output_type -> viam.component.gripper.v1.GrabResponse
	5, // 10: viam.component.gripper.v1.GripperService.Stop:output_type -> viam.component.gripper.v1.StopResponse
	7, // 11: viam.component.gripper.v1.GripperService.IsMoving:output_type -> viam.component.gripper.v1.IsMovingResponse
