...
var file_component_servo_v1_servo_proto_rawDesc = []byte{
	...
	0x69, 0x6e, 0x67, 0x32, 0xe7, 0x05, 0x0a, 0x0c, 0x53, 0x65, 0x72, 0x76, 0x6f, 0x53, 0x65, 0x72,
...
var file_component_servo_v1_servo_proto_depIdxs = []int32{
	...
	1,  // 8: viam.component.servo.v1.ServoService.Move:output_type -> viam.component.servo.v1.MoveResponse
	3,  // 9: viam.component.servo.v1.ServoService.GetPosition:output_type -> viam.component.servo.v1.GetPositionResponse
	5,  // 10: viam.component.servo.v1.ServoService.Stop:output_type -> viam.component.servo.v1.StopResponse
	8,  // 11: viam.component.servo.v1.ServoService.IsMoving:output_type -> viam.component.servo.v1.IsMovingResponse
	11, // 12: viam.component.servo.v1.ServoService.DoCommand:output_type -> viam.common.v1.DoCommandResponse
