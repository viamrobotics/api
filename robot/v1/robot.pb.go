...
var file_robot_v1_robot_proto_rawDesc = []byte{
	...
	0x74, 0x75, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0x57, 0x0a, 0x18, 0x47, 0x65,
	...
	0x63, 0x65, 0x73, 0x22, 0xb0, 0x02, 0x0a, 0x0e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x30, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x76, 0x69, 0x61, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d,
	0x6f, 0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x4e, 0x61,
	0x6d, 0x65, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x39, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74,
	0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x23, 0x2e, 0x76, 0x69, 0x61, 0x6d, 0x2e, 0x72,
	...
	0x65, 0x64, 0x22, 0x72, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x15, 0x0a, 0x11, 0x53,
	...
	0x56, 0x49, 0x4e, 0x47, 0x10, 0x04, 0x2a, 0x7a, 0x0a, 0x12, 0x50, 0x65, 0x65, 0x72, 0x43, 0x6f,
	...
	0x10, 0x02, 0x32, 0xda, 0x14, 0x0a, 0x0c, 0x52, 0x6f, 0x62, 0x6f, 0x74, 0x53, 0x65, 0x72, 0x76,
	...
	0x2f, 0x6d, 0x61, 0x63, 0x68, 0x69, 0x6e, 0x65, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x42,
...
var file_robot_v1_robot_proto_msgTypes = make([]protoimpl.MessageInfo, 50)
var file_robot_v1_robot_proto_goTypes = []interface{}{
	...
	(*v1.Transform)(nil),                 // 52: viam.common.v1.Transform
	(*structpb.Struct)(nil),              // 53: google.protobuf.Struct
	(*v1.PoseInFrame)(nil),               // 54: viam.common.v1.PoseInFrame
	(*v1.ResourceName)(nil),              // 55: viam.common.v1.ResourceName
	(*timestamppb.Timestamp)(nil),        // 56: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),          // 57: google.protobuf.Duration
	(*v1.LogEntry)(nil),                  // 58: viam.common.v1.LogEntry
}
var file_robot_v1_robot_proto_depIdxs = []int32{
	52, // 0: viam.robot.v1.FrameSystemConfig.frame:type_name -> viam.common.v1.Transform
	53, // 1: viam.robot.v1.FrameSystemConfig.kinematics:type_name -> google.protobuf.Struct
	52, // 2: viam.robot.v1.FrameSystemConfigRequest.supplemental_transforms:type_name -> viam.common.v1.Transform
	2,  // 3: viam.robot.v1.FrameSystemConfigResponse.frame_system_configs:type_name -> viam.robot.v1.FrameSystemConfig
	54, // 4: viam.robot.v1.TransformPoseRequest.source:type_name -> viam.common.v1.PoseInFrame
	52, // 5: viam.robot.v1.TransformPoseRequest.supplemental_transforms:type_name -> viam.common.v1.Transform
	54, // 6: viam.robot.v1.TransformPoseResponse.pose:type_name -> viam.common.v1.PoseInFrame
	55, // 7: viam.robot.v1.ResourceNamesResponse.resources:type_name -> viam.common.v1.ResourceName
	55, // 8: viam.robot.v1.ResourceRPCSubtype.subtype:type_name -> viam.common.v1.ResourceName
	11, // 9: viam.robot.v1.ResourceRPCSubtypesResponse.resource_rpc_subtypes:type_name -> viam.robot.v1.ResourceRPCSubtype
	53, // 10: viam.robot.v1.Operation.arguments:type_name -> google.protobuf.Struct
	56, // 11: viam.robot.v1.Operation.started:type_name -> google.protobuf.Timestamp
	...
	53, // 17: viam.robot.v1.Discovery.results:type_name -> google.protobuf.Struct
	...
	55, // 20: viam.robot.v1.Status.name:type_name -> viam.common.v1.ResourceName
	53, // 21: viam.robot.v1.Status.status:type_name -> google.protobuf.Struct
	56, // 22: viam.robot.v1.Status.last_reconfigured:type_name -> google.protobuf.Timestamp
	55, // 23: viam.robot.v1.GetStatusRequest.resource_names:type_name -> viam.common.v1.ResourceName
	29, // 24: viam.robot.v1.GetStatusResponse.status:type_name -> viam.robot.v1.Status
	55, // 25: viam.robot.v1.StreamStatusRequest.resource_names:type_name -> viam.common.v1.ResourceName
	57, // 26: viam.robot.v1.StreamStatusRequest.every:type_name -> google.protobuf.Duration
	29, // 27: viam.robot.v1.StreamStatusResponse.status:type_name -> viam.robot.v1.Status
	55, // 28: viam.robot.v1.StopExtraParameters.name:type_name -> viam.common.v1.ResourceName
	53, // 29: viam.robot.v1.StopExtraParameters.params:type_name -> google.protobuf.Struct
	34, // 30: viam.robot.v1.StopAllRequest.extra:type_name -> viam.robot.v1.StopExtraParameters
	57, // 31: viam.robot.v1.StartSessionResponse.heartbeat_window:type_name -> google.protobuf.Duration
	58, // 32: viam.robot.v1.LogRequest.logs:type_name -> viam.common.v1.LogEntry
	51, // 33: viam.robot.v1.GetMachineStatusResponse.resources:type_name -> viam.robot.v1.ResourceStatus
	55, // 34: viam.robot.v1.ResourceStatus.name:type_name -> viam.common.v1.ResourceName
	1,  // 35: viam.robot.v1.ResourceStatus.state:type_name -> viam.robot.v1.ResourceStatus.State
	56, // 36: viam.robot.v1.ResourceStatus.last_updated:type_name -> google.protobuf.Timestamp
	15, // 37: viam.robot.v1.RobotService.GetOperations:input_type -> viam.robot.v1.GetOperationsRequest
	23, // 38: viam.robot.v1.RobotService.GetSessions:input_type -> viam.robot.v1.GetSessionsRequest
	9,  // 39: viam.robot.v1.RobotService.ResourceNames:input_type -> viam.robot.v1.ResourceNamesRequest
	12, // 40: viam.robot.v1.RobotService.ResourceRPCSubtypes:input_type -> viam.robot.v1.ResourceRPCSubtypesRequest
	17, // 41: viam.robot.v1.RobotService.CancelOperation:input_type -> viam.robot.v1.CancelOperationRequest
	19, // 42: viam.robot.v1.RobotService.BlockForOperation:input_type -> viam.robot.v1.BlockForOperationRequest
	27, // 43: viam.robot.v1.RobotService.DiscoverComponents:input_type -> viam.robot.v1.DiscoverComponentsRequest
	3,  // 44: viam.robot.v1.RobotService.FrameSystemConfig:input_type -> viam.robot.v1.FrameSystemConfigRequest
	5,  // 45: viam.robot.v1.RobotService.TransformPose:input_type -> viam.robot.v1.TransformPoseRequest
	7,  // 46: viam.robot.v1.RobotService.TransformPCD:input_type -> viam.robot.v1.TransformPCDRequest
	30, // 47: viam.robot.v1.RobotService.GetStatus:input_type -> viam.robot.v1.GetStatusRequest
	32, // 48: viam.robot.v1.RobotService.StreamStatus:input_type -> viam.robot.v1.StreamStatusRequest
	35, // 49: viam.robot.v1.RobotService.StopAll:input_type -> viam.robot.v1.StopAllRequest
	37, // 50: viam.robot.v1.RobotService.StartSession:input_type -> viam.robot.v1.StartSessionRequest
	39, // 51: viam.robot.v1.RobotService.SendSessionHeartbeat:input_type -> viam.robot.v1.SendSessionHeartbeatRequest
	41, // 52: viam.robot.v1.RobotService.Log:input_type -> viam.robot.v1.LogRequest
	43, // 53: viam.robot.v1.RobotService.GetCloudMetadata:input_type -> viam.robot.v1.GetCloudMetadataRequest
	45, // 54: viam.robot.v1.RobotService.RestartModule:input_type -> viam.robot.v1.RestartModuleRequest
	47, // 55: viam.robot.v1.RobotService.Shutdown:input_type -> viam.robot.v1.ShutdownRequest
	49, // 56: viam.robot.v1.RobotService.GetMachineStatus:input_type -> viam.robot.v1.GetMachineStatusRequest
	16, // 57: viam.robot.v1.RobotService.GetOperations:output_type -> viam.robot.v1.GetOperationsResponse
	24, // 58: viam.robot.v1.RobotService.GetSessions:output_type -> viam.robot.v1.GetSessionsResponse
	10, // 59: viam.robot.v1.RobotService.ResourceNames:output_type -> viam.robot.v1.ResourceNamesResponse
	13, // 60: viam.robot.v1.RobotService.ResourceRPCSubtypes:output_type -> viam.robot.v1.ResourceRPCSubtypesResponse
	18, // 61: viam.robot.v1.RobotService.CancelOperation:output_type -> viam.robot.v1.CancelOperationResponse
	20, // 62: viam.robot.v1.RobotService.BlockForOperation:output_type -> viam.robot.v1.BlockForOperationResponse
	28, // 63: viam.robot.v1.RobotService.DiscoverComponents:output_type -> viam.robot.v1.DiscoverComponentsResponse
	4,  // 64: viam.robot.v1.RobotService.FrameSystemConfig:output_type -> viam.robot.v1.FrameSystemConfigResponse
	6,  // 65: viam.robot.v1.RobotService.TransformPose:output_type -> viam.robot.v1.TransformPoseResponse
	8,  // 66: viam.robot.v1.RobotService.TransformPCD:output_type -> viam.robot.v1.TransformPCDResponse
	31, // 67: viam.robot.v1.RobotService.GetStatus:output_type -> viam.robot.v1.GetStatusResponse
	33, // 68: viam.robot.v1.RobotService.StreamStatus:output_type -> viam.robot.v1.StreamStatusResponse
	36, // 69: viam.robot.v1.RobotService.StopAll:output_type -> viam.robot.v1.StopAllResponse
	38, // 70: viam.robot.v1.RobotService.StartSession:output_type -> viam.robot.v1.StartSessionResponse
	40, // 71: viam.robot.v1.RobotService.SendSessionHeartbeat:output_type -> viam.robot.v1.SendSessionHeartbeatResponse
	42, // 72: viam.robot.v1.RobotService.Log:output_type -> viam.robot.v1.LogResponse
	44, // 73: viam.robot.v1.RobotService.GetCloudMetadata:output_type -> viam.robot.v1.GetCloudMetadataResponse
	46, // 74: viam.robot.v1.RobotService.RestartModule:output_type -> viam.robot.v1.RestartModuleResponse
	48, // 75: viam.robot.v1.RobotService.Shutdown:output_type -> viam.robot.v1.ShutdownResponse
	50, // 76: viam.robot.v1.RobotService.GetMachineStatus:output_type -> viam.robot.v1.GetMachineStatusResponse
