...
const (
	...
	CredentialsType_CREDENTIALS_TYPE_WEB_OAUTH             CredentialsType = 5
)
...
func (x *AuthHandlerConfig) GetWebOauthConfig() *AuthHandlerWebOauthConfig {
	if x != nil {
		return x.WebOauthConfig
	}
	return nil
}
...
var file_app_v1_robot_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x22, 0x62, 0x0a, 0x0c, 0x4d, 0x6f, 0x64, 0x75, 0x6c, 0x65, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x73, 0x2a, 0xdf, 0x01, 0x0a, 0x0f, 0x43, 0x72, 0x65, 0x64, 0x65,
...
var file_app_v1_robot_proto_msgTypes = make([]protoimpl.MessageInfo, 34)
var file_app_v1_robot_proto_goTypes = []interface{}{
	...
	(*Orientation_EulerAngles)(nil),              // 31: viam.app.v1.Orientation.EulerAngles
	(*Orientation_AxisAngles)(nil),               // 32: viam.app.v1.Orientation.AxisAngles
	(*Orientation_Quaternion)(nil),               // 33: viam.app.v1.Orientation.Quaternion
	(*RemoteAuth_Credentials)(nil),               // 34: viam.app.v1.RemoteAuth.Credentials
...
var file_app_v1_robot_proto_depIdxs = []int32{
	...
	30, // 25: viam.app.v1.Orientation.vector_degrees:type_name -> viam.app.v1.Orientation.OrientationVectorDegrees
