...
var file_component_board_v1_board_proto_rawDesc = []byte{
	...
	0x45, 0x5f, 0x44, 0x45, 0x45, 0x50, 0x10, 0x02, 0x32, 0x9e, 0x0e, 0x0a, 0x0c, 0x42, 0x6f, 0x61,
	...
	0x6f, 0x77, 0x65, 0x72, 0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x42, 0x41, 0x0a, 0x1b, 0x63, 0x6f, 0x6d,
	0x2e, 0x76, 0x69, 0x61, 0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e, 0x65, 0x6e, 0x74, 0x2e,
	0x62, 0x6f, 0x61, 0x72, 0x64, 0x2e, 0x76, 0x31, 0x5a, 0x22, 0x67, 0x6f, 0x2e, 0x76, 0x69, 0x61,
	0x6d, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x63, 0x6f, 0x6d, 0x70, 0x6f, 0x6e,
	0x65, 0x6e, 0x74, 0x2f, 0x62, 0x6f, 0x61, 0x72, 0x64, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_component_board_v1_board_proto_depIdxs = []int32{
	...
	2,  // 24: viam.component.board.v1.BoardService.Status:output_type -> viam.component.board.v1.StatusResponse
	4,  // 25: viam.component.board.v1.BoardService.SetGPIO:output_type -> viam.component.board.v1.SetGPIOResponse
	6,  // 26: viam.component.board.v1.BoardService.GetGPIO:output_type -> viam.component.board.v1.GetGPIOResponse
	8,  // 27: viam.component.board.v1.BoardService.PWM:output_type -> viam.component.board.v1.PWMResponse
	10, // 28: viam.component.board.v1.BoardService.SetPWM:output_type -> viam.component.board.v1.SetPWMResponse
	12, // 29: viam.component.board.v1.BoardService.PWMFrequency:output_type -> viam.component.board.v1.PWMFrequencyResponse
	14, // 30: viam.component.board.v1.BoardService.SetPWMFrequency:output_type -> viam.component.board.v1.SetPWMFrequencyResponse
	25, // 31: viam.component.board.v1.BoardService.DoCommand:output_type -> viam.common.v1.DoCommandResponse
	16, // 32: viam.component.board.v1.BoardService.ReadAnalogReader:output_type -> viam.component.board.v1.ReadAnalogReaderResponse
	18, // 33: viam.component.board.v1.BoardService.GetDigitalInterruptValue:output_type -> viam.component.board.v1.GetDigitalInterruptValueResponse
	20, // 34: viam.component.board.v1.BoardService.SetPowerMode:output_type -> viam.component.board.v1.SetPowerModeResponse
